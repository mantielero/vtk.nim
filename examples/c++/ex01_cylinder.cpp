// yay -S vtk
// nm -DA /usr/lib/libvtk*.so | grep _ZN6vtksys18SystemToolsManagerD1Ev
// nm -gCD /usr/lib/libvtk*.so | grep vtkPolyDataMapper\:\:New\(\)
