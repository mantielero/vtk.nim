...
## !!!Ignored construct:  # vtkTextureUnitManager_h [NewLine] # vtkTextureUnitManager_h [NewLine] # vtkObject.h [NewLine] # vtkRenderingOpenGL2Module.h  For export macro [NewLine] class vtkOpenGLRenderWindow ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKRENDERINGOPENGL2_EXPORT vtkTextureUnitManager : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkTextureUnitManager :: IsTypeOf ( type ) ; } static vtkTextureUnitManager * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkTextureUnitManager * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkTextureUnitManager * NewInstance ( ) const { return vtkTextureUnitManager :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkTextureUnitManager :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkTextureUnitManager :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkTextureUnitManager * New ( ) ; *
...
##  virtual void Free ( int textureUnitId ) ; protected : *
##  Default constructor.
...
##  void DeleteTable ( ) ; int NumberOfTextureUnits ; bool * TextureUnits ; private : vtkTextureUnitManager ( const vtkTextureUnitManager & ) = delete ; void operator = ( const vtkTextureUnitManager & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
