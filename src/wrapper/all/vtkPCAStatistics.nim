...
## !!!Ignored construct:  # vtkPCAStatistics_h [NewLine] # vtkPCAStatistics_h [NewLine] # vtkFiltersStatisticsModule.h  For export macro # vtkMultiCorrelativeStatistics.h [NewLine] class vtkDoubleArray ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkIdTypeArray"
## !!!Ignored construct:  class VTKFILTERSSTATISTICS_EXPORT vtkPCAStatistics : public vtkMultiCorrelativeStatistics { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkMultiCorrelativeStatistics Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkMultiCorrelativeStatistics :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPCAStatistics :: IsTypeOf ( type ) ; } static vtkPCAStatistics * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPCAStatistics * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPCAStatistics * NewInstance ( ) const { return vtkPCAStatistics :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkMultiCorrelativeStatistics :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPCAStatistics :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPCAStatistics :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkPCAStatistics * New ( ) ; *
##  Methods by which the covariance matrix may be normalized.
##  enum NormalizationType { NONE , !< The covariance matrix should be used as computed. TRIANGLE_SPECIFIED , !< Normalize cov(i,j) by V(i,j) where V is supplied by the user. DIAGONAL_SPECIFIED , !< Normalize cov(i,j) by sqrt(V(i)*V(j)) where V is supplied by the user. DIAGONAL_VARIANCE , !< Normalize cov(i,j) by sqrt(cov(i,i)*cov(j,j)). NUM_NORMALIZATION_SCHEMES !< The number of normalization schemes. } ; *
##  These are the enumeration values that SetBasisScheme() accepts and GetBasisScheme returns.
##  enum ProjectionType { FULL_BASIS , !< Use all entries in the basis matrix FIXED_BASIS_SIZE , !< Use the first N entries in the basis matrix FIXED_BASIS_ENERGY , !< Use consecutive basis matrix entries whose energies sum to at least T NUM_BASIS_SCHEMES !< The number of schemes (not a valid scheme). } ; /@{ *
...
##  virtual void SetNormalizationScheme ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  NormalizationScheme  to  << _arg ) ; if ( this -> NormalizationScheme != _arg ) { this -> NormalizationScheme = _arg ; this -> Modified ( ) ; } } ; virtual int GetNormalizationScheme ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << NormalizationScheme  of  << this -> NormalizationScheme ) ; return this -> NormalizationScheme ; } ; virtual void SetNormalizationSchemeByName ( const char * schemeName ) ; virtual const char * GetNormalizationSchemeName ( int scheme ) ; /@} /@{ *
...
##  virtual vtkTable * GetSpecifiedNormalization ( ) ; virtual void SetSpecifiedNormalization ( vtkTable * ) ; /@} /@{ *
...
##  option is turned on.
##  void GetEigenvalues ( int request , vtkDoubleArray * ) ; void GetEigenvalues ( vtkDoubleArray * ) ; double GetEigenvalue ( int request , int i ) ; double GetEigenvalue ( int i ) ; /@} /@{ *
...
##  void GetEigenvectors ( int request , vtkDoubleArray * eigenvectors ) ; void GetEigenvectors ( vtkDoubleArray * eigenvectors ) ; void GetEigenvector ( int i , vtkDoubleArray * eigenvector ) ; void GetEigenvector ( int request , int i , vtkDoubleArray * eigenvector ) ; /@} /@{ *
...
##  virtual void SetNormalizationSchemeBasisScheme ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  BasisScheme  to  << _arg ) ; if ( this -> BasisScheme != _arg ) { this -> BasisScheme = _arg ; this -> Modified ( ) ; } } ; virtual int GetNormalizationSchemeBasisScheme ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << BasisScheme  of  << this -> BasisScheme ) ; return this -> BasisScheme ; } ; virtual const char * GetBasisSchemeName ( int schemeIndex ) ; virtual void SetBasisSchemeByName ( const char * schemeName ) ; /@} /@{ *
...
##  basis scheme.
##  virtual void SetNormalizationSchemeBasisSchemeFixedBasisSize ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  FixedBasisSize  to  << _arg ) ; if ( this -> FixedBasisSize != _arg ) { this -> FixedBasisSize = _arg ; this -> Modified ( ) ; } } ; virtual int GetNormalizationSchemeBasisSchemeFixedBasisSize ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << FixedBasisSize  of  << this -> FixedBasisSize ) ; return this -> FixedBasisSize ; } ; /@} /@{ *
...
##  virtual void SetFixedBasisEnergy ( double _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << FixedBasisEnergy  to  << _arg ) ; if ( this -> FixedBasisEnergy != ( _arg < 0.0 ? 0.0 : ( _arg > 1.0 ? 1.0 : _arg ) ) ) { this -> FixedBasisEnergy = ( _arg < 0.0 ? 0.0 : ( _arg > 1.0 ? 1.0 : _arg ) ) ; this -> Modified ( ) ; } } virtual double GetFixedBasisEnergyMinValue ( ) { return 0.0 ; } virtual double GetFixedBasisEnergyMaxValue ( ) { return 1.0 ; } ; virtual double GetNormalizationSchemeBasisSchemeFixedBasisSizeFixedBasisEnergy ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << FixedBasisEnergy  of  << this -> FixedBasisEnergy ) ; return this -> FixedBasisEnergy ; } ; /@} *
...
##  bool SetParameter ( const char * parameter , int index , vtkVariant value ) override ; protected : vtkPCAStatistics ( ) ; ~ vtkPCAStatistics ( ) override ; *
...
##  void SelectAssessFunctor ( vtkTable * inData , vtkDataObject * inMeta , vtkStringArray * rowNames , AssessFunctor * & dfunc ) override ; int NormalizationScheme ; int BasisScheme ; int FixedBasisSize ; double FixedBasisEnergy ; static const char * BasisSchemeEnumNames [ NUM_BASIS_SCHEMES + 1 ] ; static const char * NormalizationSchemeEnumNames [ NUM_NORMALIZATION_SCHEMES + 1 ] ; private : vtkPCAStatistics ( const vtkPCAStatistics & ) = delete ; void operator = ( const vtkPCAStatistics & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
