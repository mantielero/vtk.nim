...
## !!!Ignored construct:  # vtkPythonInterpreter_h [NewLine] # vtkPythonInterpreter_h [NewLine] # vtkObject.h [NewLine] # vtkPythonInterpreterModule.h  For export macro # vtkStdString.h  needed for vtkStdString. [NewLine] # defined ( _WIN32 ) [NewLine] # < vector >  for vtkWideArgsConverter # [NewLine] class VTKPYTHONINTERPRETER_EXPORT vtkPythonInterpreter : public vtkObject { public : static vtkPythonInterpreter * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPythonInterpreter :: IsTypeOf ( type ) ; } static vtkPythonInterpreter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPythonInterpreter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPythonInterpreter * NewInstance ( ) const { return vtkPythonInterpreter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPythonInterpreter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPythonInterpreter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  static void PrependPythonPath ( const char * anchor , const char * landmark , bool add_landmark = false ) ; /@} /@{ *
##  To capture stdin, especially for non-terminal applications, set CaptureStdin
##  to true. In that case vtkCommand::UpdateEvent will be fired with the calldata
##  being a reference to a vtkStdString that should be filled in with the text to
##  be passed in as the input.
##  static void SetCaptureStdin ( bool ) ; static bool GetCaptureStdin ( ) ; /@} /@{ *
##  Enable/disable VTK from redirecting Python output to vtkOutputWindow. On by default.
##  static void SetRedirectOutput ( bool redirect ) ; static bool GetRedirectOutput ( ) ; /@} /@{ *
...
##  static void SetLogVerbosity ( int ) ; static int GetLogVerbosity ( ) ; /@} protected : vtkPythonInterpreter ( ) ; ~ vtkPythonInterpreter ( ) override ; friend struct vtkPythonStdStreamCaptureHelper ; /@{ *
##  Internal methods used by Python. Don't call directly.
##  static void WriteStdOut ( const char * txt ) ; static void FlushStdOut ( ) ; static void WriteStdErr ( const char * txt ) ; static void FlushStdErr ( ) ; static vtkStdString ReadStdin ( ) ; /@} private : static bool InitializeWithArgs ( int initsigs , int argc , char * argv [ ] ) ; vtkPythonInterpreter ( const vtkPythonInterpreter & ) = delete ; void operator = ( const vtkPythonInterpreter & ) = delete ; static bool InitializedOnce ; static bool CaptureStdin ; static bool RedirectOutput ; *
...
##  static std :: string StdErrBuffer ; static std :: string StdOutBuffer ; /@} *
...
## !!!Ignored construct:  class VTKPYTHONINTERPRETER_EXPORT vtkPythonGlobalInterpreters { public : vtkPythonGlobalInterpreters ( ) ; ~ vtkPythonGlobalInterpreters ( ) ; private : vtkPythonGlobalInterpreters ( const vtkPythonGlobalInterpreters & ) = delete ; vtkPythonGlobalInterpreters & operator = ( const vtkPythonGlobalInterpreters & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

##  This is here to implement the Schwarz counter idiom.

var vtkPythonInterpreters* {.importcpp: "vtkPythonInterpreters",
                           header: "vtkPythonInterpreter.h".}: vtkPythonGlobalInterpreters

## !!!Ignored construct:  # defined ( _WIN32 ) [NewLine] class VTKPYTHONINTERPRETER_EXPORT vtkWideArgsConverter { public : vtkWideArgsConverter ( int argc , wchar_t * wargv [ ] ) ; ~ vtkWideArgsConverter ( ) ; char * * GetArgs ( ) { return & this -> Args [ 0 ] ; } int GetArgCount ( ) { return this -> Argc ; } private : int Argc ; std :: vector < char * > Args ; std :: vector < char * > MemCache ; vtkWideArgsConverter ( const vtkWideArgsConverter & ) = delete ; vtkWideArgsConverter & operator = ( const vtkWideArgsConverter & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
