...
## !!!Ignored construct:  # vtkPolyData_h [NewLine] # vtkPolyData_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkPointSet.h [NewLine] # vtkCellArray.h  Needed for inline methods # vtkCellLinks.h  Needed for inline methods # vtkPolyDataInternals.h  Needed for inline methods [NewLine] class vtkVertex ;
...
discard "forward decl of vtkPolyDataDummyContainter"
discard "forward decl of vtkIncrementalPointLocator"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkPolyData : public vtkPointSet { public : static vtkPolyData * New ( ) ; static vtkPolyData * ExtendedNew ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPointSet Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPointSet :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPolyData :: IsTypeOf ( type ) ; } static vtkPolyData * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPolyData * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPolyData * NewInstance ( ) const { return vtkPolyData :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPointSet :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPolyData :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPolyData :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Return what type of dataset this is.
##  int GetDataObjectType ( ) override { return VTK_POLY_DATA ; } *
##  Copy the geometric and topological structure of an input poly data object.
##  void CopyStructure ( vtkDataSet * ds ) override ; /@{ *
##  Standard vtkDataSet interface.
##  vtkIdType GetNumberOfCells ( ) override ; using vtkDataSet :: GetCell ; vtkCell * GetCell ( vtkIdType cellId ) override ; void GetCell ( vtkIdType cellId , vtkGenericCell * cell ) override ; int GetCellType ( vtkIdType cellId ) override ; vtkIdType GetCellSize ( vtkIdType cellId ) override ; void GetCellBounds ( vtkIdType cellId , double bounds [ 6 ] ) override ; void GetCellNeighbors ( vtkIdType cellId , vtkIdList * ptIds , vtkIdList * cellIds ) override ; /@} *
...
##  vtkIdType GetNumberOfVerts ( ) { return ( this -> Verts ? this -> Verts -> GetNumberOfCells ( ) : 0 ) ; } vtkIdType GetNumberOfLines ( ) { return ( this -> Lines ? this -> Lines -> GetNumberOfCells ( ) : 0 ) ; } vtkIdType GetNumberOfPolys ( ) { return ( this -> Polys ? this -> Polys -> GetNumberOfCells ( ) : 0 ) ; } vtkIdType GetNumberOfStrips ( ) { return ( this -> Strips ? this -> Strips -> GetNumberOfCells ( ) : 0 ) ; } /@} *
...
##  void Allocate ( vtkIdType numCells = 1000 , int vtkNotUsed ( extSize ) = 1000 ) { this -> AllocateExact ( numCells , numCells ) ; } *
...
##  void Allocate ( vtkPolyData * inPolyData , vtkIdType numCells = 1000 , int vtkNotUsed ( extSize ) = 1000 ) { this -> AllocateProportional ( inPolyData , static_cast < double > ( numCells ) / inPolyData -> GetNumberOfCells ( ) ) ; } *
...
##  virtual void SetLinks ( vtkAbstractCellLinks * links ) ; virtual vtkAbstractCellLinks * Getname ( ) { vtkDebugWithObjectMacro ( this , <<  returning  name  address  << static_cast < vtkAbstractCellLinks * > ( this -> Links ) ) ; return this -> Links ; } ; /@} *
...
##  unsigned char GetCellPoints ( vtkIdType cellId , vtkIdType & npts , vtkIdType const * & pts ) VTK_SIZEHINT ( pts , npts ) ; *
...
##  void GetCellPoints ( vtkIdType cellId , vtkIdType & npts , vtkIdType const * & pts , vtkIdList * ptIds ) VTK_SIZEHINT ( pts , npts ) override ; *
...
##  @{
##  void ReplaceCell ( vtkIdType cellId , vtkIdList * ids ) ; void ReplaceCell ( vtkIdType cellId , int npts , const vtkIdType pts [ ] ) VTK_SIZEHINT ( pts , npts ) ; *@} *
...
##  method only when the dataset is set as Editable.
##  void DeletePoint ( vtkIdType ptId ) ; void DeleteCell ( vtkIdType cellId ) ; /@} *
...
##  method only when the dataset is set as Editable.
##  vtkIdType InsertNextLinkedPoint ( int numLinks ) ; vtkIdType InsertNextLinkedPoint ( double x [ 3 ] , int numLinks ) ; /@} *
...
##  static vtkPolyData * GetData ( vtkInformation * info ) ; static vtkPolyData * GetData ( vtkInformationVector * v , int i = 0 ) ; /@} *
...
##  enum { ERR_NO_SUCH_FIELD = - 4 , ERR_INCORRECT_FIELD = - 3 , ERR_NON_MANIFOLD_STAR = - 2 , REGULAR_POINT = - 1 , MINIMUM = 0 , SADDLE = 1 , MAXIMUM = 2 } ; int GetScalarFieldCriticalIndex ( vtkIdType pointId , vtkDataArray * scalarField ) ; int GetScalarFieldCriticalIndex ( vtkIdType pointId , int fieldId ) ; int GetScalarFieldCriticalIndex ( vtkIdType pointId , const char * fieldName ) ; *
...
##  exists in memory.
##  unsigned char GetCell ( vtkIdType cellId , const vtkIdType * & pts ) ; protected : vtkPolyData ( ) ; ~ vtkPolyData ( ) override ; using TaggedCellId = vtkPolyData_detail :: TaggedCellId ; using CellMap = vtkPolyData_detail :: CellMap ; vtkCellArray * GetCellArrayInternal ( TaggedCellId tag ) ;  constant cell objects returned by GetCell called. vtkSmartPointer < vtkVertex > Vertex ; vtkSmartPointer < vtkPolyVertex > PolyVertex ; vtkSmartPointer < vtkLine > Line ; vtkSmartPointer < vtkPolyLine > PolyLine ; vtkSmartPointer < vtkTriangle > Triangle ; vtkSmartPointer < vtkQuad > Quad ; vtkSmartPointer < vtkPolygon > Polygon ; vtkSmartPointer < vtkTriangleStrip > TriangleStrip ; vtkSmartPointer < vtkEmptyCell > EmptyCell ;  points inherited
##  point data (i.e., scalars, vectors, normals, tcoords) inherited vtkSmartPointer < vtkCellArray > Verts ; vtkSmartPointer < vtkCellArray > Lines ; vtkSmartPointer < vtkCellArray > Polys ; vtkSmartPointer < vtkCellArray > Strips ;  supporting structures for more complex topological operations
##  built only when necessary vtkSmartPointer < CellMap > Cells ; vtkSmartPointer < vtkCellLinks > Links ; vtkNew < vtkIdList > LegacyBuffer ;  dummy static member below used as a trick to simplify traversal static vtkPolyDataDummyContainter DummyContainer ;  Take into account only points that belong to at least one cell. double CellsBounds [ 6 ] ; vtkTimeStamp CellsBoundsTime ; private : void Cleanup ( ) ; private : vtkPolyData ( const vtkPolyData & ) = delete ; void operator = ( const vtkPolyData & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

## ------------------------------------------------------------------------------

proc GetPointCells*(ptId: vtkIdType; ncells: var vtkIdType; cells: ptr vtkIdType) {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::GetPointCells(@)",
...
proc GetCellType*(cellId: vtkIdType): cint {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::GetCellType(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc GetCellSize*(cellId: vtkIdType): vtkIdType {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::GetCellSize(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc IsTriangle*(v1: cint; v2: cint; v3: cint): cint {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::IsTriangle(@)", header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc IsPointUsedByCell*(ptId: vtkIdType; cellId: vtkIdType): cint {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::IsPointUsedByCell(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc DeletePoint*(ptId: vtkIdType) {.importcpp: "VTKCOMMONDATAMODEL_EXPORT::DeletePoint(@)",
                                  header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc DeleteCell*(cellId: vtkIdType) {.importcpp: "VTKCOMMONDATAMODEL_EXPORT::DeleteCell(@)",
                                   header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc RemoveCellReference*(cellId: vtkIdType) {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::RemoveCellReference(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc AddCellReference*(cellId: vtkIdType) {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::AddCellReference(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc ResizeCellList*(ptId: vtkIdType; size: cint) {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::ResizeCellList(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------
...
proc ReplaceCellPoint*(cellId: vtkIdType; oldPtId: vtkIdType; newPtId: vtkIdType) {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::ReplaceCellPoint(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------

proc GetCellPoints*(cellId: vtkIdType; npts: var vtkIdType; pts: ptr vtkIdType): cuchar {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::GetCellPoints(@)",
    header: "vtkPolyData.h".}
## ------------------------------------------------------------------------------
