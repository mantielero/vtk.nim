...
## !!!Ignored construct:  # vtkLineWidget_h [NewLine] # vtkLineWidget_h [NewLine] # vtk3DWidget.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro # vtkLineSource.h  For passing calls to it [NewLine] class vtkActor ;
...
discard "forward decl of vtkPointWidget"
discard "forward decl of vtkPWCallback"
discard "forward decl of vtkPW1Callback"
discard "forward decl of vtkPW2Callback"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkLineWidget : public vtk3DWidget { public : *
##  Instantiate the object.
##  static vtkLineWidget * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtk3DWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtk3DWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkLineWidget :: IsTypeOf ( type ) ; } static vtkLineWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkLineWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkLineWidget * NewInstance ( ) const { return vtkLineWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtk3DWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkLineWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkLineWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  void SetResolution ( int r ) { this -> LineSource -> SetResolution ( r ) ; } int GetResolution ( ) { return this -> LineSource -> GetResolution ( ) ; } *
##  Set/Get the position of first end point.
##  void SetPoint1 ( double x , double y , double z ) ; void SetPoint1 ( double x [ 3 ] ) { this -> SetPoint1 ( x [ 0 ] , x [ 1 ] , x [ 2 ] ) ; } double * GetPoint1 ( ) VTK_SIZEHINT ( 3 ) { return this -> LineSource -> GetPoint1 ( ) ; } void GetPoint1 ( double xyz [ 3 ] ) { this -> LineSource -> GetPoint1 ( xyz ) ; } *
##  Set position of other end point.
##  void SetPoint2 ( double x , double y , double z ) ; void SetPoint2 ( double x [ 3 ] ) { this -> SetPoint2 ( x [ 0 ] , x [ 1 ] , x [ 2 ] ) ; } double * GetPoint2 ( ) VTK_SIZEHINT ( 3 ) { return this -> LineSource -> GetPoint2 ( ) ; } void GetPoint2 ( double xyz [ 3 ] ) { this -> LineSource -> GetPoint2 ( xyz ) ; } /@{ *
...
##  not aligned.
##  virtual void SetAlign ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << Align  to  << _arg ) ; if ( this -> Align != ( _arg < XAxis ? XAxis : ( _arg > None ? None : _arg ) ) ) { this -> Align = ( _arg < XAxis ? XAxis : ( _arg > None ? None : _arg ) ) ; this -> Modified ( ) ; } } virtual int GetAlignMinValue ( ) { return XAxis ; } virtual int GetAlignMaxValue ( ) { return None ; } ; virtual int GetAlign ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Align  of  << this -> Align ) ; return this -> Align ; } ; void SetAlignToXAxis ( ) { this -> SetAlign ( XAxis ) ; } void SetAlignToYAxis ( ) { this -> SetAlign ( YAxis ) ; } void SetAlignToZAxis ( ) { this -> SetAlign ( ZAxis ) ; } void SetAlignToNone ( ) { this -> SetAlign ( None ) ; } /@} /@{ *
...
##  virtual void SetClampToBounds ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  ClampToBounds  to  << _arg ) ; if ( this -> ClampToBounds != _arg ) { this -> ClampToBounds = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetAlignClampToBounds ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ClampToBounds  of  << this -> ClampToBounds ) ; return this -> ClampToBounds ; } ; virtual void ClampToBoundsOn ( ) { this -> SetClampToBounds ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void ClampToBoundsOff ( ) { this -> SetClampToBounds ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} *
...
##  virtual vtkProperty * GetnameHandlePropertySelectedHandlePropertyLineProperty ( ) { vtkDebugWithObjectMacro ( this , <<  returning  LineProperty  address  << static_cast < vtkProperty * > ( this -> LineProperty ) ) ; return this -> LineProperty ; } ; virtual vtkProperty * GetnameHandlePropertySelectedHandlePropertyLinePropertySelectedLineProperty ( ) { vtkDebugWithObjectMacro ( this , <<  returning  SelectedLineProperty  address  << static_cast < vtkProperty * > ( this -> SelectedLineProperty ) ) ; return this -> SelectedLineProperty ; } ; /@} protected : vtkLineWidget ( ) ; ~ vtkLineWidget ( ) override ;  Manage the state of the widget friend class vtkPWCallback ; int State ; enum WidgetState { Start = 0 , MovingHandle , MovingLine , Scaling , Outside } ;  handles the events static void ProcessEvents ( vtkObject * object , unsigned long event , void * clientdata , void * calldata ) ;  ProcessEvents() dispatches to these methods. void OnLeftButtonDown ( ) ; void OnLeftButtonUp ( ) ; void OnMiddleButtonDown ( ) ; void OnMiddleButtonUp ( ) ; void OnRightButtonDown ( ) ; void OnRightButtonUp ( ) ; virtual void OnMouseMove ( ) ;  controlling ivars int Align ; enum AlignmentState { XAxis , YAxis , ZAxis , None } ;  the line vtkActor * LineActor ; vtkPolyDataMapper * LineMapper ; vtkLineSource * LineSource ; void HighlightLine ( int highlight ) ;  glyphs representing hot spots (e.g., handles) vtkActor * * Handle ; vtkPolyDataMapper * * HandleMapper ; vtkSphereSource * * HandleGeometry ; void BuildRepresentation ( ) ; void SizeHandles ( ) override ; void HandlesOn ( double length ) ; void HandlesOff ( ) ; int HighlightHandle ( vtkProp * prop ) ;  returns cell id void HighlightHandles ( int highlight ) ;  Do the picking vtkCellPicker * HandlePicker ; vtkCellPicker * LinePicker ; vtkActor * CurrentHandle ; double LastPosition [ 3 ] ; void SetLinePosition ( double x [ 3 ] ) ;  Register internal Pickers within PickingManager void RegisterPickers ( ) override ;  Methods to manipulate the hexahedron. void Scale ( double * p1 , double * p2 , int X , int Y ) ;  Initial bounds vtkTypeBool ClampToBounds ; void ClampPosition ( double x [ 3 ] ) ; int InBounds ( double x [ 3 ] ) ;  Properties used to control the appearance of selected objects and
##  the manipulator in general. vtkProperty * HandleProperty ; vtkProperty * SelectedHandleProperty ; vtkProperty * LineProperty ; vtkProperty * SelectedLineProperty ; void CreateDefaultProperties ( ) ; void GenerateLine ( ) ;  Methods for managing the point widgets used to control the endpoints vtkPointWidget * PointWidget ; vtkPointWidget * PointWidget1 ; vtkPointWidget * PointWidget2 ; vtkPWCallback * PWCallback ; vtkPW1Callback * PW1Callback ; vtkPW2Callback * PW2Callback ; vtkPointWidget * CurrentPointWidget ; void EnablePointWidget ( ) ; void DisablePointWidget ( ) ; int ForwardEvent ( unsigned long event ) ; private : vtkLineWidget ( const vtkLineWidget & ) = delete ; void operator = ( const vtkLineWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
