...
## !!!Ignored construct:  # vtkIdList_h [NewLine] # vtkIdList_h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkObject.h [NewLine] class VTKCOMMONCORE_EXPORT vtkIdList : public vtkObject { public : /@{ *
##  Standard methods for instantiation, type information, and printing.
##  static vtkIdList * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkIdList :: IsTypeOf ( type ) ; } static vtkIdList * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkIdList * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkIdList * NewInstance ( ) const { return vtkIdList :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkIdList :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkIdList :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  vtkIdType GetId ( const vtkIdType i ) VTK_EXPECTS ( 0 <= i && i < GetNumberOfIds ( ) ) { return this -> Ids [ i ] ; } *
##  Find the location i of the provided id.
##  vtkIdType FindIdLocation ( const vtkIdType id ) { for ( int i = 0 ; i < this -> NumberOfIds ; i ++ ) if ( this -> Ids [ i ] == id ) return i ; return - 1 ; } *
...
##  void SetId ( const vtkIdType i , const vtkIdType vtkid ) VTK_EXPECTS ( 0 <= i && i < GetNumberOfIds ( ) ) { this -> Ids [ i ] = vtkid ; } *
...
##  vtkIdType * Resize ( const vtkIdType sz ) ; # __VTK_WRAP__ [NewLine] *
...
##  call.
##  vtkIdType * Release ( ) ; # [NewLine] /@{ *
##  To support range-based `for` loops
##  vtkIdType * begin ( ) { return this -> Ids ; } vtkIdType * end ( ) { return this -> Ids + this -> NumberOfIds ; } const vtkIdType * begin ( ) const { return this -> Ids ; } const vtkIdType * end ( ) const { return this -> Ids + this -> NumberOfIds ; } /@} protected : vtkIdList ( ) ; ~ vtkIdList ( ) override ; vtkIdType NumberOfIds ; vtkIdType Size ; vtkIdType * Ids ; bool ManageMemory ; private : vtkIdList ( const vtkIdList & ) = delete ; void operator = ( const vtkIdList & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

##  In-lined for performance

proc InsertId*(i: vtkIdType; vtkid: vtkIdType) {.
    importcpp: "VTKCOMMONCORE_EXPORT::InsertId(@)", header: "vtkIdList.h".}
##  In-lined for performance

proc InsertNextId*(vtkid: vtkIdType): vtkIdType {.
    importcpp: "VTKCOMMONCORE_EXPORT::InsertNextId(@)", header: "vtkIdList.h".}
proc IsId*(vtkid: vtkIdType): vtkIdType {.importcpp: "VTKCOMMONCORE_EXPORT::IsId(@)",
                                      header: "vtkIdList.h".}