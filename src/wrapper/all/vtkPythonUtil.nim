...
## !!!Ignored construct:  # vtkPythonUtil_h [NewLine] # vtkPythonUtil_h [NewLine] # PyVTKNamespace.h [NewLine] # PyVTKObject.h [NewLine] # PyVTKSpecialObject.h [NewLine] # vtkPython.h [NewLine] # vtkPythonCompatibility.h [NewLine] # defined ( _MSC_VER )  Visual Studio  some docstrings trigger "decimal digit terminates octal escape sequence" # warning ( disable : 4125 ) [NewLine] # [NewLine] class vtkPythonClassMap ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPythonCommand"
discard "forward decl of vtkPythonCommandList"
discard "forward decl of vtkPythonGhostMap"
discard "forward decl of vtkPythonObjectMap"
discard "forward decl of vtkPythonSpecialTypeMap"
discard "forward decl of vtkPythonNamespaceMap"
discard "forward decl of vtkPythonEnumMap"
discard "forward decl of vtkPythonModuleList"
discard "forward decl of vtkStdString"
discard "forward decl of vtkVariant"
proc vtkPythonUtilDelete*() {.importcpp: "vtkPythonUtilDelete(@)",
                            header: "vtkPythonUtil.h".}
## !!!Ignored construct:  class VTKWRAPPINGPYTHONCORE_EXPORT vtkPythonUtil { public : *
...
##  static PyTypeObject * AddClassToMap ( PyTypeObject * pytype , PyMethodDef * methods , const char * classname , vtknewfunc constructor ) ; *
...
##  static PyTypeObject * AddSpecialTypeToMap ( PyTypeObject * pytype , PyMethodDef * methods , PyMethodDef * constructors , vtkcopyfunc copyfunc ) ; *
##  Get information about a special VTK type, given the type name.
...
##  static void RegisterPythonCommand ( vtkPythonCommand * ) ; static void UnRegisterPythonCommand ( vtkPythonCommand * ) ; /@} private : vtkPythonUtil ( ) ; ~ vtkPythonUtil ( ) ; vtkPythonUtil ( const vtkPythonUtil & ) = delete ; void operator = ( const vtkPythonUtil & ) = delete ; vtkPythonObjectMap * ObjectMap ; vtkPythonGhostMap * GhostMap ; vtkPythonClassMap * ClassMap ; vtkPythonSpecialTypeMap * SpecialTypeMap ; vtkPythonNamespaceMap * NamespaceMap ; vtkPythonEnumMap * EnumMap ; vtkPythonModuleList * ModuleList ; vtkPythonCommandList * PythonCommandList ; friend void vtkPythonUtilDelete ( ) ; friend void vtkPythonUtilCreateIfNeeded ( ) ; } ;
## Error: token expected: ; but got: [identifier]!!!

##  For use by SetXXMethod() , SetXXMethodArgDelete()

## !!!Ignored construct:  extern VTKWRAPPINGPYTHONCORE_EXPORT void vtkPythonVoidFunc ( void * ) ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  extern VTKWRAPPINGPYTHONCORE_EXPORT void vtkPythonVoidFuncArgDelete ( void * ) ;
## Error: token expected: ; but got: [identifier]!!!
