...
## !!!Ignored construct:  # vtkParseMangle_h [NewLine] # vtkParseMangle_h [NewLine] # vtkWrappingToolsModule.h [NewLine] # < stddef . h > [NewLine] # __cplusplus [NewLine] extern C { # [NewLine] *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_MangledTypeName ( const char * name , char * new_name ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_MangledLiteral ( const char * name , char * new_name ) ; # __cplusplus [NewLine] }  extern "C" # [NewLine] # [NewLine]  VTK-HeaderTest-Exclude: vtkParseMangle.h
