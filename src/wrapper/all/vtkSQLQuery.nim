...
## !!!Ignored construct:  # vtkSQLQuery_h [NewLine] # vtkSQLQuery_h [NewLine] # vtkIOSQLModule.h  For export macro # vtkRowQuery.h [NewLine] # vtkStdString.h  for EscapeString() [NewLine] class vtkSQLDatabase ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkVariant"
discard "forward decl of vtkVariantArray"
## !!!Ignored construct:  class VTKIOSQL_EXPORT vtkSQLQuery : public vtkRowQuery { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkRowQuery Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkRowQuery :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkSQLQuery :: IsTypeOf ( type ) ; } static vtkSQLQuery * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkSQLQuery * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkSQLQuery * NewInstance ( ) const { return vtkSQLQuery :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkRowQuery :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkSQLQuery :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkSQLQuery :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  virtual bool SetQuery ( const char * query ) ; virtual const char * GetQuery ( ) ; /@} *
...
##  nothing.
##  virtual bool BeginTransaction ( ) { return true ; } virtual bool CommitTransaction ( ) { return true ; } virtual bool RollbackTransaction ( ) { return true ; } /@{ *
##  Return the database associated with the query.
##  virtual vtkSQLDatabase * GetnameDatabase ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Database  address  << static_cast < vtkSQLDatabase * > ( this -> Database ) ) ; return this -> Database ; } ; /@} *
...
##  virtual bool BindParameter ( int index , unsigned char value ) ; virtual bool BindParameter ( int index , unsigned short value ) ; virtual bool BindParameter ( int index , unsigned int value ) ; virtual bool BindParameter ( int index , unsigned long value ) ;  The C and C++ standards leave it up to each compiler to decide
##  whether chars are signed or unsigned by default.  All the other
##  types are signed unless otherwise specified. virtual bool BindParameter ( int index , signed char value ) ; virtual bool BindParameter ( int index , short value ) ; virtual bool BindParameter ( int index , int value ) ; virtual bool BindParameter ( int index , long value ) ; virtual bool BindParameter ( int index , unsigned long long value ) ; virtual bool BindParameter ( int index , long long value ) ; virtual bool BindParameter ( int index , float value ) ; virtual bool BindParameter ( int index , double value ) ; *
##  Bind a string value -- string must be null-terminated
##  virtual bool BindParameter ( int index , const char * stringValue ) ; *
##  Bind a string value by specifying an array and a size
##  virtual bool BindParameter ( int index , const char * stringValue , size_t length ) ; virtual bool BindParameter ( int index , const vtkStdString & string ) ; virtual bool BindParameter ( int index , vtkVariant var ) ; *
...
##  char * EscapeString ( const char * src , bool addSurroundingQuotes ) ; protected : vtkSQLQuery ( ) ; ~ vtkSQLQuery ( ) override ; *
...
##  GetQueryInstance().
##  void SetDatabase ( vtkSQLDatabase * db ) ; char * Query ; vtkSQLDatabase * Database ; bool Active ; private : vtkSQLQuery ( const vtkSQLQuery & ) = delete ; void operator = ( const vtkSQLQuery & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
