...
## !!!Ignored construct:  # QVTKOpenGLNativeWidget_h [NewLine] # QVTKOpenGLNativeWidget_h [NewLine] # < QOpenGLWidget > [NewLine] # < QScopedPointer >  for QScopedPointer. [NewLine] # QVTKInteractor.h  needed for QVTKInteractor # vtkGUISupportQtModule.h  for export macro # vtkNew.h  needed for vtkNew # vtkSmartPointer.h  needed for vtkSmartPointer [NewLine] class QVTKInteractor ;
...
##  void setDefaultCursor ( const QCursor & cursor ) ; const QCursor & defaultCursor ( ) const { return this -> DefaultCursor ; } /@} protected Q_SLOTS : *
