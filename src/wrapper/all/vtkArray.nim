...
## !!!Ignored construct:  # vtkArray_h [NewLine] # vtkArray_h [NewLine] # vtkArrayCoordinates.h  for vtkArrayCoordinates # vtkArrayExtents.h  for vtkArrayExtents # vtkCommonCoreModule.h  For export macro # vtkObject.h [NewLine] # vtkStdString.h  for vtkStdString # vtkVariant.h  for vtkVariant [NewLine] class VTKCOMMONCORE_EXPORT vtkArray : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkArray :: IsTypeOf ( type ) ; } static vtkArray * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkArray * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkArray * NewInstance ( ) const { return vtkArray :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkArray :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkArray :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; typedef vtkArrayExtents :: CoordinateT CoordinateT ; typedef vtkArrayExtents :: DimensionT DimensionT ; typedef vtkArrayExtents :: SizeT SizeT ; enum { / Used with CreateArray() to create dense arrays DENSE = 0 , / Used with CreateArray() to create sparse arrays SPARSE = 1 } ; *
...
##  VTK_NEWINSTANCE static vtkArray * CreateArray ( int StorageType , int ValueType ) ; *
...
##  void Resize ( const CoordinateT i ) ; void Resize ( const CoordinateT i , const CoordinateT j ) ; void Resize ( const CoordinateT i , const CoordinateT j , const CoordinateT k ) ; void Resize ( const vtkArrayRange & i ) ; void Resize ( const vtkArrayRange & i , const vtkArrayRange & j ) ; void Resize ( const vtkArrayRange & i , const vtkArrayRange & j , const vtkArrayRange & k ) ; void Resize ( const vtkArrayExtents & extents ) ; /@} *
...
##  inline vtkVariant GetVariantValue ( CoordinateT i ) ; inline vtkVariant GetVariantValue ( CoordinateT i , CoordinateT j ) ; inline vtkVariant GetVariantValue ( CoordinateT i , CoordinateT j , CoordinateT k ) ; virtual vtkVariant GetVariantValue ( const vtkArrayCoordinates & coordinates ) = 0 ; /@} *
...
##  virtual void CopyValue ( vtkArray * source , const vtkArrayCoordinates & source_coordinates , const vtkArrayCoordinates & target_coordinates ) = 0 ; virtual void CopyValue ( vtkArray * source , const SizeT source_index , const vtkArrayCoordinates & target_coordinates ) = 0 ; virtual void CopyValue ( vtkArray * source , const vtkArrayCoordinates & source_coordinates , const SizeT target_index ) = 0 ; /@} *
##  Returns a new array that is a deep copy of this array.
##  virtual vtkArray * DeepCopy ( ) = 0 ; protected : vtkArray ( ) ; ~ vtkArray ( ) override ; private : vtkArray ( const vtkArray & ) = delete ; void operator = ( const vtkArray & ) = delete ; *
...
proc GetVariantValue*(i: CoordinateT): vtkVariant {.
    importcpp: "VTKCOMMONCORE_EXPORT::GetVariantValue(@)", header: "vtkArray.h".}
proc GetVariantValue*(i: CoordinateT; j: CoordinateT): vtkVariant {.
    importcpp: "VTKCOMMONCORE_EXPORT::GetVariantValue(@)", header: "vtkArray.h".}
proc GetVariantValue*(i: CoordinateT; j: CoordinateT; k: CoordinateT): vtkVariant {.
    importcpp: "VTKCOMMONCORE_EXPORT::GetVariantValue(@)", header: "vtkArray.h".}
proc SetVariantValue*(i: CoordinateT; value: vtkVariant) {.
    importcpp: "VTKCOMMONCORE_EXPORT::SetVariantValue(@)", header: "vtkArray.h".}
proc SetVariantValue*(i: CoordinateT; j: CoordinateT; value: vtkVariant) {.
    importcpp: "VTKCOMMONCORE_EXPORT::SetVariantValue(@)", header: "vtkArray.h".}
proc SetVariantValue*(i: CoordinateT; j: CoordinateT; k: CoordinateT; value: vtkVariant) {.
    importcpp: "VTKCOMMONCORE_EXPORT::SetVariantValue(@)", header: "vtkArray.h".}