...
## !!!Ignored construct:  # vtkCellCentersPointPlacer_h [NewLine] # vtkCellCentersPointPlacer_h [NewLine] # vtkInteractionWidgetsModule.h  For export macro # vtkPointPlacer.h [NewLine] class vtkRenderer ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPropCollection"
discard "forward decl of vtkProp"
discard "forward decl of vtkCellPicker"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkCellCentersPointPlacer : public vtkPointPlacer { public : *
##  Instantiate this class.
##  static vtkCellCentersPointPlacer * New ( ) ; /@{ *
##  Standard methods for instances of this class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPointPlacer Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPointPlacer :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkCellCentersPointPlacer :: IsTypeOf ( type ) ; } static vtkCellCentersPointPlacer * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkCellCentersPointPlacer * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkCellCentersPointPlacer * NewInstance ( ) const { return vtkCellCentersPointPlacer :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPointPlacer :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkCellCentersPointPlacer :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkCellCentersPointPlacer :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@}  Descuription:
##  Add an actor (that represents a terrain in a rendererd scene) to the
##  list. Only props in this list are considered by the PointPlacer virtual void AddProp ( vtkProp * ) ; virtual void RemoveViewProp ( vtkProp * prop ) ; virtual void RemoveAllProps ( ) ; int HasProp ( vtkProp * ) ; int GetNumberOfProps ( ) ; *
...
##  Get the Prop picker.
##  virtual vtkCellPicker * GetnameCellPicker ( ) { vtkDebugWithObjectMacro ( this , <<  returning  CellPicker  address  << static_cast < vtkCellPicker * > ( this -> CellPicker ) ) ; return this -> CellPicker ; } ; /@} /@{ *
...
##  virtual void SetMode ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Mode  to  << _arg ) ; if ( this -> Mode != _arg ) { this -> Mode = _arg ; this -> Modified ( ) ; } } ; virtual int GetMode ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Mode  of  << this -> Mode ) ; return this -> Mode ; } ; /@} enum { ParametricCenter = 0 , CellPointsMean , None } ; protected : vtkCellCentersPointPlacer ( ) ; ~ vtkCellCentersPointPlacer ( ) override ;  The props that represents the terrain data (one or more) in a rendered
##  scene vtkPropCollection * PickProps ; vtkCellPicker * CellPicker ; int Mode ; private : vtkCellCentersPointPlacer ( const vtkCellCentersPointPlacer & ) = delete ; void operator = ( const vtkCellCentersPointPlacer & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
