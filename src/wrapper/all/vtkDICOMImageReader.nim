...
## !!!Ignored construct:  # vtkDICOMImageReader_h [NewLine] # vtkDICOMImageReader_h [NewLine] # vtkIOImageModule.h  For export macro # vtkImageReader2.h [NewLine] class vtkDICOMImageReaderVector ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of DICOMParser"
discard "forward decl of DICOMAppHelper"
## !!!Ignored construct:  class VTKIOIMAGE_EXPORT vtkDICOMImageReader : public vtkImageReader2 { public : /@{ *
##  Static method for construction.
##  static vtkDICOMImageReader * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkImageReader2 Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkImageReader2 :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDICOMImageReader :: IsTypeOf ( type ) ; } static vtkDICOMImageReader * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDICOMImageReader * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDICOMImageReader * NewInstance ( ) const { return vtkDICOMImageReader :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkImageReader2 :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDICOMImageReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDICOMImageReader :: New ( ) ; } public : ; /@} *
##  Prints the ivars.
##  void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
##  Set the filename for the file to read. If this method is used,
##  the reader will only read a single file.
##  void SetFileName ( VTK_FILEPATH const char * fn ) override { delete [ ] this -> DirectoryName ; delete [ ] this -> FileName ; this -> DirectoryName = nullptr ; this -> FileName = nullptr ; this -> vtkImageReader2 :: SetFileName ( fn ) ; } /@} *
...
##  virtual VTK_FILEPATH VTK_FUTURE_CONST char * GetDirectoryName ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << DirectoryName  of  << ( this -> DirectoryName ? this -> DirectoryName : (null) ) ) ; return this -> DirectoryName ; } ; /@} *
...
##  const char * GetDescriptiveName ( ) override { return DICOM ; } protected :
##  Setup the volume size
##  void SetupOutputInformation ( int num_slices ) ; void ExecuteInformation ( ) override ; void ExecuteDataWithInformation ( vtkDataObject * out , vtkInformation * outInfo ) override ;
##  Constructor
##  vtkDICOMImageReader ( ) ;
##  Destructor
...
##  vtkDICOMImageReaderVector * DICOMFileNames ; char * DirectoryName ; char * PatientName ; char * StudyUID ; char * StudyID ; char * TransferSyntaxUID ;  DICOMFileNames accessor methods for subclasses: int GetNumberOfDICOMFileNames ( ) ; VTK_FILEPATH const char * GetDICOMFileName ( int index ) ; private : vtkDICOMImageReader ( const vtkDICOMImageReader & ) = delete ; void operator = ( const vtkDICOMImageReader & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
