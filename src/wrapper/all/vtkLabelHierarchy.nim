...
## !!!Ignored construct:  # vtkLabelHierarchy_h [NewLine] # vtkLabelHierarchy_h [NewLine] # vtkPointSet.h [NewLine] # vtkRenderingLabelModule.h  For export macro [NewLine] class vtkAbstractArray ;
...
discard "forward decl of vtkLabelHierarchyIterator"
discard "forward decl of vtkPoints"
discard "forward decl of vtkPolyData"
discard "forward decl of vtkRenderer"
discard "forward decl of vtkTextProperty"
## !!!Ignored construct:  class VTKRENDERINGLABEL_EXPORT vtkLabelHierarchy : public vtkPointSet { public : static vtkLabelHierarchy * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPointSet Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPointSet :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkLabelHierarchy :: IsTypeOf ( type ) ; } static vtkLabelHierarchy * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkLabelHierarchy * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkLabelHierarchy * NewInstance ( ) const { return vtkLabelHierarchy :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPointSet :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkLabelHierarchy :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkLabelHierarchy :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual void SetTargetLabelCount ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  TargetLabelCount  to  << _arg ) ; if ( this -> TargetLabelCount != _arg ) { this -> TargetLabelCount = _arg ; this -> Modified ( ) ; } } ; virtual int GetTargetLabelCount ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << TargetLabelCount  of  << this -> TargetLabelCount ) ; return this -> TargetLabelCount ; } ; /@} /@{ *
##  The maximum depth of the octree.
##  virtual void SetTargetLabelCountMaximumDepth ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  MaximumDepth  to  << _arg ) ; if ( this -> MaximumDepth != _arg ) { this -> MaximumDepth = _arg ; this -> Modified ( ) ; } } ; virtual int GetTargetLabelCountMaximumDepth ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << MaximumDepth  of  << this -> MaximumDepth ) ; return this -> MaximumDepth ; } ; /@} *
...
##  virtual void SetTextProperty ( vtkTextProperty * tprop ) ; virtual vtkTextProperty * GetnameTextProperty ( ) { vtkDebugWithObjectMacro ( this , <<  returning  TextProperty  address  << static_cast < vtkTextProperty * > ( this -> TextProperty ) ) ; return this -> TextProperty ; } ; /@} /@{ *
##  Set/get the array specifying the importance (priority) of each label.
##  virtual void SetPriorities ( vtkDataArray * arr ) ; virtual vtkDataArray * GetnameTextPropertyPriorities ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Priorities  address  << static_cast < vtkDataArray * > ( this -> Priorities ) ) ; return this -> Priorities ; } ; /@} /@{ *
##  Set/get the array specifying the text of each label.
##  virtual void SetLabels ( vtkAbstractArray * arr ) ; virtual vtkAbstractArray * GetnameTextPropertyPrioritiesLabels ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Labels  address  << static_cast < vtkAbstractArray * > ( this -> Labels ) ) ; return this -> Labels ; } ; /@} /@{ *
##  Set/get the array specifying the orientation of each label.
##  virtual void SetOrientations ( vtkDataArray * arr ) ; virtual vtkDataArray * GetnameTextPropertyPrioritiesLabelsOrientations ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Orientations  address  << static_cast < vtkDataArray * > ( this -> Orientations ) ) ; return this -> Orientations ; } ; /@} /@{ *
##  Set/get the array specifying the icon index of each label.
##  virtual void SetIconIndices ( vtkIntArray * arr ) ; virtual vtkIntArray * GetnameTextPropertyPrioritiesLabelsOrientationsIconIndices ( ) { vtkDebugWithObjectMacro ( this , <<  returning  IconIndices  address  << static_cast < vtkIntArray * > ( this -> IconIndices ) ) ; return this -> IconIndices ; } ; /@} /@{ *
##  Set/get the array specifying the size of each label.
##  virtual void SetSizes ( vtkDataArray * arr ) ; virtual vtkDataArray * GetnameTextPropertyPrioritiesLabelsOrientationsIconIndicesSizes ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Sizes  address  << static_cast < vtkDataArray * > ( this -> Sizes ) ) ; return this -> Sizes ; } ; /@} /@{ *
##  Set/get the array specifying the maximum width and height in world coordinates of each label.
##  virtual void SetBoundedSizes ( vtkDataArray * arr ) ; virtual vtkDataArray * GetnameTextPropertyPrioritiesLabelsOrientationsIconIndicesSizesBoundedSizes ( ) { vtkDebugWithObjectMacro ( this , <<  returning  BoundedSizes  address  << static_cast < vtkDataArray * > ( this -> BoundedSizes ) ) ; return this -> BoundedSizes ; } ; /@} *
...
##  vtkIdType GetNumberOfCells ( ) override ; using vtkDataSet :: GetCell ; vtkCell * GetCell ( vtkIdType ) override ; void GetCell ( vtkIdType , vtkGenericCell * ) override ; int GetCellType ( vtkIdType ) override ; void GetCellPoints ( vtkIdType , vtkIdList * ) override ; void GetPointCells ( vtkIdType , vtkIdList * ) override ; vtkIdType FindCell ( double * , vtkCell * , vtkIdType , double , int & , double * , double * ) override ; vtkIdType FindCell ( double * , vtkCell * , vtkGenericCell * , vtkIdType , double , int & , double * , double * ) override ; int GetMaxCellSize ( ) override ; /@} class Implementation ; Implementation * GetImplementation ( ) { return this -> Impl ; } /@{ *
##  Provide access to original coordinates of sets of coincident points
##  virtual vtkPoints * GetnameTextPropertyPrioritiesLabelsOrientationsIconIndicesSizesBoundedSizesCenterPts ( ) { vtkDebugWithObjectMacro ( this , <<  returning  CenterPts  address  << static_cast < vtkPoints * > ( this -> CenterPts ) ) ; return this -> CenterPts ; } ; /@} /@{ *
...
##  without overlap.
##  virtual vtkCoincidentPoints * GetnameTextPropertyPrioritiesLabelsOrientationsIconIndicesSizesBoundedSizesCenterPtsCoincidentPoints ( ) { vtkDebugWithObjectMacro ( this , <<  returning  CoincidentPoints  address  << static_cast < vtkCoincidentPoints * > ( this -> CoincidentPoints ) ) ; return this -> CoincidentPoints ; } ; /@} /@{ *
...
##  static void GetAnchorFrustumPlanes ( double frustumPlanes [ 24 ] , vtkRenderer * ren , vtkCoordinate * anchorTransform ) ; /@} protected : vtkLabelHierarchy ( ) ; ~ vtkLabelHierarchy ( ) override ; int TargetLabelCount ; int MaximumDepth ; vtkDataArray * Priorities ; vtkAbstractArray * Labels ; vtkDataArray * Orientations ; vtkIntArray * IconIndices ; vtkDataArray * Sizes ; vtkDataArray * BoundedSizes ; vtkCoincidentPoints * CoincidentPoints ; vtkPoints * CenterPts ; vtkTextProperty * TextProperty ; Implementation * Impl ; friend class vtkLabelHierarchyFrustumIterator ; friend class vtkLabelHierarchyFullSortIterator ; friend class implementation ; private : vtkLabelHierarchy ( const vtkLabelHierarchy & ) = delete ; void operator = ( const vtkLabelHierarchy & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
