...
## !!!Ignored construct:  # vtkVariantArray_h [NewLine] # vtkVariantArray_h [NewLine] # vtkAbstractArray.h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkVariant.h  For variant type [NewLine] class vtkVariantArrayLookup ;
## Error: token expected: ; but got: [identifier]!!!

## / Forward declaration required for Boost serialization

discard "forward decl of access"
## !!!Ignored construct:  class VTKCOMMONCORE_EXPORT vtkVariantArray : public vtkAbstractArray { / Friendship required for Boost serialization friend class boost :: serialization :: access ; public : enum DeleteMethod { VTK_DATA_ARRAY_FREE = vtkAbstractArray :: VTK_DATA_ARRAY_FREE , VTK_DATA_ARRAY_DELETE = vtkAbstractArray :: VTK_DATA_ARRAY_DELETE , VTK_DATA_ARRAY_ALIGNED_FREE = vtkAbstractArray :: VTK_DATA_ARRAY_ALIGNED_FREE , VTK_DATA_ARRAY_USER_DEFINED = vtkAbstractArray :: VTK_DATA_ARRAY_USER_DEFINED } ; static vtkVariantArray * New ( ) ; static vtkVariantArray * ExtendedNew ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractArray Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractArray :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkVariantArray :: IsTypeOf ( type ) ; } static vtkVariantArray * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkVariantArray * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkVariantArray * NewInstance ( ) const { return vtkVariantArray :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractArray :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkVariantArray :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkVariantArray :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ;
...
##  Note that memory allocation is performed as necessary to hold the data.
##  void InsertTuples ( vtkIdList * dstIds , vtkIdList * srcIds , vtkAbstractArray * source ) override ; void InsertTuplesStartingAt ( vtkIdType dstStart , vtkIdList * srcIds , vtkAbstractArray * source ) override ; *
...
##  void SetVoidArray ( void * arr , vtkIdType size , int save ) override ; void SetVoidArray ( void * arr , vtkIdType size , int save , int deleteM ) override ; /@} *
...
##  void SetValue ( vtkIdType id , vtkVariant value ) VTK_EXPECTS ( 0 <= id && id < this -> GetNumberOfValues ( ) ) ; *
...
##  vtkIdType LookupValue ( vtkVariant value ) override ; void LookupValue ( vtkVariant value , vtkIdList * ids ) override ; /@} *
...
##  ~ vtkVariantArray ( ) override ; protected :  Construct object with default tuple dimension (number of components) of 1. vtkVariantArray ( ) ;  Pointer to data vtkVariant * Array ;  Function to resize data vtkVariant * ResizeAndExtend ( vtkIdType sz ) ; void ( * DeleteFunction ) ( void * ) ; private : vtkVariantArray ( const vtkVariantArray & ) = delete ; void operator = ( const vtkVariantArray & ) = delete ; vtkVariantArrayLookup * Lookup ; void UpdateLookup ( ) ; } ;
## Error: token expected: ; but got: [identifier]!!!
