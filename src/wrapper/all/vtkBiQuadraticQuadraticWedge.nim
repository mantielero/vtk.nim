...
## !!!Ignored construct:  # vtkBiQuadraticQuadraticWedge_h [NewLine] # vtkBiQuadraticQuadraticWedge_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkNonLinearCell.h [NewLine] class vtkQuadraticEdge ;
...
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkBiQuadraticQuadraticWedge : public vtkNonLinearCell { public : static vtkBiQuadraticQuadraticWedge * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkNonLinearCell Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkNonLinearCell :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkBiQuadraticQuadraticWedge :: IsTypeOf ( type ) ; } static vtkBiQuadraticQuadraticWedge * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkBiQuadraticQuadraticWedge * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkBiQuadraticQuadraticWedge * NewInstance ( ) const { return vtkBiQuadraticQuadraticWedge :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkNonLinearCell :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkBiQuadraticQuadraticWedge :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkBiQuadraticQuadraticWedge :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
##  Implement the vtkCell API. See the vtkCell API for descriptions
##  of these methods.
##  int GetCellType ( ) override { return VTK_BIQUADRATIC_QUADRATIC_WEDGE ; } int GetCellDimension ( ) override { return 3 ; } int GetNumberOfEdges ( ) override { return 9 ; } int GetNumberOfFaces ( ) override { return 5 ; } vtkCell * GetEdge ( int edgeId ) override ; vtkCell * GetFace ( int faceId ) override ; /@} int CellBoundary ( int subId , const double pcoords [ 3 ] , vtkIdList * pts ) override ; void Contour ( double value , vtkDataArray * cellScalars , vtkIncrementalPointLocator * locator , vtkCellArray * verts , vtkCellArray * lines , vtkCellArray * polys , vtkPointData * inPd , vtkPointData * outPd , vtkCellData * inCd , vtkIdType cellId , vtkCellData * outCd ) override ; int EvaluatePosition ( const double x [ 3 ] , double * closestPoint , int & subId , double pcoords [ 3 ] , double & dist2 , double * weights ) override ; void EvaluateLocation ( int & subId , const double pcoords [ 3 ] , double x [ 3 ] , double * weights ) override ; int Triangulate ( int index , vtkIdList * ptIds , vtkPoints * pts ) override ; void Derivatives ( int subId , const double pcoords [ 3 ] , const double * values , int dim , double * derivs ) override ; double * GetParametricCoords ( ) override ; *
...
##  int GetParametricCenter ( double pcoords [ 3 ] ) override ; static void InterpolationFunctions ( const double pcoords [ 3 ] , double weights [ 15 ] ) ; static void InterpolationDerivs ( const double pcoords [ 3 ] , double derivs [ 45 ] ) ; /@{ *
##  Compute the interpolation functions/derivatives
##  (aka shape functions/derivatives)
##  void InterpolateFunctions ( const double pcoords [ 3 ] , double weights [ 15 ] ) override { vtkBiQuadraticQuadraticWedge :: InterpolationFunctions ( pcoords , weights ) ; } void InterpolateDerivs ( const double pcoords [ 3 ] , double derivs [ 45 ] ) override { vtkBiQuadraticQuadraticWedge :: InterpolationDerivs ( pcoords , derivs ) ; } /@}
## /@{ *
...
##  void JacobianInverse ( const double pcoords [ 3 ] , double * * inverse , double derivs [ 45 ] ) ; protected : vtkBiQuadraticQuadraticWedge ( ) ; ~ vtkBiQuadraticQuadraticWedge ( ) override ; vtkQuadraticEdge * Edge ; vtkQuadraticTriangle * TriangleFace ; vtkBiQuadraticQuad * Face ; vtkWedge * Wedge ; vtkDoubleArray * Scalars ;  used to avoid New/Delete in contouring/clipping private : vtkBiQuadraticQuadraticWedge ( const vtkBiQuadraticQuadraticWedge & ) = delete ; void operator = ( const vtkBiQuadraticQuadraticWedge & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
...
proc GetParametricCenter*(pcoords: array[3, cdouble]): cint {.
    ...
    header: "vtkBiQuadraticQuadraticWedge.h".}