...
## !!!Ignored construct:  # vtkDiscreteFlyingEdgesClipper2D_h [NewLine] # vtkDiscreteFlyingEdgesClipper2D_h [NewLine] # vtkContourValues.h  Needed for direct access to ContourValues # vtkFiltersGeneralModule.h  For export macro # vtkPolyDataAlgorithm.h [NewLine] class vtkImageData ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKFILTERSGENERAL_EXPORT vtkDiscreteFlyingEdgesClipper2D : public vtkPolyDataAlgorithm { public : /@{ *
##  Standard methods for instantiation, printing, and type information.
##  static vtkDiscreteFlyingEdgesClipper2D * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPolyDataAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPolyDataAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDiscreteFlyingEdgesClipper2D :: IsTypeOf ( type ) ; } static vtkDiscreteFlyingEdgesClipper2D * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDiscreteFlyingEdgesClipper2D * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDiscreteFlyingEdgesClipper2D * NewInstance ( ) const { return vtkDiscreteFlyingEdgesClipper2D :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPolyDataAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDiscreteFlyingEdgesClipper2D :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDiscreteFlyingEdgesClipper2D :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  defaults to 0.
##  virtual void SetComputeScalarsArrayComponent ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  ArrayComponent  to  << _arg ) ; if ( this -> ArrayComponent != _arg ) { this -> ArrayComponent = _arg ; this -> Modified ( ) ; } } ; virtual int GetComputeScalarsArrayComponent ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ArrayComponent  of  << this -> ArrayComponent ) ; return this -> ArrayComponent ; } ; /@} protected : vtkDiscreteFlyingEdgesClipper2D ( ) ; ~ vtkDiscreteFlyingEdgesClipper2D ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int FillInputPortInformation ( int port , vtkInformation * info ) override ; vtkContourValues * ContourValues ; int ComputeScalars ; int ArrayComponent ; private : vtkDiscreteFlyingEdgesClipper2D ( const vtkDiscreteFlyingEdgesClipper2D & ) = delete ; void operator = ( const vtkDiscreteFlyingEdgesClipper2D & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
