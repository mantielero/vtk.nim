...
## !!!Ignored construct:  # vtkRearrangeFields_h [NewLine] # vtkRearrangeFields_h [NewLine] # vtkDataSetAlgorithm.h [NewLine] # vtkFiltersCoreModule.h  For export macro [NewLine] # vtkDataSetAttributes.h  Needed for NUM_ATTRIBUTES [NewLine] class vtkFieldData ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKFILTERSCORE_EXPORT vtkRearrangeFields : public vtkDataSetAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkDataSetAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkDataSetAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkRearrangeFields :: IsTypeOf ( type ) ; } static vtkRearrangeFields * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkRearrangeFields * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkRearrangeFields * NewInstance ( ) const { return vtkRearrangeFields :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkDataSetAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkRearrangeFields :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkRearrangeFields :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Create a new vtkRearrangeFields with an empty operation list.
##  static vtkRearrangeFields * New ( ) ; enum OperationType { COPY = 0 , MOVE = 1 } ; enum FieldLocation { DATA_OBJECT = 0 , POINT_DATA = 1 , CELL_DATA = 2 } ; *
...
##  void RemoveAllOperations ( ) { this -> Modified ( ) ; this -> LastId = 0 ; this -> DeleteAllOperations ( ) ; } /@} enum FieldType { NAME , ATTRIBUTE } ; struct Operation { int OperationType ;  COPY or MOVE int FieldType ;  NAME or ATTRIBUTE char * FieldName ; int AttributeType ; int FromFieldLoc ;  fd, pd or do int ToFieldLoc ;  fd, pd or do int Id ;  assigned during creation Operation * Next ;  linked list Operation ( ) { FieldName = nullptr ; } ~ Operation ( ) { delete [ ] FieldName ; } } ; protected : vtkRearrangeFields ( ) ; ~ vtkRearrangeFields ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ;  Operations are stored as a linked list. Operation * Head ; Operation * Tail ;  This is incremented whenever a new operation is created.
##  It is not decremented when an operation is deleted. int LastId ;  Methods to browse/modify the linked list. Operation * GetNextOperation ( Operation * op ) { return op -> Next ; } Operation * GetFirst ( ) { return this -> Head ; } void AddOperation ( Operation * op ) ; void DeleteOperation ( Operation * op , Operation * before ) ; Operation * FindOperation ( int id , Operation * & before ) ; Operation * FindOperation ( const char * name , Operation * & before ) ; Operation * FindOperation ( int operationType , const char * name , int fromFieldLoc , int toFieldLoc , Operation * & before ) ; Operation * FindOperation ( int operationType , int attributeType , int fromFieldLoc , int toFieldLoc , Operation * & before ) ;  Used when finding/deleting an operation given a signature. int CompareOperationsByType ( const Operation * op1 , const Operation * op2 ) ; int CompareOperationsByName ( const Operation * op1 , const Operation * op2 ) ; void DeleteAllOperations ( ) ; void ApplyOperation ( Operation * op , vtkDataSet * input , vtkDataSet * output ) ;  Given location (DATA_OBJECT, CELL_DATA, POINT_DATA) return the
##  pointer to the corresponding field data. vtkFieldData * GetFieldDataFromLocation ( vtkDataSet * ds , int fieldLoc ) ;  Used by AddOperation() and RemoveOperation() designed to be used
##  from other language bindings. static char OperationTypeNames [ 2 ] [ 5 ] ; static char FieldLocationNames [ 3 ] [ 12 ] ; static char AttributeNames [ vtkDataSetAttributes :: NUM_ATTRIBUTES ] [ 10 ] ; void PrintAllOperations ( ostream & os , vtkIndent indent ) ; void PrintOperation ( Operation * op , ostream & os , vtkIndent indent ) ; private : vtkRearrangeFields ( const vtkRearrangeFields & ) = delete ; void operator = ( const vtkRearrangeFields & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
