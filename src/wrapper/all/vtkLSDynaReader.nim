...
## !!!Ignored construct:  # vtkLSDynaReader_h [NewLine] # vtkLSDynaReader_h [NewLine] # vtkIOLSDynaModule.h  For export macro # vtkLegacy.h  For VTK_LEGACY_REMOVE # vtkMultiBlockDataSetAlgorithm.h [NewLine] # < string >  for method signature [NewLine] class LSDynaMetaData ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkLSDynaPartCollection"
discard "forward decl of vtkPoints"
discard "forward decl of vtkDataArray"
discard "forward decl of vtkUnsignedCharArray"
discard "forward decl of vtkUnstructuredGrid"
## !!!Ignored construct:  class VTKIOLSDYNA_EXPORT vtkLSDynaReader : public vtkMultiBlockDataSetAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkMultiBlockDataSetAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkMultiBlockDataSetAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkLSDynaReader :: IsTypeOf ( type ) ; } static vtkLSDynaReader * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkLSDynaReader * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkLSDynaReader * NewInstance ( ) const { return vtkLSDynaReader :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkMultiBlockDataSetAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkLSDynaReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkLSDynaReader :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkLSDynaReader * New ( ) ; *
...
##  whether it is valid.
##  virtual void SetDatabaseDirectory ( VTK_FILEPATH const std :: string & ) ; virtual void SetDatabaseDirectory ( VTK_FILEPATH const char * ) ; # VTK_LEGACY_REMOVE [NewLine] VTK_FILEPATH std :: string GetDatabaseDirectory ( ) ; # [NewLine] VTK_LEGACY ( VTK_FILEPATH const char * GetDatabaseDirectory ( ) ) ; # [NewLine] int IsDatabaseValid ( ) ; /@} /@{ *
...
##  virtual void SetFileName ( VTK_FILEPATH const std :: string & ) ; virtual void SetFileName ( VTK_FILEPATH const char * ) ; # VTK_LEGACY_REMOVE [NewLine] VTK_FILEPATH std :: string GetFileName ( ) ; # [NewLine] VTK_LEGACY ( VTK_FILEPATH const char * GetFileName ( ) ) ; # [NewLine] /@} *
...
##  vtkIdType GetNumberOfTimeSteps ( ) ; virtual void SetTimeStep ( vtkIdType ) ; vtkIdType GetTimeStep ( ) ; double GetTimeValue ( vtkIdType ) ; virtual int * GetTimeStepRange ( ) VTK_SIZEHINT ( 2 ) { vtkDebugWithObjectMacro ( this , <<  returning  << TimeStepRange  pointer  << this -> TimeStepRange ) ; return this -> TimeStepRange ; } VTK_WRAPEXCLUDE virtual void GetTimeStepRange ( int & _arg1 , int & _arg2 ) { _arg1 = this -> TimeStepRange [ 0 ] ; _arg2 = this -> TimeStepRange [ 1 ] ; vtkDebugWithObjectMacro ( this , <<  returning  << TimeStepRange  = ( << _arg1 << , << _arg2 << ) ) ; } VTK_WRAPEXCLUDE virtual void GetTimeStepRange ( int _arg [ 2 ] ) { this -> GetTimeStepRange ( _arg [ 0 ] , _arg [ 1 ] ) ; } ; virtual void SetTimeStepRange ( int _arg1 , int _arg2 ) { vtkDebugWithObjectMacro ( this , <<  setting  << TimeStepRange  to ( << _arg1 << , << _arg2 << ) ) ; if ( ( this -> TimeStepRange [ 0 ] != _arg1 ) || ( this -> TimeStepRange [ 1 ] != _arg2 ) ) { this -> TimeStepRange [ 0 ] = _arg1 ; this -> TimeStepRange [ 1 ] = _arg2 ; this -> Modified ( ) ; } } void SetTimeStepRange ( const int _arg [ 2 ] ) { this -> SetTimeStepRange ( _arg [ 0 ] , _arg [ 1 ] ) ; } ; /@} /@{ *
##  These methods allow you to load only selected subsets of the nodal
##  variables defined over the mesh.
##  int GetNumberOfPointArrays ( ) ; const char * GetPointArrayName ( int ) ; virtual void SetPointArrayStatus ( int arr , int status ) ; virtual void SetPointArrayStatus ( const char * arrName , int status ) ; int GetPointArrayStatus ( int arr ) ; int GetPointArrayStatus ( const char * arrName ) ; int GetNumberOfComponentsInPointArray ( int arr ) ; int GetNumberOfComponentsInPointArray ( const char * arrName ) ; /@} /@{ *
...
##  int GetNumberOfCellArrays ( int cellType ) ; const char * GetCellArrayName ( int cellType , int arr ) ; virtual void SetCellArrayStatus ( int cellType , int arr , int status ) ; virtual void SetCellArrayStatus ( int cellType , const char * arrName , int status ) ; int GetCellArrayStatus ( int cellType , int arr ) ; int GetCellArrayStatus ( int cellType , const char * arrName ) ; int GetNumberOfComponentsInCellArray ( int cellType , int arr ) ; int GetNumberOfComponentsInCellArray ( int cellType , const char * arrName ) ; /@} /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfSolidArrays ( ) ; const char * GetSolidArrayName ( int ) ; virtual void SetSolidArrayStatus ( int arr , int status ) ; virtual void SetSolidArrayStatus ( const char * arrName , int status ) ; int GetSolidArrayStatus ( int arr ) ; int GetSolidArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInSolidArray ( int a ) ; int GetNumberOfComponentsInSolidArray ( const char * arrName ) ; /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfThickShellArrays ( ) ; const char * GetThickShellArrayName ( int ) ; virtual void SetThickShellArrayStatus ( int arr , int status ) ; virtual void SetThickShellArrayStatus ( const char * arrName , int status ) ; int GetThickShellArrayStatus ( int arr ) ; int GetThickShellArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInThickShellArray ( int a ) ; int GetNumberOfComponentsInThickShellArray ( const char * arrName ) ; /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfShellArrays ( ) ; const char * GetShellArrayName ( int ) ; virtual void SetShellArrayStatus ( int arr , int status ) ; virtual void SetShellArrayStatus ( const char * arrName , int status ) ; int GetShellArrayStatus ( int arr ) ; int GetShellArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInShellArray ( int a ) ; int GetNumberOfComponentsInShellArray ( const char * arrName ) ; /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfRigidBodyArrays ( ) ; const char * GetRigidBodyArrayName ( int ) ; virtual void SetRigidBodyArrayStatus ( int arr , int status ) ; virtual void SetRigidBodyArrayStatus ( const char * arrName , int status ) ; int GetRigidBodyArrayStatus ( int arr ) ; int GetRigidBodyArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInRigidBodyArray ( int a ) ; int GetNumberOfComponentsInRigidBodyArray ( const char * arrName ) ; /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfRoadSurfaceArrays ( ) ; const char * GetRoadSurfaceArrayName ( int ) ; virtual void SetRoadSurfaceArrayStatus ( int arr , int status ) ; virtual void SetRoadSurfaceArrayStatus ( const char * arrName , int status ) ; int GetRoadSurfaceArrayStatus ( int arr ) ; int GetRoadSurfaceArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInRoadSurfaceArray ( int a ) ; int GetNumberOfComponentsInRoadSurfaceArray ( const char * arrName ) ; /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfBeamArrays ( ) ; const char * GetBeamArrayName ( int ) ; virtual void SetBeamArrayStatus ( int arr , int status ) ; virtual void SetBeamArrayStatus ( const char * arrName , int status ) ; int GetBeamArrayStatus ( int arr ) ; int GetBeamArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInBeamArray ( int a ) ; int GetNumberOfComponentsInBeamArray ( const char * arrName ) ; /@{ *
##  These methods allow you to load only selected subsets of the cell
##  variables defined over the mesh.
##  int GetNumberOfParticleArrays ( ) ; const char * GetParticleArrayName ( int ) ; virtual void SetParticleArrayStatus ( int arr , int status ) ; virtual void SetParticleArrayStatus ( const char * arrName , int status ) ; int GetParticleArrayStatus ( int arr ) ; int GetParticleArrayStatus ( const char * arrName ) ; /@} int GetNumberOfComponentsInParticleArray ( int a ) ; int GetNumberOfComponentsInParticleArray ( const char * arrName ) ; /@{ *
...
##  void SetDeformedMesh ( vtkTypeBool ) ; virtual vtkTypeBool GetDeformedMesh ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << DeformedMesh  of  << this -> DeformedMesh ) ; return this -> DeformedMesh ; } ; virtual void DeformedMeshOn ( ) { this -> SetDeformedMesh ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void DeformedMeshOff ( ) { this -> SetDeformedMesh ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  virtual void SetRemoveDeletedCells ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  RemoveDeletedCells  to  << _arg ) ; if ( this -> RemoveDeletedCells != _arg ) { this -> RemoveDeletedCells = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetDeformedMeshRemoveDeletedCells ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << RemoveDeletedCells  of  << this -> RemoveDeletedCells ) ; return this -> RemoveDeletedCells ; } ; virtual void RemoveDeletedCellsOn ( ) { this -> SetDeformedMeshRemoveDeletedCells ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void RemoveDeletedCellsOff ( ) { this -> SetDeformedMeshRemoveDeletedCells ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
##  Instead of removing the cells that are dead, hide them by setting
##  the array as the ghost levels arrays
##  virtual void SetRemoveDeletedCellsDeletedCellsAsGhostArray ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  DeletedCellsAsGhostArray  to  << _arg ) ; if ( this -> DeletedCellsAsGhostArray != _arg ) { this -> DeletedCellsAsGhostArray = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetDeformedMeshRemoveDeletedCellsDeletedCellsAsGhostArray ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << DeletedCellsAsGhostArray  of  << this -> DeletedCellsAsGhostArray ) ; return this -> DeletedCellsAsGhostArray ; } ; virtual void DeletedCellsAsGhostArrayOn ( ) { this -> SetDeformedMeshRemoveDeletedCellsDeletedCellsAsGhostArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void DeletedCellsAsGhostArrayOff ( ) { this -> SetDeformedMeshRemoveDeletedCellsDeletedCellsAsGhostArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  virtual void SetInputDeck ( const char * _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << InputDeck  to  << ( _arg ? _arg : (null) ) ) ; if ( this -> InputDeck == nullptr && _arg == nullptr ) { return ; } if ( this -> InputDeck && _arg && ( ! strcmp ( this -> InputDeck , _arg ) ) ) { return ; } delete [ ] this -> InputDeck ; if ( _arg ) { size_t n = strlen ( _arg ) + 1 ; char * cp1 = new char [ n ] ; const char * cp2 = ( _arg ) ; this -> InputDeck = cp1 ; do { * cp1 ++ = * cp2 ++ ; } while ( -- n ) ; } else { this -> InputDeck = nullptr ; } this -> Modified ( ) ; } ; virtual char * GetInputDeck ( ) { vtkDebugWithObjectMacro ( this , <<  returning  << InputDeck  of  << ( this -> InputDeck ? this -> InputDeck : (null) ) ) ; return this -> InputDeck ; } ; /@} /@{ *
...
##  int GetNumberOfPartArrays ( ) ; const char * GetPartArrayName ( int ) ; virtual void SetPartArrayStatus ( int arr , int status ) ; virtual void SetPartArrayStatus ( const char * partName , int status ) ; int GetPartArrayStatus ( int arr ) ; int GetPartArrayStatus ( const char * partName ) ; /@} protected :  holds all the parts and all the properties for each part vtkLSDynaPartCollection * Parts ; *
##  Should deflected coordinates be used, or should the mesh remain
##  undeflected?  By default, this is true.
##  vtkTypeBool DeformedMesh ; /@{ *
##  Should cells marked as deleted be removed from the mesh?
##  By default, this is true.
##  vtkTypeBool RemoveDeletedCells ; vtkTypeBool DeletedCellsAsGhostArray ; /@} *
...
##  char * InputDeck ; vtkLSDynaReader ( ) ; ~ vtkLSDynaReader ( ) override ; *
...
##  int ScanDatabaseTimeSteps ( ) ; int RequestInformation ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; /@{ *
...
##  virtual int ReadTopology ( ) ; virtual int ReadNodes ( ) ; virtual int ReadPartSizes ( ) ; virtual int ReadConnectivityAndMaterial ( ) ; virtual int ReadUserIds ( ) ; virtual int ReadState ( vtkIdType ) ; virtual int ReadNodeStateInfo ( vtkIdType ) ; virtual int ReadCellStateInfo ( vtkIdType ) ; virtual int ReadDeletion ( ) ; virtual int ReadSPHState ( vtkIdType ) ; virtual int ComputeDeflectionAndUpdateGeometry ( vtkUnstructuredGrid * grid ) ; /@} *
...
##  int ReadInputDeckXML ( istream & deck ) ; int ReadInputDeckKeywords ( istream & deck ) ; /@} *
...
##  virtual void ReadCellProperties ( const int & type , const int & numTuples ) ; LSDynaMetaData * P ; void ResetPartsCache ( ) ; private :  Helper templated methods to optimize reading. We cast the entire buffer
##  to a given type instead of casting each element to improve performance template < typename T > void FillDeletionArray ( T * buffer , vtkUnsignedCharArray * arr , const vtkIdType & start , const vtkIdType & numCells , const int & deathPos , const int & cellSize ) ; template < int wordSize , typename T > int FillTopology ( T * buffer ) ; template < typename T , int blockType , vtkIdType numWordsPerCell , vtkIdType cellLength > void ReadBlockCellSizes ( ) ; template < typename T > int FillPartSizes ( ) ; vtkLSDynaReader ( const vtkLSDynaReader & ) = delete ; void operator = ( const vtkLSDynaReader & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

proc SetPointArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetPointArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetPointArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetPointArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInPointArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInPointArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetCellArrayStatus*(cellType: cint; arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetCellArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetCellArrayStatus*(cellType: cint; arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetCellArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInCellArray*(cellType: cint; arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInCellArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetSolidArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetSolidArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetSolidArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetSolidArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInSolidArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInSolidArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetThickShellArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetThickShellArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetThickShellArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetThickShellArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInThickShellArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInThickShellArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetShellArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetShellArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetShellArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetShellArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInShellArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInShellArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetBeamArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetBeamArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetBeamArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetBeamArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInBeamArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInBeamArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetParticleArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetParticleArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetParticleArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetParticleArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInParticleArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInParticleArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetRigidBodyArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetRigidBodyArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetRigidBodyArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetRigidBodyArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInRigidBodyArray*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInRigidBodyArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetRoadSurfaceArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetRoadSurfaceArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetRoadSurfaceArrayStatus*(arrName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetRoadSurfaceArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetNumberOfComponentsInRoadSurfaceArray*(arrName: cstring): cint {.importcpp: "VTKIOLSDYNA_EXPORT::GetNumberOfComponentsInRoadSurfaceArray(@)",
    header: "vtkLSDynaReader.h".}
proc SetPartArrayStatus*(arrName: cstring; status: cint) {.
    importcpp: "VTKIOLSDYNA_EXPORT::SetPartArrayStatus(@)",
    header: "vtkLSDynaReader.h".}
proc GetPartArrayStatus*(partName: cstring): cint {.
    importcpp: "VTKIOLSDYNA_EXPORT::GetPartArrayStatus(@)",
    header: "vtkLSDynaReader.h".}