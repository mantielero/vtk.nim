...
## !!!Ignored construct:  # vtkImageStack_h [NewLine] # vtkImageStack_h [NewLine] # vtkImageSlice.h [NewLine] # vtkRenderingImageModule.h  For export macro [NewLine] class vtkImageSliceCollection ;
...
## !!!Ignored construct:  class VTKRENDERINGIMAGE_EXPORT vtkImageStack : public vtkImageSlice { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkImageSlice Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkImageSlice :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkImageStack :: IsTypeOf ( type ) ; } static vtkImageStack * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkImageStack * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkImageStack * NewInstance ( ) const { return vtkImageStack :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkImageSlice :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkImageStack :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkImageStack :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkImageStack * New ( ) ; *
...
##  virtual void SetActiveLayer ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  ActiveLayer  to  << _arg ) ; if ( this -> ActiveLayer != _arg ) { this -> ActiveLayer = _arg ; this -> Modified ( ) ; } } ; int GetActiveLayer ( ) { return this -> ActiveLayer ; } /@} *
...
##  double * GetBounds ( ) override ; void GetBounds ( double bounds [ 6 ] ) { this -> vtkProp3D :: GetBounds ( bounds ) ; } /@} *
...
##  int RenderOverlay ( vtkViewport * viewport ) override ; int RenderOpaqueGeometry ( vtkViewport * viewport ) override ; int RenderTranslucentPolygonalGeometry ( vtkViewport * viewport ) override ; /@} *
...
##  void InitPathTraversal ( ) override ; vtkAssemblyPath * GetNextPath ( ) override ; int GetNumberOfPaths ( ) override ; /@} *
##  WARNING: INTERNAL METHOD - NOT INTENDED FOR GENERAL USE
##  DO NOT USE THIS METHOD OUTSIDE OF THE RENDERING PROCESS
##  Used to construct assembly paths and perform part traversal.
##  void BuildPaths ( vtkAssemblyPaths * paths , vtkAssemblyPath * path ) override ; protected : vtkImageStack ( ) ; ~ vtkImageStack ( ) override ; void SetMapper ( vtkImageMapper3D * mapper ) ; void SetProperty ( vtkImageProperty * property ) ; void PokeMatrices ( vtkMatrix4x4 * matrix ) ; void UpdatePaths ( ) ; vtkTimeStamp PathTime ; vtkCollection * ImageMatrices ; vtkImageSliceCollection * Images ; int ActiveLayer ; private : vtkImageStack ( const vtkImageStack & ) = delete ; void operator = ( const vtkImageStack & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
