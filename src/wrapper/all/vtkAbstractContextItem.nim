...
## !!!Ignored construct:  # vtkAbstractContextItem_h [NewLine] # vtkAbstractContextItem_h [NewLine] # vtkObject.h [NewLine] # vtkRenderingContext2DModule.h  For export macro [NewLine] class vtkContext2D ;
...
## !!!Ignored construct:  class VTKRENDERINGCONTEXT2D_EXPORT vtkAbstractContextItem : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkAbstractContextItem :: IsTypeOf ( type ) ; } static vtkAbstractContextItem * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkAbstractContextItem * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkAbstractContextItem * NewInstance ( ) const { return vtkAbstractContextItem :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkAbstractContextItem :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkAbstractContextItem :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual bool GetVisible ( ) { vtkDebugWithObjectMacro ( this , << this -> GetClassName ( ) <<  ( << this << ): returning Visible of  << this -> Visible ) ; return this -> Visible ; } /@} /@{ *
##  Set the visibility of the item (should it be drawn).
##  Visible by default.
##  virtual void SetVisible ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Visible  to  << _arg ) ; if ( this -> Visible != _arg ) { this -> Visible = _arg ; this -> Modified ( ) ; } } ; /@} /@{ *
##  Get if the item is interactive (should respond to mouse events).
##  virtual bool GetInteractive ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Interactive  of  << this -> Interactive ) ; return this -> Interactive ; } ; /@} /@{ *
##  Set if the item is interactive (should respond to mouse events).
##  virtual void SetVisibleInteractive ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Interactive  to  << _arg ) ; if ( this -> Interactive != _arg ) { this -> Interactive = _arg ; this -> Modified ( ) ; } } ; /@} protected : vtkAbstractContextItem ( ) ; ~ vtkAbstractContextItem ( ) override ; *
...
##  bool Interactive ; private : vtkAbstractContextItem ( const vtkAbstractContextItem & ) = delete ; void operator = ( const vtkAbstractContextItem & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
