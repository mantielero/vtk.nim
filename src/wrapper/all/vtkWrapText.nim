...
## !!!Ignored construct:  # vtkWrapText_h [NewLine] # vtkWrapText_h [NewLine] # vtkParse.h [NewLine] # vtkParseHierarchy.h [NewLine] # vtkWrappingToolsModule.h [NewLine] # __cplusplus [NewLine] extern C { # [NewLine] *
...
##  VTKWRAPPINGTOOLS_EXPORT const char * vtkWrapText_FormatSignature ( const char * signature , size_t width , size_t maxlen ) ; *
...
##  as long as the input name, that is sufficient. VTKWRAPPINGTOOLS_EXPORT void vtkWrapText_PythonName ( const char * name , char * pname ) ; *
##  Check if a name is a reserved keyword in Python.
##  VTKWRAPPINGTOOLS_EXPORT int vtkWrapText_IsPythonKeyword ( const char * name ) ; # __cplusplus [NewLine] } # [NewLine] # [NewLine]  VTK-HeaderTest-Exclude: vtkWrapText.h
