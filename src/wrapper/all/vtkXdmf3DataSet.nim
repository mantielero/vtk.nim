...
## !!!Ignored construct:  # vtkXdmf3DataSet_h [NewLine] # vtkXdmf3DataSet_h [NewLine] # vtkIOXdmf3Module.h  For export macro [NewLine]  clang-format off # vtk_xdmf3.h [NewLine] # VTKXDMF3_HEADER ( core / XdmfSharedPtr . hpp ) [NewLine]  clang-format on # < string > Needed only for XdmfArray::getName :( [NewLine] class vtkXdmf3ArraySelection ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkXdmf3ArrayKeeper"
discard "forward decl of XdmfArray"
discard "forward decl of XdmfAttribute"
discard "forward decl of vtkDataArray"
discard "forward decl of XdmfGrid"
discard "forward decl of vtkDataObject"
discard "forward decl of XdmfSet"
discard "forward decl of vtkDataSet"
discard "forward decl of XdmfTopologyType"
discard "forward decl of XdmfRegularGrid"
discard "forward decl of vtkImageData"
discard "forward decl of XdmfRectilinearGrid"
discard "forward decl of vtkRectilinearGrid"
discard "forward decl of XdmfCurvilinearGrid"
discard "forward decl of vtkStructuredGrid"
discard "forward decl of XdmfUnstructuredGrid"
...
discard "forward decl of XdmfDomain"
## !!!Ignored construct:  class VTKIOXDMF3_EXPORT vtkXdmf3DataSet { public :  Common *
##  Returns a VTK array corresponding to the Xdmf array it is given.
##  static vtkDataArray * XdmfToVTKArray ( XdmfArray * xArray , std :: string attrName ,  TODO: needed because XdmfArray::getName() misbehaves unsigned int preferredComponents = 0 , vtkXdmf3ArrayKeeper * keeper = nullptr ) ; *
...
##  static unsigned int GetNumberOfPointsPerCell ( int vtk_cell_type , bool & fail ) ; static int GetVTKCellType ( shared_ptr < const XdmfTopologyType > topologyType ) ; static int GetXdmfCellType ( int vtkType ) ; /@} /@{ *
##  Helper used in VTKToXdmf to set the time in a Xdmf grid
##  static void SetTime ( XdmfGrid * grid , double hasTime , double time ) ; static void SetTime ( XdmfGraph * graph , double hasTime , double time ) ; /@}  vtkXdmf3RegularGrid *
...
##  static void VTKToXdmf ( vtkImageData * dataSet , XdmfDomain * domain , bool hasTime , double time , const char * name = 0 ) ;  vtkXdmf3RectilinearGrid *
##  Populates the VTK data set with the contents of the Xdmf grid
...
##  Populates the Xdmf Grid with the contents of the VTK data set
##  static void VTKToXdmf ( vtkRectilinearGrid * dataSet , XdmfDomain * domain , bool hasTime , double time , const char * name = 0 ) ;  vtkXdmf3CurvilinearGrid *
##  Populates the VTK data set with the contents of the Xdmf grid
...
##  Populates the Xdmf Grid with the contents of the VTK data set
##  static void VTKToXdmf ( vtkStructuredGrid * dataSet , XdmfDomain * domain , bool hasTime , double time , const char * name = 0 ) ;  vtkXdmf3UnstructuredGrid *
##  Populates the VTK data set with the contents of the Xdmf grid
...
##  Populates the Xdmf Grid with the contents of the VTK data set
##  static void VTKToXdmf ( vtkPointSet * dataSet , XdmfDomain * domain , bool hasTime , double time , const char * name = 0 ) ;  vtkXdmf3Graph *
...
##  Populates the Xdmf Grid with the contents of the VTK data set
##  static void VTKToXdmf ( vtkDirectedGraph * dataSet , XdmfDomain * domain , bool hasTime , double time , const char * name = 0 ) ;  Side Sets *
##  Populates the given VTK DataObject's attribute arrays with the selected
##  arrays from the Xdmf Grid
