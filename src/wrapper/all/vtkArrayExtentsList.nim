...
## !!!Ignored construct:  # vtkArrayExtentsList_h [NewLine] # vtkArrayExtentsList_h [NewLine] # vtkArrayExtents.h [NewLine] # vtkCommonCoreModule.h  For export macro # < vector >  STL Header [NewLine] class VTKCOMMONCORE_EXPORT vtkArrayExtentsList { public : *
...
##  Accesses the i-th slice.
##  const vtkArrayExtents & operator [ ] ( vtkIdType i ) const ; private : std :: vector < vtkArrayExtents > Storage ; } ;
