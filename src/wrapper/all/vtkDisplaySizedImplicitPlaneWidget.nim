...
##   Module:    vtkDisplaySizedImplicitPlaneWidget.h
##
...
## !!!Ignored construct:  # vtkDisplaySizedImplicitPlaneWidget_h [NewLine] # vtkDisplaySizedImplicitPlaneWidget_h [NewLine] # vtkAbstractWidget.h [NewLine] # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkDisplaySizedImplicitPlaneRepresentation ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkDisplaySizedImplicitPlaneInteractionCallback"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkDisplaySizedImplicitPlaneWidget : public vtkAbstractWidget { friend class vtkDisplaySizedImplicitPlaneInteractionCallback ; public : *
##  Instantiate the object.
##  static vtkDisplaySizedImplicitPlaneWidget * New ( ) ; /@{ *
##  Standard vtkObject methods
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDisplaySizedImplicitPlaneWidget :: IsTypeOf ( type ) ; } static vtkDisplaySizedImplicitPlaneWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDisplaySizedImplicitPlaneWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDisplaySizedImplicitPlaneWidget * NewInstance ( ) const { return vtkDisplaySizedImplicitPlaneWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDisplaySizedImplicitPlaneWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDisplaySizedImplicitPlaneWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
##  Specify an instance of vtkWidgetRepresentation used to represent this
##  widget in the scene. Note that the representation is a subclass of vtkProp
##  so it can be added to the renderer independent of the widget.
##  void SetRepresentation ( vtkDisplaySizedImplicitPlaneRepresentation * rep ) ;  Description:
...
##  vtkDisplaySizedImplicitPlaneRepresentation * GetDisplaySizedImplicitPlaneRepresentation ( ) { return reinterpret_cast < vtkDisplaySizedImplicitPlaneRepresentation * > ( this -> WidgetRep ) ; } *
##  Create the default widget representation if one is not set.
##  void CreateDefaultRepresentation ( ) override ; protected : vtkDisplaySizedImplicitPlaneWidget ( ) ; ~ vtkDisplaySizedImplicitPlaneWidget ( ) override ;  Manage the state of the widget int WidgetState ; enum WidgetStateType { Start = 0 , Active } ; # ! defined ( VTK_LEGACY_REMOVE ) [NewLine] VTK_DEPRECATED_IN_9_2_0 ( because leading underscore is reserved ) typedef WidgetStateType _WidgetState ; # [NewLine]  These methods handle events static void SelectAction ( vtkAbstractWidget * ) ; static void PickOriginAction ( vtkAbstractWidget * ) ; static void PickNormalAction ( vtkAbstractWidget * ) ; static void TranslateAction ( vtkAbstractWidget * ) ; static void ScaleAction ( vtkAbstractWidget * ) ; static void EndSelectAction ( vtkAbstractWidget * ) ; static void MoveAction ( vtkAbstractWidget * ) ; static void MovePlaneAction ( vtkAbstractWidget * ) ; static void SelectAction3D ( vtkAbstractWidget * ) ; static void EndSelectAction3D ( vtkAbstractWidget * ) ; static void MoveAction3D ( vtkAbstractWidget * ) ; static void TranslationAxisLock ( vtkAbstractWidget * ) ; static void TranslationAxisUnLock ( vtkAbstractWidget * ) ; *
...
##  vtkDisplaySizedImplicitPlaneInteractionCallback * InteractionCallback ; void InvokeInteractionCallback ( ) ; /@} private : vtkDisplaySizedImplicitPlaneWidget ( const vtkDisplaySizedImplicitPlaneWidget & ) = delete ; void operator = ( const vtkDisplaySizedImplicitPlaneWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
