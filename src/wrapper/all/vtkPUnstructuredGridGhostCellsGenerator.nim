...
## !!!Ignored construct:  # vtkPUnstructuredGridGhostCellsGenerator_h [NewLine] # vtkPUnstructuredGridGhostCellsGenerator_h [NewLine] # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_1_0 # vtkFiltersParallelGeometryModule.h  For export macro # vtkUnstructuredGridGhostCellsGenerator.h [NewLine] # < vector >  For passing data between methods [NewLine] class vtkMultiProcessController ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTK_DEPRECATED_IN_9_1_0 ( Use vtkGhostCellsGenerator instead ) vtkPUnstructuredGridGhostCellsGenerator : public vtkUnstructuredGridGhostCellsGenerator { protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkUnstructuredGridGhostCellsGenerator Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkUnstructuredGridGhostCellsGenerator :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPUnstructuredGridGhostCellsGenerator :: IsTypeOf ( type ) ; } static vtkPUnstructuredGridGhostCellsGenerator * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPUnstructuredGridGhostCellsGenerator * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPUnstructuredGridGhostCellsGenerator * NewInstance ( ) const { return vtkPUnstructuredGridGhostCellsGenerator :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkUnstructuredGridGhostCellsGenerator :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPUnstructuredGridGhostCellsGenerator :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPUnstructuredGridGhostCellsGenerator :: New ( ) ; } public : ; public : void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkPUnstructuredGridGhostCellsGenerator * New ( ) ; /@{ *
##  Set/Get the MPI multi process controller object.
##  void SetController ( vtkMultiProcessController * c ) ; virtual vtkMultiProcessController * GetnameController ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Controller  address  << static_cast < vtkMultiProcessController * > ( this -> Controller ) ) ; return this -> Controller ; } ; /@} protected : vtkPUnstructuredGridGhostCellsGenerator ( ) ; ~ vtkPUnstructuredGridGhostCellsGenerator ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; void GetFirstGhostLayer ( int , vtkUnstructuredGrid * ) ; void ExchangeBoundsAndDetermineNeighbors ( std :: vector < double > & ) ; void ExtractAndReduceSurfacePointsShareData ( std :: vector < double > & ) ; void ComputeSharedPoints ( ) ; void ExtractAndSendGhostCells ( vtkUnstructuredGridBase * ) ; void ReceiveAndMergeGhostCells ( int , int , vtkUnstructuredGridBase * , vtkUnstructuredGrid * ) ; void AddGhostLayer ( int ghostLevel , int maxGhostLevel ) ; void FindGhostCells ( ) ; void AddGlobalCellIds ( ) ; void RemoveGlobalCellIds ( ) ; vtkMultiProcessController * Controller ; private : struct vtkInternals ; vtkInternals * Internals ; vtkPUnstructuredGridGhostCellsGenerator ( const vtkPUnstructuredGridGhostCellsGenerator & ) = delete ; void operator = ( const vtkPUnstructuredGridGhostCellsGenerator & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
