...
## !!!Ignored construct:  # vtkArrayRange_h [NewLine] # vtkArrayRange_h [NewLine] # vtkArrayCoordinates.h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkSystemIncludes.h [NewLine] class VTKCOMMONCORE_EXPORT vtkArrayRange { public : typedef vtkArrayCoordinates :: CoordinateT CoordinateT ; *
...
##  VTKCOMMONCORE_EXPORT friend bool operator == ( const vtkArrayRange & lhs , const vtkArrayRange & rhs ) ; VTKCOMMONCORE_EXPORT friend bool operator != ( const vtkArrayRange & lhs , const vtkArrayRange & rhs ) ; /@} *
##  Serialization.
##  VTKCOMMONCORE_EXPORT friend ostream & operator << ( ostream & stream , const vtkArrayRange & rhs ) ; private : *
