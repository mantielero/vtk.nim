...
## !!!Ignored construct:  # vtkPriorityQueue_h [NewLine] # vtkPriorityQueue_h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkObject.h [NewLine] # vtkIdTypeArray.h  Needed for inline methods [NewLine] class VTKCOMMONCORE_EXPORT vtkPriorityQueue : public vtkObject { public : class Item { public : double priority ; vtkIdType id ; } ; *
##  Instantiate priority queue with default size and extension size of 1000.
##  static vtkPriorityQueue * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPriorityQueue :: IsTypeOf ( type ) ; } static vtkPriorityQueue * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPriorityQueue * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPriorityQueue * NewInstance ( ) const { return vtkPriorityQueue :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPriorityQueue :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPriorityQueue :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void Reset ( ) ; protected : vtkPriorityQueue ( ) ; ~ vtkPriorityQueue ( ) override ; Item * Resize ( const vtkIdType sz ) ; vtkIdTypeArray * ItemLocation ; Item * Array ; vtkIdType Size ; vtkIdType MaxId ; vtkIdType Extend ; private : vtkPriorityQueue ( const vtkPriorityQueue & ) = delete ; void operator = ( const vtkPriorityQueue & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

proc DeleteId*(id: vtkIdType): cdouble {.importcpp: "VTKCOMMONCORE_EXPORT::DeleteId(@)",
                                     header: "vtkPriorityQueue.h".}
proc GetPriority*(id: vtkIdType): cdouble {.importcpp: "VTKCOMMONCORE_EXPORT::GetPriority(@)",
                                        header: "vtkPriorityQueue.h".}
proc Peek*(location: vtkIdType; priority: var cdouble): vtkIdType {.
    importcpp: "VTKCOMMONCORE_EXPORT::Peek(@)", header: "vtkPriorityQueue.h".}
proc Peek*(location: vtkIdType): vtkIdType {.
    importcpp: "VTKCOMMONCORE_EXPORT::Peek(@)", header: "vtkPriorityQueue.h".}