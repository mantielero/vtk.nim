...
## !!!Ignored construct:  # vtkMutableUndirectedGraph_h [NewLine] # vtkMutableUndirectedGraph_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkUndirectedGraph.h [NewLine] class vtkEdgeListIterator ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkGraphEdge"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkMutableUndirectedGraph : public vtkUndirectedGraph { public : static vtkMutableUndirectedGraph * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkUndirectedGraph Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkUndirectedGraph :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkMutableUndirectedGraph :: IsTypeOf ( type ) ; } static vtkMutableUndirectedGraph * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkMutableUndirectedGraph * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkMutableUndirectedGraph * NewInstance ( ) const { return vtkMutableUndirectedGraph :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkUndirectedGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkMutableUndirectedGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkMutableUndirectedGraph :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void RemoveEdges ( vtkIdTypeArray * arr ) ; protected : vtkMutableUndirectedGraph ( ) ; ~ vtkMutableUndirectedGraph ( ) override ; *
##  Graph edge that is reused of AddGraphEdge calls.
##  vtkGraphEdge * GraphEdge ; private : vtkMutableUndirectedGraph ( const vtkMutableUndirectedGraph & ) = delete ; void operator = ( const vtkMutableUndirectedGraph & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
