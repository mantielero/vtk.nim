...
## !!!Ignored construct:  # vtkCenteredSliderWidget_h [NewLine] # vtkCenteredSliderWidget_h [NewLine] # vtkAbstractWidget.h [NewLine] # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkSliderRepresentation ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkCenteredSliderWidget : public vtkAbstractWidget { public : *
##  Instantiate the class.
##  static vtkCenteredSliderWidget * New ( ) ; /@{ *
##  Standard macros.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkCenteredSliderWidget :: IsTypeOf ( type ) ; } static vtkCenteredSliderWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkCenteredSliderWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkCenteredSliderWidget * NewInstance ( ) const { return vtkCenteredSliderWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkCenteredSliderWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkCenteredSliderWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  double GetValue ( ) { return this -> Value ; } protected : vtkCenteredSliderWidget ( ) ; ~ vtkCenteredSliderWidget ( ) override = default ;  These are the events that are handled static void SelectAction ( vtkAbstractWidget * ) ; static void EndSelectAction ( vtkAbstractWidget * ) ; static void MoveAction ( vtkAbstractWidget * ) ; static void TimerAction ( vtkAbstractWidget * ) ;  Manage the state of the widget int WidgetState ; enum WidgetStateType { Start = 0 , Sliding } ; # ! defined ( VTK_LEGACY_REMOVE ) [NewLine] VTK_DEPRECATED_IN_9_2_0 ( because leading underscore is reserved ) typedef WidgetStateType _WidgetState ; # [NewLine] int TimerId ; int TimerDuration ; double StartTime ; double Value ; private : vtkCenteredSliderWidget ( const vtkCenteredSliderWidget & ) = delete ; void operator = ( const vtkCenteredSliderWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
