...
## !!!Ignored construct:  # vtkOpenVRRenderWindow_h [NewLine] # vtkOpenVRRenderWindow_h [NewLine] # vtkEventData.h  for enums # vtkOpenVROverlay.h  used for ivars # vtkRenderingOpenVRModule.h  For export macro # vtkSmartPointer.h  used for ivars # vtkVRRenderWindow.h [NewLine] # < openvr . h >  for ivars [NewLine] class vtkMatrix4x4 ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkOpenVRModel"
## !!!Ignored construct:  class VTKRENDERINGOPENVR_EXPORT vtkOpenVRRenderWindow : public vtkVRRenderWindow { public : static vtkOpenVRRenderWindow * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkVRRenderWindow Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkVRRenderWindow :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkOpenVRRenderWindow :: IsTypeOf ( type ) ; } static vtkOpenVRRenderWindow * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkOpenVRRenderWindow * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkOpenVRRenderWindow * NewInstance ( ) const { return vtkOpenVRRenderWindow :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkVRRenderWindow :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkOpenVRRenderWindow :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkOpenVRRenderWindow :: New ( ) ; } public : ; *
...
##  virtual vtkOpenVROverlay * Getname ( ) { vtkDebugWithObjectMacro ( this , <<  returning  name  address  << static_cast < vtkOpenVROverlay * > ( this -> DashboardOverlay ) ) ; return this -> DashboardOverlay ; } ; *
...
##  void RenderModels ( ) override ; uint32_t GetDeviceHandleForOpenVRHandle ( vr :: TrackedDeviceIndex_t index ) ; vtkEventDataDevice GetDeviceForOpenVRHandle ( vr :: TrackedDeviceIndex_t ohandle ) ; protected : vtkOpenVRRenderWindow ( ) ; ~ vtkOpenVRRenderWindow ( ) override = default ; std :: string GetWindowTitleFromAPI ( ) override ; bool GetSizeFromAPI ( ) override ; bool CreateFramebuffers ( uint32_t viewCount = 2 ) override ; bool CreateOneFramebuffer ( int nWidth , int nHeight , FramebufferDesc & framebufferDesc ) ; *
...
##  vtkOpenVRModel * FindOrLoadRenderModel ( const char * modelName ) ; vtkSmartPointer < vtkOpenVROverlay > DashboardOverlay ; vr :: IVRSystem * HMD = nullptr ; vr :: IVRRenderModels * OpenVRRenderModels = nullptr ; private : vtkOpenVRRenderWindow ( const vtkOpenVRRenderWindow & ) = delete ; void operator = ( const vtkOpenVRRenderWindow & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
