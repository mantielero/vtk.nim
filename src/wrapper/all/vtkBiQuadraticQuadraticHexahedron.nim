...
## !!!Ignored construct:  # vtkBiQuadraticQuadraticHexahedron_h [NewLine] # vtkBiQuadraticQuadraticHexahedron_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkNonLinearCell.h [NewLine] class vtkQuadraticEdge ;
...
##  int IntersectWithLine ( const double p1 [ 3 ] , const double p2 [ 3 ] , double tol , double & t , double x [ 3 ] , double pcoords [ 3 ] , int & subId ) override ; static void InterpolationFunctions ( const double pcoords [ 3 ] , double weights [ 24 ] ) ; static void InterpolationDerivs ( const double pcoords [ 3 ] , double derivs [ 72 ] ) ; /@{ *
##  Compute the interpolation functions/derivatives
##  (aka shape functions/derivatives)
##  void InterpolateFunctions ( const double pcoords [ 3 ] , double weights [ 24 ] ) override { vtkBiQuadraticQuadraticHexahedron :: InterpolationFunctions ( pcoords , weights ) ; } void InterpolateDerivs ( const double pcoords [ 3 ] , double derivs [ 72 ] ) override { vtkBiQuadraticQuadraticHexahedron :: InterpolationDerivs ( pcoords , derivs ) ; } /@}
## /@{ *
