...
## !!!Ignored construct:  # vtkHoverWidget_h [NewLine] # vtkHoverWidget_h [NewLine] # vtkAbstractWidget.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class VTKINTERACTIONWIDGETS_EXPORT vtkHoverWidget : public vtkAbstractWidget { public : *
##  Instantiate this class.
##  static vtkHoverWidget * New ( ) ; /@{ *
##  Standard methods for a VTK class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkHoverWidget :: IsTypeOf ( type ) ; } static vtkHoverWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkHoverWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkHoverWidget * NewInstance ( ) const { return vtkHoverWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkHoverWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkHoverWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} /@{ *
...
##  virtual void SetTimerDuration ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << TimerDuration  to  << _arg ) ; if ( this -> TimerDuration != ( _arg < 1 ? 1 : ( _arg > 100000 ? 100000 : _arg ) ) ) { this -> TimerDuration = ( _arg < 1 ? 1 : ( _arg > 100000 ? 100000 : _arg ) ) ; this -> Modified ( ) ; } } virtual int GetTimerDurationMinValue ( ) { return 1 ; } virtual int GetTimerDurationMaxValue ( ) { return 100000 ; } ; virtual int GetTimerDuration ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << TimerDuration  of  << this -> TimerDuration ) ; return this -> TimerDuration ; } ; /@} *
...
##  void CreateDefaultRepresentation ( ) override { this -> WidgetRep = nullptr ; } protected : vtkHoverWidget ( ) ; ~ vtkHoverWidget ( ) override ;  The state of the widget enum { Start = 0 , Timing , TimedOut } ; int WidgetState ;  Callback interface to execute events static void MoveAction ( vtkAbstractWidget * ) ; static void HoverAction ( vtkAbstractWidget * ) ; static void SelectAction ( vtkAbstractWidget * ) ;  Subclasses of this class invoke these methods. If a non-zero
##  value is returned, a subclass is handling the event. virtual int SubclassHoverAction ( ) { return 0 ; } virtual int SubclassEndHoverAction ( ) { return 0 ; } virtual int SubclassSelectAction ( ) { return 0 ; } /@{ *
##  Helper methods for creating and destroying timers.
##  int TimerId ; int TimerDuration ; /@} private : vtkHoverWidget ( const vtkHoverWidget & ) = delete ; void operator = ( const vtkHoverWidget & ) = delete ; } ;
