...
## !!!Ignored construct:  # vtkOrientedGlyphFocalPlaneContourRepresentation_h [NewLine] # vtkOrientedGlyphFocalPlaneContourRepresentation_h [NewLine] # vtkFocalPlaneContourRepresentation.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkProperty2D ;
...
discard "forward decl of vtkPolyData"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkOrientedGlyphFocalPlaneContourRepresentation : public vtkFocalPlaneContourRepresentation { public : *
##  Instantiate this class.
##  static vtkOrientedGlyphFocalPlaneContourRepresentation * New ( ) ; /@{ *
##  Standard methods for instances of this class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkFocalPlaneContourRepresentation Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkFocalPlaneContourRepresentation :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkOrientedGlyphFocalPlaneContourRepresentation :: IsTypeOf ( type ) ; } static vtkOrientedGlyphFocalPlaneContourRepresentation * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkOrientedGlyphFocalPlaneContourRepresentation * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkOrientedGlyphFocalPlaneContourRepresentation * NewInstance ( ) const { return vtkOrientedGlyphFocalPlaneContourRepresentation :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkFocalPlaneContourRepresentation :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkOrientedGlyphFocalPlaneContourRepresentation :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkOrientedGlyphFocalPlaneContourRepresentation :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} /@{ *
...
##  with the handle.
##  virtual vtkProperty2D * GetnamePropertyActiveProperty ( ) { vtkDebugWithObjectMacro ( this , <<  returning  ActiveProperty  address  << static_cast < vtkProperty2D * > ( this -> ActiveProperty ) ) ; return this -> ActiveProperty ; } ; /@} /@{ *
##  This is the property used by the lines.
##  virtual vtkProperty2D * GetnamePropertyActivePropertyLinesProperty ( ) { vtkDebugWithObjectMacro ( this , <<  returning  LinesProperty  address  << static_cast < vtkProperty2D * > ( this -> LinesProperty ) ) ; return this -> LinesProperty ; } ; /@} /@{ *
...
##  the manipulator in general. vtkProperty2D * Property ; vtkProperty2D * ActiveProperty ; vtkProperty2D * LinesProperty ; vtkMatrix4x4 * ContourPlaneDirectionCosines ; void CreateDefaultProperties ( ) ;  Distance between where the mouse event happens and where the
##  widget is focused - maintain this distance during interaction. double InteractionOffset [ 2 ] ; void BuildLines ( ) override ; private : vtkOrientedGlyphFocalPlaneContourRepresentation ( const vtkOrientedGlyphFocalPlaneContourRepresentation & ) = delete ; void operator = ( const vtkOrientedGlyphFocalPlaneContourRepresentation & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
