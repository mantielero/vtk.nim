...
## !!!Ignored construct:  # vtkDistanceWidget_h [NewLine] # vtkDistanceWidget_h [NewLine] # vtkAbstractWidget.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkDistanceRepresentation ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkHandleWidget"
discard "forward decl of vtkDistanceWidgetCallback"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkDistanceWidget : public vtkAbstractWidget { public : *
##  Instantiate this class.
##  static vtkDistanceWidget * New ( ) ; /@{ *
##  Standard methods for a VTK class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDistanceWidget :: IsTypeOf ( type ) ; } static vtkDistanceWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDistanceWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDistanceWidget * NewInstance ( ) const { return vtkDistanceWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDistanceWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDistanceWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  void SetRepresentation ( vtkDistanceRepresentation * r ) { this -> Superclass :: SetWidgetRepresentation ( reinterpret_cast < vtkWidgetRepresentation * > ( r ) ) ; } *
##  Return the representation as a vtkDistanceRepresentation.
##  vtkDistanceRepresentation * GetDistanceRepresentation ( ) { return reinterpret_cast < vtkDistanceRepresentation * > ( this -> WidgetRep ) ; } *
...
##  effect.
##  virtual void SetWidgetStateToStart ( ) ; virtual void SetWidgetStateToManipulate ( ) ; /@} *
##  Return the current widget state.
##  virtual int GetWidgetState ( ) { return this -> WidgetState ; } protected : vtkDistanceWidget ( ) ; ~ vtkDistanceWidget ( ) override ;  The state of the widget int WidgetState ; int CurrentHandle ;  Callback interface to capture events when
##  placing the widget. static void AddPointAction ( vtkAbstractWidget * ) ; static void MoveAction ( vtkAbstractWidget * ) ; static void EndSelectAction ( vtkAbstractWidget * ) ; static void AddPointAction3D ( vtkAbstractWidget * ) ; static void MoveAction3D ( vtkAbstractWidget * ) ; static void EndSelectAction3D ( vtkAbstractWidget * ) ;  The positioning handle widgets vtkHandleWidget * Point1Widget ; vtkHandleWidget * Point2Widget ; vtkDistanceWidgetCallback * DistanceWidgetCallback1 ; vtkDistanceWidgetCallback * DistanceWidgetCallback2 ;  Methods invoked when the handles at the
##  end points of the widget are manipulated void StartDistanceInteraction ( int handleNum ) ; void DistanceInteraction ( int handleNum ) ; void EndDistanceInteraction ( int handleNum ) ; friend class vtkDistanceWidgetCallback ; private : vtkDistanceWidget ( const vtkDistanceWidget & ) = delete ; void operator = ( const vtkDistanceWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
