...
## !!!Ignored construct:  # vtkSobelGradientMagnitudePass_h [NewLine] # vtkSobelGradientMagnitudePass_h [NewLine] # vtkImageProcessingPass.h [NewLine] # vtkRenderingOpenGL2Module.h  For export macro [NewLine] class vtkDepthPeelingPassLayerList ;
...
## !!!Ignored construct:  class VTKRENDERINGOPENGL2_EXPORT vtkSobelGradientMagnitudePass : public vtkImageProcessingPass { public : static vtkSobelGradientMagnitudePass * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkImageProcessingPass Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkImageProcessingPass :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkSobelGradientMagnitudePass :: IsTypeOf ( type ) ; } static vtkSobelGradientMagnitudePass * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkSobelGradientMagnitudePass * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkSobelGradientMagnitudePass * NewInstance ( ) const { return vtkSobelGradientMagnitudePass :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkImageProcessingPass :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkSobelGradientMagnitudePass :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkSobelGradientMagnitudePass :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  Graphics resources.
##  vtkOpenGLFramebufferObject * FrameBufferObject ; vtkTextureObject * Pass1 ;  render target for the scene vtkTextureObject * Gx1 ;  render target 0 for the first shader vtkTextureObject * Gy1 ;  render target 1 for the first shader  Structures for the various cell types we render. vtkOpenGLHelper * Program1 ;  shader to compute Gx1 and Gy1 vtkOpenGLHelper * Program2 ;  shader to compute |G| from Gx1 and Gy1 private : vtkSobelGradientMagnitudePass ( const vtkSobelGradientMagnitudePass & ) = delete ; void operator = ( const vtkSobelGradientMagnitudePass & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
