...
## !!!Ignored construct:  # vtkMutableDirectedGraph_h [NewLine] # vtkMutableDirectedGraph_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDirectedGraph.h [NewLine] class vtkEdgeListIterator ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkGraphEdge"
discard "forward decl of vtkVariant"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkMutableDirectedGraph : public vtkDirectedGraph { public : static vtkMutableDirectedGraph * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkDirectedGraph Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkDirectedGraph :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkMutableDirectedGraph :: IsTypeOf ( type ) ; } static vtkMutableDirectedGraph * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkMutableDirectedGraph * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkMutableDirectedGraph * NewInstance ( ) const { return vtkMutableDirectedGraph :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkDirectedGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkMutableDirectedGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkMutableDirectedGraph :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  vtkIdType AddChild ( vtkIdType parent , vtkVariantArray * propertyArr ) ; vtkIdType AddChild ( vtkIdType parent ) { return this -> AddChild ( parent , nullptr ) ; } *
...
##  void RemoveEdges ( vtkIdTypeArray * arr ) ; protected : vtkMutableDirectedGraph ( ) ; ~ vtkMutableDirectedGraph ( ) override ; *
##  Graph edge that is reused of \p AddGraphEdge calls.
##  vtkGraphEdge * GraphEdge ; private : vtkMutableDirectedGraph ( const vtkMutableDirectedGraph & ) = delete ; void operator = ( const vtkMutableDirectedGraph & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
