...
#      define VTKRENDERINGRAYTRACING_EXPORT __attribute__((visibility("default")))
#    else
...
#    define VTKRENDERINGRAYTRACING_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef VTKRENDERINGRAYTRACING_DEPRECATED
#  define VTKRENDERINGRAYTRACING_DEPRECATED __attribute__ ((__deprecated__))
#endif
