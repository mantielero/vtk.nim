...
## !!!Ignored construct:  # vtkOBBTree_h [NewLine] # vtkOBBTree_h [NewLine] # vtkAbstractCellLocator.h [NewLine] # vtkFiltersGeneralModule.h  For export macro [NewLine] class vtkMatrix4x4 ;
## Error: token expected: ; but got: [identifier]!!!

##  Special class defines node for the OBB tree

## !!!Ignored construct:  class VTKFILTERSGENERAL_EXPORT vtkOBBNode { ;prevent man page generation public : vtkOBBNode ( ) ; ~ vtkOBBNode ( ) ; double Corner [ 3 ] ;  center point of this node double Axes [ 3 ] [ 3 ] ;  the axes defining the OBB - ordered from long->short vtkOBBNode * Parent ;  parent node; nullptr if root vtkOBBNode * * Kids ;  two children of this node; nullptr if leaf vtkIdList * Cells ;  list of cells in node void DebugPrintTree ( int level , double * leaf_vol , int * minCells , int * maxCells ) ; private : vtkOBBNode ( const vtkOBBNode & other ) = delete ; vtkOBBNode & operator = ( const vtkOBBNode & rhs ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKFILTERSGENERAL_EXPORT vtkOBBTree : public vtkAbstractCellLocator { public : /@{ *
##  Standard methods to print and obtain type-related information.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractCellLocator Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractCellLocator :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkOBBTree :: IsTypeOf ( type ) ; } static vtkOBBTree * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkOBBTree * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkOBBTree * NewInstance ( ) const { return vtkOBBTree :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractCellLocator :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkOBBTree :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkOBBTree :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
##  Construct with automatic computation of divisions, averaging
##  25 cells per octant.
##  static vtkOBBTree * New ( ) ;  Re-use any superclass signatures that we don't override. using vtkAbstractCellLocator :: IntersectWithLine ; *
...
##  void FreeSearchStructure ( ) override ; void BuildLocator ( ) override ; void ForceBuildLocator ( ) override ; /@} *
...
##  void GenerateRepresentation ( int level , vtkPolyData * pd ) override ; protected : vtkOBBTree ( ) ; ~ vtkOBBTree ( ) override ; void BuildLocatorInternal ( ) override ;  Compute an OBB from the list of cells given.  This used to be
##  public but should not have been.  A public call has been added
##  so that the functionality can be accessed. void ComputeOBB ( vtkIdList * cells , double corner [ 3 ] , double max [ 3 ] , double mid [ 3 ] , double min [ 3 ] , double size [ 3 ] ) ; vtkOBBNode * Tree ; void BuildTree ( vtkIdList * cells , vtkOBBNode * parent , int level ) ; vtkPoints * PointsList ; int * InsertedPoints ; int OBBCount ; void DeleteTree ( vtkOBBNode * OBBptr ) ; void GeneratePolygons ( vtkOBBNode * OBBptr , int level , int repLevel , vtkPoints * pts , vtkCellArray * polys ) ; private : vtkOBBTree ( const vtkOBBTree & ) = delete ; void operator = ( const vtkOBBTree & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
