...
## !!!Ignored construct:  # vtkReebGraph_h [NewLine] # vtkReebGraph_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkMutableDirectedGraph.h [NewLine] class vtkDataArray ;
...
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkReebGraph : public vtkMutableDirectedGraph { public : static vtkReebGraph * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkMutableDirectedGraph Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkMutableDirectedGraph :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkReebGraph :: IsTypeOf ( type ) ; } static vtkReebGraph * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkReebGraph * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkReebGraph * NewInstance ( ) const { return vtkReebGraph :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkMutableDirectedGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkReebGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkReebGraph :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; void PrintNodeData ( ostream & os , vtkIndent indent ) ; *
...
##  int GetDataObjectType ( ) override { return VTK_REEB_GRAPH ; } enum { ERR_INCORRECT_FIELD = - 1 , ERR_NO_SUCH_FIELD = - 2 , ERR_NOT_A_SIMPLICIAL_MESH = - 3 } ; *
...
##  Implements deep copy void DeepCopy ( vtkDataObject * src ) override ; *
...
##  Use with caution!
##  void Set ( vtkMutableDirectedGraph * g ) ; protected : vtkReebGraph ( ) ; ~ vtkReebGraph ( ) override ; class Implementation ; Implementation * Storage ; private : vtkReebGraph ( const vtkReebGraph & ) = delete ; void operator = ( const vtkReebGraph & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
