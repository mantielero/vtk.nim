...
## !!!Ignored construct:  # vtkPointCloudFilter_h [NewLine] # vtkPointCloudFilter_h [NewLine] # vtkFiltersPointsModule.h  For export macro # vtkPolyDataAlgorithm.h [NewLine] class vtkPointSet ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPolyData"
## !!!Ignored construct:  class VTKFILTERSPOINTS_EXPORT vtkPointCloudFilter : public vtkPolyDataAlgorithm { public : /@{ *
##  Standard methods to obtain type information, and print information.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPolyDataAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPolyDataAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPointCloudFilter :: IsTypeOf ( type ) ; } static vtkPointCloudFilter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPointCloudFilter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPointCloudFilter * NewInstance ( ) const { return vtkPointCloudFilter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPolyDataAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPointCloudFilter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPointCloudFilter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  and shifted by -1.
##  virtual void SetGenerateOutliers ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  GenerateOutliers  to  << _arg ) ; if ( this -> GenerateOutliers != _arg ) { this -> GenerateOutliers = _arg ; this -> Modified ( ) ; } } ; virtual bool GetGenerateOutliers ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << GenerateOutliers  of  << this -> GenerateOutliers ) ; return this -> GenerateOutliers ; } ; virtual void GenerateOutliersOn ( ) { this -> SetGenerateOutliers ( static_cast < bool > ( 1 ) ) ; } virtual void GenerateOutliersOff ( ) { this -> SetGenerateOutliers ( static_cast < bool > ( 0 ) ) ; } ; /@} /@{ *
...
##  this is off (false).
##  virtual void SetGenerateOutliersGenerateVertices ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  GenerateVertices  to  << _arg ) ; if ( this -> GenerateVertices != _arg ) { this -> GenerateVertices = _arg ; this -> Modified ( ) ; } } ; virtual bool GetGenerateOutliersGenerateVertices ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << GenerateVertices  of  << this -> GenerateVertices ) ; return this -> GenerateVertices ; } ; virtual void GenerateVerticesOn ( ) { this -> SetGenerateOutliersGenerateVertices ( static_cast < bool > ( 1 ) ) ; } virtual void GenerateVerticesOff ( ) { this -> SetGenerateOutliersGenerateVertices ( static_cast < bool > ( 0 ) ) ; } ; /@} protected : vtkPointCloudFilter ( ) ; ~ vtkPointCloudFilter ( ) override ;  All derived classes must implement this method. Note that a side effect of
##  the class is to populate the PointMap. Zero is returned on error. virtual int FilterPoints ( vtkPointSet * input ) = 0 ;  Keep track of which points are removed through the point map vtkIdType * PointMap ; vtkIdType NumberOfPointsRemoved ;  Does a second output need to be created? bool GenerateOutliers ;  Should output vertex cells be created? bool GenerateVertices ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int FillInputPortInformation ( int port , vtkInformation * info ) override ; void GenerateVerticesIfRequested ( vtkPolyData * output ) ; private : vtkPointCloudFilter ( const vtkPointCloudFilter & ) = delete ; void operator = ( const vtkPointCloudFilter & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
