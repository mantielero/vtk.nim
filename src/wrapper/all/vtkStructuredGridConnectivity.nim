...
## !!!Ignored construct:  # vtkStructuredGridConnectivity_h [NewLine] # vtkStructuredGridConnectivity_h [NewLine] # VTK_NO_OVERLAP 0 [NewLine] # VTK_NODE_OVERLAP 1 [NewLine] # VTK_EDGE_OVERLAP 2 [NewLine] # VTK_PARTIAL_OVERLAP 3 [NewLine]  VTK include directives # vtkAbstractGridConnectivity.h [NewLine] # vtkFiltersGeometryModule.h  For export macro # vtkStructuredData.h  For data description definitions # vtkStructuredNeighbor.h  For Structured Neighbor object definition [NewLine]  C++ include directives # < cassert >  For assert() # < iostream >  For cout # < map >  For STL map # < utility >  For STL pair and overloaded relational operators # < vector >  For STL vector [NewLine]  Forward Declarations class vtkIdList ;
...
## !!!Ignored construct:  class VTKFILTERSGEOMETRY_EXPORT vtkStructuredGridConnectivity : public vtkAbstractGridConnectivity { public : static vtkStructuredGridConnectivity * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractGridConnectivity Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractGridConnectivity :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkStructuredGridConnectivity :: IsTypeOf ( type ) ; } static vtkStructuredGridConnectivity * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkStructuredGridConnectivity * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkStructuredGridConnectivity * NewInstance ( ) const { return vtkStructuredGridConnectivity :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractGridConnectivity :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkStructuredGridConnectivity :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkStructuredGridConnectivity :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  virtual int GetDataDimension ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << DataDimension  of  << this -> DataDimension ) ; return this -> DataDimension ; } ; /@} *
...
##  grid ID.
##  int GetNumberOfNeighbors ( const int gridID ) { return ( static_cast < int > ( this -> Neighbors [ gridID ] . size ( ) ) ) ; } *
...
##  void CreateGhostLayers ( const int N = 1 ) override ; protected : vtkStructuredGridConnectivity ( ) ; ~ vtkStructuredGridConnectivity ( ) override ; *
##  Returns true iff Lo <= idx <= Hi, otherwise false.
##  bool InBounds ( const int idx , const int Lo , const int Hi ) { return ( ( idx >= Lo ) && ( idx <= Hi ) ) ; } *
##  Returns true iff Lo < idx < Hi, otherwise false.
##  bool StrictlyInsideBounds ( const int idx , const int Lo , const int Hi ) { return ( ( idx > Lo ) && ( idx < Hi ) ) ; } *
##  Returns true iff A is a subset of B, otherwise false.
##  bool IsSubset ( int A [ 2 ] , int B [ 2 ] ) { return ( this -> InBounds ( A [ 0 ] , B [ 0 ] , B [ 1 ] ) && this -> InBounds ( A [ 1 ] , B [ 0 ] , B [ 1 ] ) ) ; } *
...
##  int GetNumberOfNodesPerCell ( const int dim ) { int numNodes = 0 ; switch ( dim ) { case 1 : numNodes = 2 ;  line cell break ; case 2 : numNodes = 4 ;  quad cell break ; case 3 : numNodes = 8 ;  hex cell break ; default : assert ( ERROR: code should not reach here! && false ) ; }  END switch return ( numNodes ) ; } /@} *
...
##  void PrintExtent ( int extent [ 6 ] ) ; int DataDimension ; int DataDescription ; int WholeExtent [ 6 ] ; std :: vector < int > GridExtents ; std :: vector < int > GhostedExtents ; std :: vector < unsigned char > BlockTopology ; std :: vector < std :: vector < vtkStructuredNeighbor >> Neighbors ; std :: map < std :: pair < int , int > , int > NeighborPair2NeighborListIndex ; private : vtkStructuredGridConnectivity ( const vtkStructuredGridConnectivity & ) = delete ; void operator = ( const vtkStructuredGridConnectivity & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
...
proc GetNeighborIndex*(gridIdx: cint; NeighborGridIdx: cint): cint {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::GetNeighborIndex(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc GetGhostedExtent*(ghostedExtent: ptr cint; GridExtent: array[6, cint];
                      minIdx: cint; maxIdx: cint; N: cint) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::GetGhostedExtent(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc SetGhostedGridExtent*(gridID: cint; ext: array[6, cint]) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::SetGhostedGridExtent(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc GetGridExtent*(gridID: cint; ext: array[6, cint]) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::GetGridExtent(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc GetGhostedGridExtent*(gridID: cint; ext: array[6, cint]) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::GetGhostedGridExtent(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc IsNodeOnBoundaryOfExtent*(i: cint; j: cint; k: cint; ext: array[6, cint]): bool {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::IsNodeOnBoundaryOfExtent(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc IsNodeInterior*(i: cint; j: cint; k: cint; GridExtent: array[6, cint]): bool {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::IsNodeInterior(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc DetermineNeighborOrientation*(idx: cint; A: array[2, cint]; B: array[2, cint];
                                  overlap: array[2, cint]; orient: array[3, cint]) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::DetermineNeighborOrientation(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc Get1DOrientation*(idx: cint; ExtentLo: cint; ExtentHi: cint; OnLo: cint; OnHi: cint;
                      NotOnBoundary: cint): cint {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::Get1DOrientation(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc HasBlockConnection*(gridID: cint; blockDirection: cint): bool {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::HasBlockConnection(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc RemoveBlockConnection*(gridID: cint; blockDirection: cint) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::RemoveBlockConnection(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc AddBlockConnection*(gridID: cint; blockDirection: cint) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::AddBlockConnection(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc ClearBlockConnections*(gridID: cint) {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::ClearBlockConnections(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc GetNumberOfConnectingBlockFaces*(gridID: cint): cint {.
    importcpp: "VTKFILTERSGEOMETRY_EXPORT::GetNumberOfConnectingBlockFaces(@)",
    header: "vtkStructuredGridConnectivity.h".}
## ------------------------------------------------------------------------------

proc SetNumberOfGrids*(N: cuint) {.importcpp: "VTKFILTERSGEOMETRY_EXPORT::SetNumberOfGrids(@)",
                                header: "vtkStructuredGridConnectivity.h".}