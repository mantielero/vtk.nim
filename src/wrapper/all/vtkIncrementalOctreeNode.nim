...
## !!!Ignored construct:  # vtkIncrementalOctreeNode_h [NewLine] # vtkIncrementalOctreeNode_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_1_0 # vtkObject.h [NewLine] class vtkPoints ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkIdList"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkIncrementalOctreeNode : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkIncrementalOctreeNode :: IsTypeOf ( type ) ; } static vtkIncrementalOctreeNode * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkIncrementalOctreeNode * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkIncrementalOctreeNode * NewInstance ( ) const { return vtkIncrementalOctreeNode :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkIncrementalOctreeNode :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkIncrementalOctreeNode :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkIncrementalOctreeNode * New ( ) ; /@{ *
...
##  virtual vtkIdList * GetnamePointIdSet ( ) { vtkDebugWithObjectMacro ( this , <<  returning  PointIdSet  address  << static_cast < vtkIdList * > ( this -> PointIdSet ) ) ; return this -> PointIdSet ; } ; /@} *
...
##  virtual double * GetMinBounds ( ) VTK_SIZEHINT ( 3 ) { vtkDebugWithObjectMacro ( this , <<  returning  << MinBounds  pointer  << this -> MinBounds ) ; return this -> MinBounds ; } VTK_WRAPEXCLUDE virtual void GetMinBounds ( double & _arg1 , double & _arg2 , double & _arg3 ) { _arg1 = this -> MinBounds [ 0 ] ; _arg2 = this -> MinBounds [ 1 ] ; _arg3 = this -> MinBounds [ 2 ] ; vtkDebugWithObjectMacro ( this , <<  returning  << MinBounds  = ( << _arg1 << , << _arg2 << , << _arg3 << ) ) ; } VTK_WRAPEXCLUDE virtual void GetMinBounds ( double _arg [ 3 ] ) { this -> GetMinBounds ( _arg [ 0 ] , _arg [ 1 ] , _arg [ 2 ] ) ; } ; /@} /@{ *
##  Get access to MaxBounds. Do not free this pointer.
##  virtual double * GetMinBoundsMaxBounds ( ) VTK_SIZEHINT ( 3 ) { vtkDebugWithObjectMacro ( this , <<  returning  << MaxBounds  pointer  << this -> MaxBounds ) ; return this -> MaxBounds ; } VTK_WRAPEXCLUDE virtual void GetMinBoundsMaxBounds ( double & _arg1 , double & _arg2 , double & _arg3 ) { _arg1 = this -> MaxBounds [ 0 ] ; _arg2 = this -> MaxBounds [ 1 ] ; _arg3 = this -> MaxBounds [ 2 ] ; vtkDebugWithObjectMacro ( this , <<  returning  << MaxBounds  = ( << _arg1 << , << _arg2 << , << _arg3 << ) ) ; } VTK_WRAPEXCLUDE virtual void GetMinBoundsMaxBounds ( double _arg [ 3 ] ) { this -> GetMinBoundsMaxBounds ( _arg [ 0 ] , _arg [ 1 ] , _arg [ 2 ] ) ; } ; /@} *
##  Get access to MinDataBounds. Note that MinDataBounds is not valid until
##  point insertion.
##  double * GetMinDataBounds ( ) { return this -> NumberOfPoints ? this -> MinDataBounds : this -> MinBounds ; } *
##  Get access to MaxDataBounds. Note that MaxDataBounds is not valid until
##  point insertion.
##  double * GetMaxDataBounds ( ) { return this -> NumberOfPoints ? this -> MaxDataBounds : this -> MaxBounds ; } *
...
##  VTK_DEPRECATED_IN_9_1_0 ( Use the version with numberOfNodes parameter instead. ) int InsertPoint ( vtkPoints * points , const double newPnt [ 3 ] , int maxPts , vtkIdType * pntId , int ptMode ) ; int InsertPoint ( vtkPoints * points , const double newPnt [ 3 ] , int maxPts , vtkIdType * pntId , int ptMode , int & numberOfNodes ) ; @} *
...
##  int GetID ( ) const { return this -> ID ; } vtkIdList * GetPointIds ( ) const { return this -> PointIdSet ; } protected : vtkIncrementalOctreeNode ( ) ; ~ vtkIncrementalOctreeNode ( ) override ; private : *
...
##  int CreateChildNodes ( vtkPoints * points , vtkIdList * pntIds , const double newPnt [ 3 ] , vtkIdType * pntIdx , int maxPts , int ptMode , int & numberOfNodes ) ; *
...
##  int UpdateCounterAndDataBoundsRecursively ( const double point [ 3 ] , int nHits , int updateData , vtkIncrementalOctreeNode * endNode ) ; *
...
##  void SeperateExactlyDuplicatePointsFromNewInsertion ( vtkPoints * points , vtkIdList * pntIds , const double newPnt [ 3 ] , vtkIdType * pntIdx , int maxPts , int ptMode ) ; *
...
##  double GetDistance2ToBoundary ( const double point [ 3 ] , double closest [ 3 ] , int innerOnly , vtkIncrementalOctreeNode * rootNode , int checkData = 0 ) ; vtkIncrementalOctreeNode ( const vtkIncrementalOctreeNode & ) = delete ; void operator = ( const vtkIncrementalOctreeNode & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

##  In-lined for performance

proc GetChildIndex*(point: array[3, cdouble]): cint {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::GetChildIndex(@)",
    header: "vtkIncrementalOctreeNode.h".}
##  In-lined for performance

proc ContainsPoint*(pnt: array[3, cdouble]): vtkTypeBool {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::ContainsPoint(@)",
    header: "vtkIncrementalOctreeNode.h".}
##  In-lined for performance

proc ContainsPointByData*(pnt: array[3, cdouble]): vtkTypeBool {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::ContainsPointByData(@)",
    header: "vtkIncrementalOctreeNode.h".}
##  In-lined for performance

proc ContainsDuplicatePointsOnly*(pnt: array[3, cdouble]): cint {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::ContainsDuplicatePointsOnly(@)",
    header: "vtkIncrementalOctreeNode.h".}
##  In-lined for performance

proc UpdateCounterAndDataBounds*(point: array[3, cdouble]) {.
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::UpdateCounterAndDataBounds(@)",
    header: "vtkIncrementalOctreeNode.h".}
##  In-lined for performance

proc UpdateCounterAndDataBoundsRecursively*(point: array[3, cdouble]; nHits: cint;
    updateData: cint; endNode: ptr vtkIncrementalOctreeNode): cint {.importcpp: "VTKCOMMONDATAMODEL_EXPORT::UpdateCounterAndDataBoundsRecursively(@)",
    header: "vtkIncrementalOctreeNode.h".}