...
## !!!Ignored construct:  # vtkProgrammableGlyphFilter_h [NewLine] # vtkProgrammableGlyphFilter_h [NewLine] # VTK_COLOR_BY_INPUT 0 [NewLine] # VTK_COLOR_BY_SOURCE 1 [NewLine] # vtkFiltersProgrammableModule.h  For export macro # vtkPolyDataAlgorithm.h [NewLine] class vtkPointData ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKFILTERSPROGRAMMABLE_EXPORT vtkProgrammableGlyphFilter : public vtkPolyDataAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPolyDataAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPolyDataAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkProgrammableGlyphFilter :: IsTypeOf ( type ) ; } static vtkProgrammableGlyphFilter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkProgrammableGlyphFilter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkProgrammableGlyphFilter * NewInstance ( ) const { return vtkProgrammableGlyphFilter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPolyDataAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkProgrammableGlyphFilter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkProgrammableGlyphFilter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual vtkIdType GetPointId ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << PointId  of  << this -> PointId ) ; return this -> PointId ; } ; /@} /@{ *
##  Get the current point coordinates during processing. Value only valid during the
##  Execute() method of this filter. (Meant to be called by the GlyphMethod().)
##  virtual double * GetPoint ( ) VTK_SIZEHINT ( 3 ) { vtkDebugWithObjectMacro ( this , <<  returning  << Point  pointer  << this -> Point ) ; return this -> Point ; } VTK_WRAPEXCLUDE virtual void GetPoint ( double & _arg1 , double & _arg2 , double & _arg3 ) { _arg1 = this -> Point [ 0 ] ; _arg2 = this -> Point [ 1 ] ; _arg3 = this -> Point [ 2 ] ; vtkDebugWithObjectMacro ( this , <<  returning  << Point  = ( << _arg1 << , << _arg2 << , << _arg3 << ) ) ; } VTK_WRAPEXCLUDE virtual void GetPoint ( double _arg [ 3 ] ) { this -> GetPoint ( _arg [ 0 ] , _arg [ 1 ] , _arg [ 2 ] ) ; } ; /@} /@{ *
...
##  virtual vtkPointData * GetnamePointData ( ) { vtkDebugWithObjectMacro ( this , <<  returning  PointData  address  << static_cast < vtkPointData * > ( this -> PointData ) ) ; return this -> PointData ; } ; /@} /@{ *
##  Either color by the input or source scalar data.
##  virtual void SetColorMode ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  ColorMode  to  << _arg ) ; if ( this -> ColorMode != _arg ) { this -> ColorMode = _arg ; this -> Modified ( ) ; } } ; virtual int GetPointIdColorMode ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ColorMode  of  << this -> ColorMode ) ; return this -> ColorMode ; } ; void SetColorModeToColorByInput ( ) { this -> SetColorMode ( VTK_COLOR_BY_INPUT ) ; } void SetColorModeToColorBySource ( ) { this -> SetColorMode ( VTK_COLOR_BY_SOURCE ) ; } const char * GetColorModeAsString ( ) ; /@} protected : vtkProgrammableGlyphFilter ( ) ; ~ vtkProgrammableGlyphFilter ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int FillInputPortInformation ( int , vtkInformation * ) override ; double Point [ 3 ] ;  Coordinates of point vtkIdType PointId ;  Current point id during processing vtkPointData * PointData ; int ColorMode ; ProgrammableMethodCallbackType GlyphMethod ;  Support GlyphMethod ProgrammableMethodCallbackType GlyphMethodArgDelete ; void * GlyphMethodArg ; private : vtkProgrammableGlyphFilter ( const vtkProgrammableGlyphFilter & ) = delete ; void operator = ( const vtkProgrammableGlyphFilter & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
