...
## !!!Ignored construct:  # vtkBalloonWidget_h [NewLine] # vtkBalloonWidget_h [NewLine] # vtkHoverWidget.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkBalloonRepresentation ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkProp"
discard "forward decl of vtkAbstractPropPicker"
discard "forward decl of vtkStdString"
discard "forward decl of vtkPropMap"
discard "forward decl of vtkImageData"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkBalloonWidget : public vtkHoverWidget { public : *
##  Instantiate this class.
##  static vtkBalloonWidget * New ( ) ; /@{ *
##  Standard methods for a VTK class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkHoverWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkHoverWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkBalloonWidget :: IsTypeOf ( type ) ; } static vtkBalloonWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkBalloonWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkBalloonWidget * NewInstance ( ) const { return vtkBalloonWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkHoverWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkBalloonWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkBalloonWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  void SetRepresentation ( vtkBalloonRepresentation * r ) { this -> Superclass :: SetWidgetRepresentation ( reinterpret_cast < vtkWidgetRepresentation * > ( r ) ) ; } *
##  Return the representation as a vtkBalloonRepresentation.
##  vtkBalloonRepresentation * GetBalloonRepresentation ( ) { return reinterpret_cast < vtkBalloonRepresentation * > ( this -> WidgetRep ) ; } *
##  Create the default widget representation if one is not set.
##  void CreateDefaultRepresentation ( ) override ; /@{ *
##  Add and remove text and/or an image to be associated with a vtkProp. You
##  may add one or both of them.
##  void AddBalloon ( vtkProp * prop , vtkStdString * str , vtkImageData * img ) ; void AddBalloon ( vtkProp * prop , const char * str , vtkImageData * img ) ; void AddBalloon ( vtkProp * prop , const char * str )  for wrapping { this -> AddBalloon ( prop , str , nullptr ) ; } void RemoveBalloon ( vtkProp * prop ) ; /@} /@{ *
...
##  const char * GetBalloonString ( vtkProp * prop ) ; vtkImageData * GetBalloonImage ( vtkProp * prop ) ; /@} /@{ *
##  Update the balloon string or image. If the specified prop does not exist,
##  then nothing is added not changed.
##  void UpdateBalloonString ( vtkProp * prop , const char * str ) ; void UpdateBalloonImage ( vtkProp * prop , vtkImageData * image ) ; /@} *
...
##  void SetPicker ( vtkAbstractPropPicker * ) ; virtual vtkAbstractPropPicker * GetnamePicker ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Picker  address  << static_cast < vtkAbstractPropPicker * > ( this -> Picker ) ) ; return this -> Picker ; } ; /@}
##  Register internal Pickers within PickingManager
##  void RegisterPickers ( ) override ; protected : vtkBalloonWidget ( ) ; ~ vtkBalloonWidget ( ) override ;  This class implements the method called from its superclass. int SubclassEndHoverAction ( ) override ; int SubclassHoverAction ( ) override ;  Classes for managing balloons vtkPropMap * PropMap ;  PIMPL'd map of (vtkProp,vtkStdString)  Support for picking vtkAbstractPropPicker * Picker ;  The vtkProp that is being hovered over (which may be nullptr) vtkProp * CurrentProp ; private : vtkBalloonWidget ( const vtkBalloonWidget & ) = delete ; void operator = ( const vtkBalloonWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
