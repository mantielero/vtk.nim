...
## !!!Ignored construct:  # vtkDataArraySelection_h [NewLine] # vtkDataArraySelection_h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkObject.h [NewLine] # < memory >  for std::unique_ptr [NewLine] class VTKCOMMONCORE_EXPORT vtkDataArraySelection : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDataArraySelection :: IsTypeOf ( type ) ; } static vtkDataArraySelection * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDataArraySelection * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDataArraySelection * NewInstance ( ) const { return vtkDataArraySelection :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDataArraySelection :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDataArraySelection :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkDataArraySelection * New ( ) ; *
...
##
##  This method **does not** call `this->Modified()`.
##  void SetArrays ( const char * const * names , int numArrays ) ; void SetArraysWithDefault ( const char * const * names , int numArrays , int defaultStatus ) ; /@} *
...
##  void Union ( vtkDataArraySelection * other ) { this -> Union ( other , false ) ; } void Union ( vtkDataArraySelection * other , bool skipModified ) ; /@} /@{ *
...
##  virtual void SetUnknownArraySetting ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  UnknownArraySetting  to  << _arg ) ; if ( this -> UnknownArraySetting != _arg ) { this -> UnknownArraySetting = _arg ; this -> Modified ( ) ; } } ; virtual int GetUnknownArraySetting ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << UnknownArraySetting  of  << this -> UnknownArraySetting ) ; return this -> UnknownArraySetting ; } ; /@} *
...
##  bool IsEqual ( const vtkDataArraySelection * other ) const ; protected : vtkDataArraySelection ( ) ; ~ vtkDataArraySelection ( ) override ; private : vtkDataArraySelection ( const vtkDataArraySelection & ) = delete ; void operator = ( const vtkDataArraySelection & ) = delete ;  Internal implementation details. class vtkInternals ; std :: unique_ptr < vtkInternals > Internal ; int UnknownArraySetting ; } ;
