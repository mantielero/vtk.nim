...
## !!!Ignored construct:  # vtkAbstractArray_h [NewLine] # vtkAbstractArray_h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkIdList.h  For InsertTuples # vtkObject.h [NewLine] # vtkVariant.h  for variant arguments [NewLine] class vtkArrayIterator ;
...
## !!!Ignored construct:  class VTKCOMMONCORE_EXPORT vtkAbstractArray : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkAbstractArray :: IsTypeOf ( type ) ; } static vtkAbstractArray * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkAbstractArray * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkAbstractArray * NewInstance ( ) const { return vtkAbstractArray :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkAbstractArray :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkAbstractArray :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  components return 0.
##  virtual int GetDataTypeSize ( ) const = 0 ; static int GetDataTypeSize ( int type ) ; /@} *
...
##  void Reset ( ) { this -> MaxId = - 1 ; this -> DataChanged ( ) ; } /@} *
##  Return the size of the data.
##  vtkIdType GetSize ( ) const { return this -> Size ; } *
##  What is the maximum id currently in the array.
##  vtkIdType GetMaxId ( ) const { return this -> MaxId ; } enum DeleteMethod { VTK_DATA_ARRAY_FREE , VTK_DATA_ARRAY_DELETE , VTK_DATA_ARRAY_ALIGNED_FREE , VTK_DATA_ARRAY_USER_DEFINED } ; /@{ *
...
##  virtual void SetVoidArray ( void * vtkNotUsed ( array ) , vtkIdType vtkNotUsed ( size ) , int vtkNotUsed ( save ) ) = 0 ; virtual void SetVoidArray ( void * array , vtkIdType size , int save , int vtkNotUsed ( deleteMethod ) ) { this -> SetVoidArray ( array , size , save ) ; } /@} *
...
##  virtual void SetName ( const char * _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << Name  to  << ( _arg ? _arg : (null) ) ) ; if ( this -> Name == nullptr && _arg == nullptr ) { return ; } if ( this -> Name && _arg && ( ! strcmp ( this -> Name , _arg ) ) ) { return ; } delete [ ] this -> Name ; if ( _arg ) { size_t n = strlen ( _arg ) + 1 ; char * cp1 = new char [ n ] ; const char * cp2 = ( _arg ) ; this -> Name = cp1 ; do { * cp1 ++ = * cp2 ++ ; } while ( -- n ) ; } else { this -> Name = nullptr ; } this -> Modified ( ) ; } ; virtual char * GetName ( ) { vtkDebugWithObjectMacro ( this , <<  returning  << Name  of  << ( this -> Name ? this -> Name : (null) ) ) ; return this -> Name ; } ; /@} *
##  Get the name of a data type as a string.
##  virtual const char * GetDataTypeAsString ( void ) const { return ( ( ( this -> GetDataType ( ) ) == VTK_VOID ) ? void : ( ( ( this -> GetDataType ( ) ) == VTK_BIT ) ? bit : ( ( ( this -> GetDataType ( ) ) == VTK_CHAR ) ? char : ( ( ( this -> GetDataType ( ) ) == VTK_SIGNED_CHAR ) ? signed char : ( ( ( this -> GetDataType ( ) ) == VTK_UNSIGNED_CHAR ) ? unsigned char : ( ( ( this -> GetDataType ( ) ) == VTK_SHORT ) ? short : ( ( ( this -> GetDataType ( ) ) == VTK_UNSIGNED_SHORT ) ? unsigned short : ( ( ( this -> GetDataType ( ) ) == VTK_INT ) ? int : ( ( ( this -> GetDataType ( ) ) == VTK_UNSIGNED_INT ) ? unsigned int : ( ( ( this -> GetDataType ( ) ) == VTK_LONG ) ? long : ( ( ( this -> GetDataType ( ) ) == VTK_UNSIGNED_LONG ) ? unsigned long : ( ( ( this -> GetDataType ( ) ) == VTK_LONG_LONG ) ? long long : ( ( ( this -> GetDataType ( ) ) == VTK_UNSIGNED_LONG_LONG ) ? unsigned long long : ( ( ( this -> GetDataType ( ) ) == VTK_FLOAT ) ? float : ( ( ( this -> GetDataType ( ) ) == VTK_DOUBLE ) ? double : ( ( ( this -> GetDataType ( ) ) == VTK_ID_TYPE ) ? idtype : ( ( ( this -> GetDataType ( ) ) == VTK_STRING ) ? string : ( ( ( this -> GetDataType ( ) ) == VTK_VARIANT ) ? variant : ( ( ( this -> GetDataType ( ) ) == VTK_OBJECT ) ? object : Undefined ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ; } *
...
##  user.
##  VTK_NEWINSTANCE static vtkAbstractArray * CreateArray ( int dataType ) ; *
...
##  virtual vtkIdType GetDataSize ( ) const { return this -> GetNumberOfComponents ( ) * this -> GetNumberOfTuples ( ) ; } /@{ *
...
##  virtual vtkIdType LookupValue ( vtkVariant value ) = 0 ; virtual void LookupValue ( vtkVariant value , vtkIdList * valueIds ) = 0 ; /@} *
##  Retrieve value from the array as a variant.
##  virtual vtkVariant GetVariantValue ( vtkIdType valueIdx ) VTK_EXPECTS ( 0 <= valueIdx && valueIdx < GetNumberOfValues ( ) ) ; *
##  Insert a value into the array from a variant.  This method does
##  bounds checking.
##  virtual void InsertVariantValue ( vtkIdType valueIdx , vtkVariant value ) VTK_EXPECTS ( 0 <= valueIdx ) = 0 ; *
##  Set a value in the array from a variant.  This method does NOT do
##  bounds checking.
##  virtual void SetVariantValue ( vtkIdType valueIdx , vtkVariant value ) VTK_EXPECTS ( 0 <= valueIdx && valueIdx < GetNumberOfValues ( ) ) = 0 ; *
...
##  values.
##  virtual void GetProminentComponentValues ( int comp , vtkVariantArray * values , double uncertainty = 1.e-6 , double minimumProminence = 1.e-3 ) ;  TODO: Implement these lookup functions also.
...
##  static vtkInformationDoubleVectorKey * DISCRETE_VALUE_SAMPLE_PARAMETERS ( ) ;  Deprecated.  Use vtkAbstractArray::MaxDiscreteValues instead. enum { MAX_DISCRETE_VALUES = 32 } ; /@{ *
...
##  virtual unsigned int GetMaxDiscreteValues ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << MaxDiscreteValues  of  << this -> MaxDiscreteValues ) ; return this -> MaxDiscreteValues ; } ; virtual void SetMaxDiscreteValues ( unsigned int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  MaxDiscreteValues  to  << _arg ) ; if ( this -> MaxDiscreteValues != _arg ) { this -> MaxDiscreteValues = _arg ; this -> Modified ( ) ; } } ; /@} enum { AbstractArray = 0 , DataArray , AoSDataArrayTemplate , SoADataArrayTemplate , TypedDataArray , MappedDataArray , ScaleSoADataArrayTemplate , DataArrayTemplate = AoSDataArrayTemplate ! Legacy } ; *
...
##  const char * GetArrayTypeAsString ( ) const ; protected :  Construct object with default tuple dimension (number of components) of 1. vtkAbstractArray ( ) ; ~ vtkAbstractArray ( ) override ; *
...
##  virtual void UpdateDiscreteValueSet ( double uncertainty , double minProminence ) ; vtkIdType Size ;  allocated size of data vtkIdType MaxId ;  maximum index inserted thus far int NumberOfComponents ;  the number of components per tuple  maximum number of prominent values before array is considered continuous. unsigned int MaxDiscreteValues ; char * Name ; bool RebuildArray ;  whether to rebuild the fast lookup data structure. vtkInformation * Information ; class vtkInternalComponentNames ; vtkInternalComponentNames * ComponentNames ;  names for each component private : vtkAbstractArray ( const vtkAbstractArray & ) = delete ; void operator = ( const vtkAbstractArray & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
...
type
  VTKCOMMONCORE_EXPORTVTKCOMMONCORE_EXPORTvtkArrayDownCast_impl*[ArrayT] {.importcpp: "VTKCOMMONCORE_EXPORT::VTKCOMMONCORE_EXPORT::vtkArrayDownCast_impl<\'0>",
      header: "vtkAbstractArray.h", bycopy.} = object


proc `()`*[ArrayT](this: var VTKCOMMONCORE_EXPORTVTKCOMMONCORE_EXPORTvtkArrayDownCast_impl[
    ArrayT]; array: ptr vtkAbstractArray): ptr ArrayT {.importcpp: "#(@)",
    header: "vtkAbstractArray.h".}
## /@}
## *
...
proc vtkArrayDownCast*[ArrayT](array: ptr vtkAbstractArray): ptr ArrayT =
  discard
...
## !!!Ignored construct:  # vtkArrayDownCast_FastCastMacro ( ArrayT ) template < > [end of template] struct vtkArrayDownCast_impl < ArrayT > { inline ArrayT * operator ( ) ( vtkAbstractArray * array ) { return ArrayT :: FastDownCast ( array ) ; } } [NewLine] /@} /@{ *
...
##  with any value type.
##  # vtkArrayDownCast_TemplateFastCastMacro ( ArrayT ) template < typename ValueT > struct vtkArrayDownCast_impl < ArrayT < ValueT >> { inline ArrayT < ValueT > * operator ( ) ( vtkAbstractArray * array ) { return ArrayT < ValueT > :: FastDownCast ( array ) ; } } [NewLine] /@} # [NewLine]
