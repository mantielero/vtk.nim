...
## !!!Ignored construct:  # vtkInteractorStyleTrackballCamera_h [NewLine] # vtkInteractorStyleTrackballCamera_h [NewLine] # vtkInteractionStyleModule.h  For export macro # vtkInteractorStyle.h [NewLine] class VTKINTERACTIONSTYLE_EXPORT vtkInteractorStyleTrackballCamera : public vtkInteractorStyle { public : static vtkInteractorStyleTrackballCamera * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkInteractorStyle Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkInteractorStyle :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkInteractorStyleTrackballCamera :: IsTypeOf ( type ) ; } static vtkInteractorStyleTrackballCamera * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkInteractorStyleTrackballCamera * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkInteractorStyleTrackballCamera * NewInstance ( ) const { return vtkInteractorStyleTrackballCamera :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkInteractorStyle :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkInteractorStyleTrackballCamera :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkInteractorStyleTrackballCamera :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  (use interactor's GetEventPosition and GetLastEventPosition) void Rotate ( ) override ; void Spin ( ) override ; void Pan ( ) override ; void Dolly ( ) override ; void EnvironmentRotate ( ) override ; /@{ *
##  Set the apparent sensitivity of the interactor style to mouse motion.
##  virtual void SetMotionFactor ( double _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  MotionFactor  to  << _arg ) ; if ( this -> MotionFactor != _arg ) { this -> MotionFactor = _arg ; this -> Modified ( ) ; } } ; virtual double GetMotionFactor ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << MotionFactor  of  << this -> MotionFactor ) ; return this -> MotionFactor ; } ; /@} protected : vtkInteractorStyleTrackballCamera ( ) ; ~ vtkInteractorStyleTrackballCamera ( ) override ; double MotionFactor ; virtual void Dolly ( double factor ) ; private : vtkInteractorStyleTrackballCamera ( const vtkInteractorStyleTrackballCamera & ) = delete ; void operator = ( const vtkInteractorStyleTrackballCamera & ) = delete ; } ;
