...
## !!!Ignored construct:  # vtkEdgeTable_h [NewLine] # vtkEdgeTable_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkObject.h [NewLine] class vtkIdList ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPoints"
discard "forward decl of vtkVoidArray"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkEdgeTable : public vtkObject { public : *
##  Instantiate object assuming that 1000 edges are to be inserted.
##  static vtkEdgeTable * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkEdgeTable :: IsTypeOf ( type ) ; } static vtkEdgeTable * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkEdgeTable * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkEdgeTable * NewInstance ( ) const { return vtkEdgeTable :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkEdgeTable :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkEdgeTable :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual vtkIdType GetNumberOfEdges ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << NumberOfEdges  of  << this -> NumberOfEdges ) ; return this -> NumberOfEdges ; } ; /@} *
