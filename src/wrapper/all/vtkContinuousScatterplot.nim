...
## !!!Ignored construct:  # vtkContinuousScatterplot_h [NewLine] # vtkContinuousScatterplot_h [NewLine] # vtkImageAlgorithm.h [NewLine] # vtkInfovisCoreModule.h  For export macro [NewLine] class VTKINFOVISCORE_EXPORT vtkContinuousScatterplot : public vtkImageAlgorithm { public : static vtkContinuousScatterplot * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkImageAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkImageAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkContinuousScatterplot :: IsTypeOf ( type ) ; } static vtkContinuousScatterplot * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkContinuousScatterplot * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkContinuousScatterplot * NewInstance ( ) const { return vtkContinuousScatterplot :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkImageAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkContinuousScatterplot :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkContinuousScatterplot :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Get the tolerance used when comparing floating point numbers for equality.
##  virtual double GetEpsilon ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Epsilon  of  << this -> Epsilon ) ; return this -> Epsilon ; } ; *
##  Set the tolerance used when comparing floating point numbers for equality.
##  virtual void SetEpsilon ( double _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Epsilon  to  << _arg ) ; if ( this -> Epsilon != _arg ) { this -> Epsilon = _arg ; this -> Modified ( ) ; } } ; *
...
##  void SetField2 ( const char * fieldName , vtkIdType ResY ) ; protected : vtkContinuousScatterplot ( ) ;  Configure input port to accept only vtkUnstructuredGrid. int FillInputPortInformation ( int port , vtkInformation * info ) override ;  Configure out port to be a vtkImageData data set. int FillOutputPortInformation ( int port , vtkInformation * info ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ;  Set the tolerance used when comparing floating numbers for equality. double Epsilon ;  Names of the scalar fields to be used in the filter. const char * Fields [ 2 ] ;  Resolution of the output image. vtkIdType ResX , ResY ; private : vtkContinuousScatterplot ( const vtkContinuousScatterplot & ) = delete ; void operator = ( const vtkContinuousScatterplot & ) = delete ; } ;
