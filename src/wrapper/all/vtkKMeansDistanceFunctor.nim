## !!!Ignored construct:  # vtkKMeansDistanceFunctor_h [NewLine] # vtkKMeansDistanceFunctor_h [NewLine] *
...
##  # vtkFiltersStatisticsModule.h  For export macro # vtkObject.h [NewLine] class vtkVariantArray ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkAbstractArray"
discard "forward decl of vtkTable"
## !!!Ignored construct:  class VTKFILTERSSTATISTICS_EXPORT vtkKMeansDistanceFunctor : public vtkObject { public : static vtkKMeansDistanceFunctor * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkKMeansDistanceFunctor :: IsTypeOf ( type ) ; } static vtkKMeansDistanceFunctor * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkKMeansDistanceFunctor * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkKMeansDistanceFunctor * NewInstance ( ) const { return vtkKMeansDistanceFunctor :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkKMeansDistanceFunctor :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkKMeansDistanceFunctor :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  This code may assume that the columns in \a curTable are all of the type returned by \a
##  GetNewVTKArray().
##  virtual void UnPackElements ( vtkTable * curTable , vtkTable * newTable , void * vLocalElements , void * vGlobalElements , int np ) ; virtual void UnPackElements ( vtkTable * curTable , void * vLocalElements , vtkIdType numRows , vtkIdType numCols ) ; /@} *
##  Return the data type used to store cluster center coordinates.
##  virtual int GetDataType ( ) ; protected : vtkKMeansDistanceFunctor ( ) ; ~ vtkKMeansDistanceFunctor ( ) override ; vtkVariantArray * EmptyTuple ;  Used to quickly initialize Tuple for each datum vtkTable * CenterUpdates ;  Used to hold online computation of next iteration's cluster center coords. private : vtkKMeansDistanceFunctor ( const vtkKMeansDistanceFunctor & ) = delete ; void operator = ( const vtkKMeansDistanceFunctor & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
