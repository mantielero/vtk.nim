...
## !!!Ignored construct:  # vtkDistributedGraphHelper_h [NewLine] # vtkDistributedGraphHelper_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkObject.h [NewLine] class vtkDistributedGraphHelperInternals ;
...
type
  VTKCOMMONDATAMODEL_EXPORTvtkVertexPedigreeIdDistribution* = proc (
      pedigreeId: VTKCOMMONDATAMODEL_EXPORTvtkVariant; userData: pointer): vtkIdType

## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkDistributedGraphHelper : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDistributedGraphHelper :: IsTypeOf ( type ) ; } static vtkDistributedGraphHelper * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDistributedGraphHelper * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDistributedGraphHelper * NewInstance ( ) const { return vtkDistributedGraphHelper :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDistributedGraphHelper :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDistributedGraphHelper :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  static vtkInformationIntegerKey * DISTRIBUTEDVERTEXIDS ( ) ; static vtkInformationIntegerKey * DISTRIBUTEDEDGEIDS ( ) ; /@} protected : vtkDistributedGraphHelper ( ) ; ~ vtkDistributedGraphHelper ( ) override ; *
...
##  int indexBits ; private : vtkDistributedGraphHelper ( const vtkDistributedGraphHelper & ) = delete ; void operator = ( const vtkDistributedGraphHelper & ) = delete ; friend class vtkGraph ; } ;
## Error: token expected: ; but got: [identifier]!!!
