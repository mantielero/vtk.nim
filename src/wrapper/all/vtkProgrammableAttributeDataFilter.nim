...
## !!!Ignored construct:  # vtkProgrammableAttributeDataFilter_h [NewLine] # vtkProgrammableAttributeDataFilter_h [NewLine] # vtkDataSetAlgorithm.h [NewLine] # vtkFiltersProgrammableModule.h  For export macro [NewLine] class vtkDataSetCollection ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKFILTERSPROGRAMMABLE_EXPORT vtkProgrammableAttributeDataFilter : public vtkDataSetAlgorithm { public : static vtkProgrammableAttributeDataFilter * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkDataSetAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkDataSetAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkProgrammableAttributeDataFilter :: IsTypeOf ( type ) ; } static vtkProgrammableAttributeDataFilter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkProgrammableAttributeDataFilter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkProgrammableAttributeDataFilter * NewInstance ( ) const { return vtkProgrammableAttributeDataFilter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkDataSetAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkProgrammableAttributeDataFilter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkProgrammableAttributeDataFilter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void SetExecuteMethodArgDelete ( void ( * f ) ( void * ) ) ; protected : vtkProgrammableAttributeDataFilter ( ) ; ~ vtkProgrammableAttributeDataFilter ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; vtkDataSetCollection * InputList ;  list of datasets to process ProgrammableMethodCallbackType ExecuteMethod ;  function to invoke ProgrammableMethodCallbackType ExecuteMethodArgDelete ; void * ExecuteMethodArg ; void ReportReferences ( vtkGarbageCollector * ) override ; private :  hide the superclass' AddInput() from the user and the compiler void AddInput ( vtkDataObject * ) { do { if ( vtkObject :: GetGlobalWarningDisplay ( ) ) { vtkOStreamWrapper :: EndlType endl ; vtkOStreamWrapper :: UseEndl ( endl ) ; vtkOStrStreamWrapper vtkmsg ; vtkObject * _object = const_cast < vtkObject * > ( static_cast < const vtkObject * > ( this ) ) ; if ( _object ) { vtkmsg << _object -> GetObjectDescription ( ) << :  ; } else { vtkmsg << (nullptr):  ; } vtkmsg <<  << AddInput() must be called with a vtkDataSet not a vtkDataObject. ; std :: string _filename = vtksys :: SystemTools :: GetFilenameName ( __FILE__ ) ; vtkOutputWindowDisplayErrorText ( _filename . c_str ( ) , __LINE__ , vtkmsg . str ( ) , _object ) ; vtkmsg . rdbuf ( ) -> freeze ( 0 ) ; vtkObject :: BreakOnError ( ) ; } } while ( false ) ; } private : vtkProgrammableAttributeDataFilter ( const vtkProgrammableAttributeDataFilter & ) = delete ; void operator = ( const vtkProgrammableAttributeDataFilter & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
