...
## !!!Ignored construct:  # vtkTree_h [NewLine] # vtkTree_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDirectedAcyclicGraph.h [NewLine] class vtkIdTypeArray ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkTree : public vtkDirectedAcyclicGraph { public : static vtkTree * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkDirectedAcyclicGraph Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkDirectedAcyclicGraph :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkTree :: IsTypeOf ( type ) ; } static vtkTree * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkTree * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkTree * NewInstance ( ) const { return vtkTree :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkDirectedAcyclicGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkTree :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkTree :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Return what type of dataset this is.
##  int GetDataObjectType ( ) override { return VTK_TREE ; } /@{ *
##  Get the root vertex of the tree.
##  virtual vtkIdType GetRoot ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Root  of  << this -> Root ) ; return this -> Root ; } ; /@} *
...
##  static vtkTree * GetData ( vtkInformation * info ) ; static vtkTree * GetData ( vtkInformationVector * v , int i = 0 ) ; /@} *
...
##  virtual void ReorderChildren ( vtkIdType parent , vtkIdTypeArray * children ) ; protected : vtkTree ( ) ; ~ vtkTree ( ) override ; *
##  Check the storage, and accept it if it is a valid
##  tree.
##  bool IsStructureValid ( vtkGraph * g ) override ; *
##  The root of the tree.
##  vtkIdType Root ; private : vtkTree ( const vtkTree & ) = delete ; void operator = ( const vtkTree & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
