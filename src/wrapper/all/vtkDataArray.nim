...
## !!!Ignored construct:  # vtkDataArray_h [NewLine] # vtkDataArray_h [NewLine] # vtkAbstractArray.h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkVTK_USE_SCALED_SOA_ARRAYS.h  For #define of VTK_USE_SCALED_SOA_ARRAYS [NewLine] class vtkDoubleArray ;
...
## !!!Ignored construct:  class VTKCOMMONCORE_EXPORT vtkDataArray : public vtkAbstractArray { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractArray Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractArray :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDataArray :: IsTypeOf ( type ) ; } static vtkDataArray * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDataArray * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDataArray * NewInstance ( ) const { return vtkDataArray :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractArray :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDataArray :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDataArray :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  data type.
##  int GetElementComponentSize ( ) const override { return this -> GetDataTypeSize ( ) ; }  Reimplemented virtuals (doc strings are inherited from superclass):
## /@{ *
...
##  void InsertTuple ( vtkIdType dstTupleIdx , vtkIdType srcTupleIdx , vtkAbstractArray * source ) override ; vtkIdType InsertNextTuple ( vtkIdType srcTupleIdx , vtkAbstractArray * source ) override ; void InsertTuples ( vtkIdList * dstIds , vtkIdList * srcIds , vtkAbstractArray * source ) override ; void InsertTuples ( vtkIdType dstStart , vtkIdType n , vtkIdType srcStart , vtkAbstractArray * source ) override ; void InsertTuplesStartingAt ( vtkIdType dstStart , vtkIdList * srcIds , vtkAbstractArray * source ) override ; void SetTuple ( vtkIdType dstTupleIdx , vtkIdType srcTupleIdx , vtkAbstractArray * source ) override ; /@} void GetTuples ( vtkIdList * tupleIds , vtkAbstractArray * output ) override ; void GetTuples ( vtkIdType p1 , vtkIdType p2 , vtkAbstractArray * output ) override ; void InterpolateTuple ( vtkIdType dstTupleIdx , vtkIdList * ptIndices , vtkAbstractArray * source , double * weights ) override ; void InterpolateTuple ( vtkIdType dstTupleIdx , vtkIdType srcTupleIdx1 , vtkAbstractArray * source1 , vtkIdType srcTupleIdx2 , vtkAbstractArray * source2 , double t ) override ; *
...
##  virtual double * GetTuple ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) = 0 ; *
...
##  virtual void GetTuple ( vtkIdType tupleIdx , double * tuple ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) = 0 ; /@{ *
...
##  double GetTuple1 ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; double * GetTuple2 ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_SIZEHINT ( 2 ) ; double * GetTuple3 ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_SIZEHINT ( 3 ) ; double * GetTuple4 ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_SIZEHINT ( 4 ) ; double * GetTuple6 ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_SIZEHINT ( 6 ) ; double * GetTuple9 ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_SIZEHINT ( 9 ) ; /@} /@{ *
...
##  virtual void SetTuple ( vtkIdType tupleIdx , const float * tuple ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; virtual void SetTuple ( vtkIdType tupleIdx , const double * tuple ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; /@} /@{ *
##  These methods are included as convenience for the wrappers.
##  GetTuple() and SetTuple() which return/take arrays can not be
##  used from wrapped languages. These methods can be used instead.
##  void SetTuple1 ( vtkIdType tupleIdx , double value ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; void SetTuple2 ( vtkIdType tupleIdx , double val0 , double val1 ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; void SetTuple3 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; void SetTuple4 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 , double val3 ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; void SetTuple6 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 , double val3 , double val4 , double val5 ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; void SetTuple9 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 , double val3 , double val4 , double val5 , double val6 , double val7 , double val8 ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) ; /@} /@{ *
##  Insert the data tuple at tupleIdx. Note that memory allocation
##  is performed as necessary to hold the data.
##  virtual void InsertTuple ( vtkIdType tupleIdx , const float * tuple ) VTK_EXPECTS ( 0 <= tupleIdx ) = 0 ; virtual void InsertTuple ( vtkIdType tupleIdx , const double * tuple ) VTK_EXPECTS ( 0 <= tupleIdx ) = 0 ; /@} /@{ *
##  These methods are included as convenience for the wrappers.
##  InsertTuple() which takes arrays can not be
##  used from wrapped languages. These methods can be used instead.
##  void InsertTuple1 ( vtkIdType tupleIdx , double value ) VTK_EXPECTS ( 0 <= tupleIdx ) ; void InsertTuple2 ( vtkIdType tupleIdx , double val0 , double val1 ) VTK_EXPECTS ( 0 <= tupleIdx ) ; void InsertTuple3 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 ) VTK_EXPECTS ( 0 <= tupleIdx ) ; void InsertTuple4 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 , double val3 ) VTK_EXPECTS ( 0 <= tupleIdx ) ; void InsertTuple6 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 , double val3 , double val4 , double val5 ) VTK_EXPECTS ( 0 <= tupleIdx ) ; void InsertTuple9 ( vtkIdType tupleIdx , double val0 , double val1 , double val2 , double val3 , double val4 , double val5 , double val6 , double val7 , double val8 ) VTK_EXPECTS ( 0 <= tupleIdx ) ; /@} /@{ *
...
##  the data.
##  virtual vtkIdType InsertNextTuple ( const float * tuple ) = 0 ; virtual vtkIdType InsertNextTuple ( const double * tuple ) = 0 ; /@} /@{ *
##  These methods are included as convenience for the wrappers.
##  InsertTuple() which takes arrays can not be
##  used from wrapped languages. These methods can be used instead.
##  void InsertNextTuple1 ( double value ) ; void InsertNextTuple2 ( double val0 , double val1 ) ; void InsertNextTuple3 ( double val0 , double val1 , double val2 ) ; void InsertNextTuple4 ( double val0 , double val1 , double val2 , double val3 ) ; void InsertNextTuple6 ( double val0 , double val1 , double val2 , double val3 , double val4 , double val5 ) ; void InsertNextTuple9 ( double val0 , double val1 , double val2 , double val3 , double val4 , double val5 , double val6 , double val7 , double val8 ) ; /@} /@{ *
...
##  virtual void RemoveTuple ( vtkIdType tupleIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) = 0 ; virtual void RemoveFirstTuple ( ) { this -> RemoveTuple ( 0 ) ; } virtual void RemoveLastTuple ( ) ; /@} *
##  Return the data component at the location specified by tupleIdx and
##  compIdx.
##  virtual double GetComponent ( vtkIdType tupleIdx , int compIdx ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_EXPECTS ( 0 <= compIdx && compIdx < GetNumberOfComponents ( ) ) ; *
##  Set the data component at the location specified by tupleIdx and compIdx
##  to value.
##  Note that i is less than NumberOfTuples and j is less than
##  NumberOfComponents. Make sure enough memory has been allocated
##  (use SetNumberOfTuples() and SetNumberOfComponents()).
##  virtual void SetComponent ( vtkIdType tupleIdx , int compIdx , double value ) VTK_EXPECTS ( 0 <= tupleIdx && tupleIdx < GetNumberOfTuples ( ) ) VTK_EXPECTS ( 0 <= compIdx && compIdx < GetNumberOfComponents ( ) ) ; *
##  Insert value at the location specified by tupleIdx and compIdx.
##  Note that memory allocation is performed as necessary to hold the data.
##  virtual void InsertComponent ( vtkIdType tupleIdx , int compIdx , double value ) VTK_EXPECTS ( 0 <= tupleIdx ) VTK_EXPECTS ( 0 <= compIdx && compIdx < GetNumberOfComponents ( ) ) ; *
...
##  void DeepCopy ( vtkAbstractArray * aa ) override ; virtual void DeepCopy ( vtkDataArray * da ) ; /@} *
...
##  virtual void FillComponent ( int compIdx , double value ) VTK_EXPECTS ( 0 <= compIdx && compIdx < GetNumberOfComponents ( ) ) ; *
...
##  void GetRange ( double range [ 2 ] , int comp ) { this -> ComputeRange ( range , comp ) ; } void GetRange ( double range [ 2 ] , int comp , const unsigned char * ghosts , unsigned char ghostsToSkip ) { this -> ComputeRange ( range , comp , ghosts , ghostsToSkip ) ; } /@} /@{ *
...
##  THIS METHOD IS NOT THREAD SAFE.
##  double * GetRange ( int comp ) VTK_SIZEHINT ( 2 ) { this -> GetRange ( this -> Range , comp ) ; return this -> Range ; } /@} *
...
##
##  THIS METHOD IS NOT THREAD SAFE.
##  void GetFiniteRange ( double range [ 2 ] , int comp ) { this -> ComputeFiniteRange ( range , comp ) ; } void GetFiniteRange ( double range [ 2 ] , int comp , const unsigned char * ghosts , unsigned char ghostsToSkip ) { this -> ComputeFiniteRange ( range , comp , ghosts , ghostsToSkip ) ; } /@} /@{ *
##  Return the range of the data array values for the given component. If
##  comp is -1, return the range of the magnitude (L2 norm) over all
##  components.The range is computed and then cached, and will not be
##  re-computed on subsequent calls to GetRange() unless the array is
##  modified or the requested component changes.
##  THIS METHOD IS NOT THREAD SAFE.
##  double * GetFiniteRange ( int comp ) VTK_SIZEHINT ( 2 ) { this -> GetFiniteRange ( this -> FiniteRange , comp ) ; return this -> FiniteRange ; } /@} *
##  Return the range of the data array. If the array has multiple components,
##  then this will return the range of only the first component (component
##  zero). The range is computed and then cached, and will not be re-computed
##  on subsequent calls to GetRange() unless the array is modified.
...
##  void GetDataTypeRange ( double range [ 2 ] ) ; double GetDataTypeMin ( ) ; double GetDataTypeMax ( ) ; static void GetDataTypeRange ( int type , double range [ 2 ] ) ; static double GetDataTypeMin ( int type ) ; static double GetDataTypeMax ( int type ) ; /@} *
...
##  user.
##  VTK_NEWINSTANCE static vtkDataArray * CreateDataArray ( int dataType ) ; *
...
##  int GetArrayType ( ) const override { return DataArray ; } protected : friend class vtkPoints ; friend class vtkFieldData ; /@{ *
...
##
##  THIS METHOD IS NOT THREAD SAFE.
##  virtual void ComputeRange ( double range [ 2 ] , int comp ) ; virtual void ComputeRange ( double range [ 2 ] , int comp , const unsigned char * ghosts , unsigned char ghostsToSkip = 0xff ) ; /@} /@{ *
##  Compute the range for a specific component. If comp is set -1
##  then L2 norm is computed on all components. Call ClearRange
##  to force a recomputation if it is needed. The range is copied
##  to the range argument.
...
##
##  THIS METHOD IS NOT THREAD SAFE.
##  virtual void ComputeFiniteRange ( double range [ 2 ] , int comp ) ; virtual void ComputeFiniteRange ( double range [ 2 ] , int comp , const unsigned char * ghosts , unsigned char ghostsToSkip = 0xff ) ; /@} /@{ *
...
##  when using a ghost array.
##
##  virtual bool ComputeScalarRange ( double * ranges ) ; virtual bool ComputeScalarRange ( double * ranges , const unsigned char * ghosts , unsigned char ghostsToSkip = 0xff ) ; /@} /@{ *
##  Returns true if the range was computed. Will return false
##  if you try to compute the range of an array of length zero.
##
##  The version of this method with `ghosts` and `ghostsToSkip` allows to skip
...
##  this instance. See `vtkFieldData::GetRange`, which caches the computated range
##  when using a ghost array.
##  virtual bool ComputeVectorRange ( double range [ 2 ] ) ; virtual bool ComputeVectorRange ( double range [ 2 ] , const unsigned char * ghosts , unsigned char ghostsToSkip = 0xff ) ; /@} /@{ *
##  Computes the range for each component of an array, the length
##  of \a ranges must be two times the number of components.
##  Returns true if the range was computed. Will return false
##  if you try to compute the range of an array of length zero.
...
##  this instance. See `vtkFieldData::GetFiniteRange`, which caches the computated range
##  when using a ghost array.
##  virtual bool ComputeFiniteScalarRange ( double * ranges ) ; virtual bool ComputeFiniteScalarRange ( double * ranges , const unsigned char * ghosts , unsigned char ghostsToSkip = 0xff ) ; /@} /@{ *
##  Returns true if the range was computed. Will return false
##  if you try to compute the range of an array of length zero.
##
##  The version of this method with `ghosts` and `ghostsToSkip` allows to skip
...
##  this instance. See `vtkFieldData::GetFiniteRange`, which caches the computated range
##  when using a ghost array.
##  virtual bool ComputeFiniteVectorRange ( double range [ 2 ] ) ; virtual bool ComputeFiniteVectorRange ( double range [ 2 ] , const unsigned char * ghosts , unsigned char ghostsToSkip = 0xff ) ; /@}  Construct object with default tuple dimension (number of components) of 1. vtkDataArray ( ) ; ~ vtkDataArray ( ) override ; vtkLookupTable * LookupTable ; double Range [ 2 ] ; double FiniteRange [ 2 ] ; private : double * GetTupleN ( vtkIdType i , int n ) ; private : vtkDataArray ( const vtkDataArray & ) = delete ; void operator = ( const vtkDataArray & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

## ------------------------------------------------------------------------------

proc FastDownCast*(source: ptr vtkAbstractArray): ptr vtkDataArray {.
    importcpp: "VTKCOMMONCORE_EXPORT::FastDownCast(@)", header: "vtkDataArray.h".}
...
type
  VTKCOMMONCORE_EXPORTVTKCOMMONCORE_EXPORTAllValues* {.importcpp: "vtkDataArrayPrivate::VTKCOMMONCORE_EXPORT::VTKCOMMONCORE_EXPORT::AllValues",
      header: "vtkDataArray.h", bycopy.} = object

  VTKCOMMONCORE_EXPORTVTKCOMMONCORE_EXPORTFiniteValues* {.importcpp: "vtkDataArrayPrivate::VTKCOMMONCORE_EXPORT::VTKCOMMONCORE_EXPORT::FiniteValues",
      header: "vtkDataArray.h", bycopy.} = object
