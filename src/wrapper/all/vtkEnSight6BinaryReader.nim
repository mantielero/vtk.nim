...
## !!!Ignored construct:  # vtkEnSight6BinaryReader_h [NewLine] # vtkEnSight6BinaryReader_h [NewLine] # vtkEnSightReader.h [NewLine] # vtkIOEnSightModule.h  For export macro [NewLine] class vtkMultiBlockDataSet ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkIdTypeArray"
discard "forward decl of vtkPoints"
## !!!Ignored construct:  class VTKIOENSIGHT_EXPORT vtkEnSight6BinaryReader : public vtkEnSightReader { public : static vtkEnSight6BinaryReader * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkEnSightReader Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkEnSightReader :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkEnSight6BinaryReader :: IsTypeOf ( type ) ; } static vtkEnSight6BinaryReader * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkEnSight6BinaryReader * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkEnSight6BinaryReader * NewInstance ( ) const { return vtkEnSight6BinaryReader :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkEnSightReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkEnSight6BinaryReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkEnSight6BinaryReader :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; protected : vtkEnSight6BinaryReader ( ) ; ~ vtkEnSight6BinaryReader ( ) override ;  Returns 1 if successful.  Sets file size as a side action. int OpenFile ( const char * filename ) ; *
...
##  int SkipTimeStep ( ) ; int SkipStructuredGrid ( char line [ 256 ] ) ; int SkipUnstructuredGrid ( char line [ 256 ] ) ; /@}  global list of points for the unstructured parts of the model int NumberOfUnstructuredPoints ; vtkPoints * UnstructuredPoints ; vtkIdTypeArray * UnstructuredNodeIds ;  matching of node ids to point ids int ElementIdsListed ;  The size of the file is used to choose byte order. vtkTypeUInt64 FileSize ; istream * BinaryIFile ; private : vtkEnSight6BinaryReader ( const vtkEnSight6BinaryReader & ) = delete ; void operator = ( const vtkEnSight6BinaryReader & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
