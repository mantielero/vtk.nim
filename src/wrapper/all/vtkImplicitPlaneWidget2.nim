...
## !!!Ignored construct:  # vtkImplicitPlaneWidget2_h [NewLine] # vtkImplicitPlaneWidget2_h [NewLine] # vtkAbstractWidget.h [NewLine] # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkImplicitPlaneRepresentation ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkImplicitPlaneWidget2InteractionCallback"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkImplicitPlaneWidget2 : public vtkAbstractWidget { friend class vtkImplicitPlaneWidget2InteractionCallback ; public : *
##  Instantiate the object.
##  static vtkImplicitPlaneWidget2 * New ( ) ; /@{ *
##  Standard vtkObject methods
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkImplicitPlaneWidget2 :: IsTypeOf ( type ) ; } static vtkImplicitPlaneWidget2 * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkImplicitPlaneWidget2 * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkImplicitPlaneWidget2 * NewInstance ( ) const { return vtkImplicitPlaneWidget2 :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkImplicitPlaneWidget2 :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkImplicitPlaneWidget2 :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
##  Specify an instance of vtkWidgetRepresentation used to represent this
##  widget in the scene. Note that the representation is a subclass of vtkProp
##  so it can be added to the renderer independent of the widget.
##  void SetRepresentation ( vtkImplicitPlaneRepresentation * rep ) ;  Description:
...
##  vtkImplicitPlaneRepresentation * GetImplicitPlaneRepresentation ( ) { return reinterpret_cast < vtkImplicitPlaneRepresentation * > ( this -> WidgetRep ) ; } *
##  Create the default widget representation if one is not set.
##  void CreateDefaultRepresentation ( ) override ; protected : vtkImplicitPlaneWidget2 ( ) ; ~ vtkImplicitPlaneWidget2 ( ) override ;  Manage the state of the widget int WidgetState ; enum WidgetStateType { Start = 0 , Active } ; # ! defined ( VTK_LEGACY_REMOVE ) [NewLine] VTK_DEPRECATED_IN_9_2_0 ( because leading underscore is reserved ) typedef WidgetStateType _WidgetState ; # [NewLine]  These methods handle events static void SelectAction ( vtkAbstractWidget * ) ; static void TranslateAction ( vtkAbstractWidget * ) ; static void ScaleAction ( vtkAbstractWidget * ) ; static void EndSelectAction ( vtkAbstractWidget * ) ; static void MoveAction ( vtkAbstractWidget * ) ; static void MovePlaneAction ( vtkAbstractWidget * ) ; static void SelectAction3D ( vtkAbstractWidget * ) ; static void EndSelectAction3D ( vtkAbstractWidget * ) ; static void MoveAction3D ( vtkAbstractWidget * ) ; static void TranslationAxisLock ( vtkAbstractWidget * ) ; static void TranslationAxisUnLock ( vtkAbstractWidget * ) ; *
...
##  vtkImplicitPlaneWidget2InteractionCallback * InteractionCallback ; void InvokeInteractionCallback ( ) ; /@} private : vtkImplicitPlaneWidget2 ( const vtkImplicitPlaneWidget2 & ) = delete ; void operator = ( const vtkImplicitPlaneWidget2 & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
