...
## !!!Ignored construct:  # vtkArrayExtents_h [NewLine] # vtkArrayExtents_h [NewLine] # vtkArrayRange.h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkSystemIncludes.h [NewLine] # < vector >  STL Header [NewLine] class VTKCOMMONCORE_EXPORT vtkArrayExtents { public : typedef vtkArrayCoordinates :: DimensionT DimensionT ; typedef vtkArrayCoordinates :: CoordinateT CoordinateT ; typedef vtkTypeUInt64 SizeT ; *
...
##  bool Contains ( const vtkArrayCoordinates & coordinates ) const ; VTKCOMMONCORE_EXPORT friend ostream & operator << ( ostream & stream , const vtkArrayExtents & rhs ) ; private : std :: vector < vtkArrayRange > Storage ; } ;
