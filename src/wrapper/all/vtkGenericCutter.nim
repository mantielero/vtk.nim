...
## !!!Ignored construct:  # vtkGenericCutter_h [NewLine] # vtkGenericCutter_h [NewLine] # vtkFiltersGenericModule.h  For export macro # vtkPolyDataAlgorithm.h [NewLine] class vtkContourValues ;
...
## !!!Ignored construct:  class VTKFILTERSGENERIC_EXPORT vtkGenericCutter : public vtkPolyDataAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPolyDataAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPolyDataAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkGenericCutter :: IsTypeOf ( type ) ; } static vtkGenericCutter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkGenericCutter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkGenericCutter * NewInstance ( ) const { return vtkGenericCutter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPolyDataAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkGenericCutter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkGenericCutter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void CreateDefaultLocator ( ) ; protected : vtkGenericCutter ( vtkImplicitFunction * cf = nullptr ) ; ~ vtkGenericCutter ( ) override ; /@{ *
##  Actual implementation of the cutter operation.
##  int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int FillInputPortInformation ( int , vtkInformation * ) override ; /@} vtkImplicitFunction * CutFunction ; vtkIncrementalPointLocator * Locator ; vtkContourValues * ContourValues ; vtkTypeBool GenerateCutScalars ;  Used internal by vtkGenericAdaptorCell::Contour() vtkPointData * InternalPD ; vtkPointData * SecondaryPD ; vtkCellData * SecondaryCD ; private : vtkGenericCutter ( const vtkGenericCutter & ) = delete ; void operator = ( const vtkGenericCutter & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
