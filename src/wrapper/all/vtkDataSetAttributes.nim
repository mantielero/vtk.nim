...
## !!!Ignored construct:  # vtkDataSetAttributes_h [NewLine] # vtkDataSetAttributes_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDataSetAttributesFieldList.h  for vtkDataSetAttributesFieldList # vtkFieldData.h [NewLine] class vtkLookupTable ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkDataSetAttributes : public vtkFieldData { public : *
##  Construct object with copying turned on for all data.
##  static vtkDataSetAttributes * New ( ) ; static vtkDataSetAttributes * ExtendedNew ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkFieldData Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkFieldData :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDataSetAttributes :: IsTypeOf ( type ) ; } static vtkDataSetAttributes * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDataSetAttributes * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDataSetAttributes * NewInstance ( ) const { return vtkDataSetAttributes :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkFieldData :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDataSetAttributes :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDataSetAttributes :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  now this is ignored.
##  virtual void Update ( ) { }  -- shallow and deep copy ----------------------------------------------- *
...
##  Ignores the copy flags but preserves them in the output.
##  void ShallowCopy ( vtkFieldData * pd ) override ;  -- attribute types -----------------------------------------------------  Always keep NUM_ATTRIBUTES as the last entry enum AttributeTypes { SCALARS = 0 , VECTORS = 1 , NORMALS = 2 , TCOORDS = 3 , TENSORS = 4 , GLOBALIDS = 5 , PEDIGREEIDS = 6 , EDGEFLAG = 7 , TANGENTS = 8 , RATIONALWEIGHTS = 9 , HIGHERORDERDEGREES = 10 , NUM_ATTRIBUTES } ; enum AttributeLimitTypes { MAX , EXACT , NOLIMIT } ;  ----------- ghost points and ghost cells -------------------------------------------
##  The following bit fields are consistent with VisIt ghost zones specification
##  For details, see http://www.visitusers.org/index.php?title=Representing_ghost_data enum CellGhostTypes { DUPLICATECELL = 1 ,  the cell is present on multiple processors HIGHCONNECTIVITYCELL = 2 ,  the cell has more neighbors than in a regular mesh LOWCONNECTIVITYCELL = 4 ,  the cell has less neighbors than in a regular mesh REFINEDCELL = 8 ,  other cells are present that refines it. EXTERIORCELL = 16 ,  the cell is on the exterior of the data set HIDDENCELL = 32  the cell is needed to maintain connectivity, but the data values should be ignored. } ; enum PointGhostTypes { DUPLICATEPOINT = 1 ,  the cell is present on multiple processors HIDDENPOINT = 2  the point is needed to maintain connectivity, but the data values should be ignored. } ;  A vtkDataArray with this name must be of type vtkUnsignedCharArray.
##  Each value must be assigned according to the bit fields described in
##  PointGhostTypes or CellGhostType static const char * GhostArrayName ( ) { return vtkGhostType ; } ----------------------------------------------------------------------------------- /@{ *
##  Set/Get the scalar data.
##  int SetScalars ( vtkDataArray * da ) ; int SetActiveScalars ( const char * name ) ; vtkDataArray * GetScalars ( ) ; /@} /@{ *
##  Set/Get the vector data.
##  int SetVectors ( vtkDataArray * da ) ; int SetActiveVectors ( const char * name ) ; vtkDataArray * GetVectors ( ) ; /@} /@{ *
##  Set/get the normal data.
##  int SetNormals ( vtkDataArray * da ) ; int SetActiveNormals ( const char * name ) ; vtkDataArray * GetNormals ( ) ; /@} /@{ *
##  Set/get the tangent data.
##  int SetTangents ( vtkDataArray * da ) ; int SetActiveTangents ( const char * name ) ; vtkDataArray * GetTangents ( ) ; /@} /@{ *
##  Set/Get the texture coordinate data.
##  int SetTCoords ( vtkDataArray * da ) ; int SetActiveTCoords ( const char * name ) ; vtkDataArray * GetTCoords ( ) ; /@} /@{ *
##  Set/Get the tensor data.
##  int SetTensors ( vtkDataArray * da ) ; int SetActiveTensors ( const char * name ) ; vtkDataArray * GetTensors ( ) ; /@} /@{ *
##  Set/Get the global id data.
##  int SetGlobalIds ( vtkDataArray * da ) ; int SetActiveGlobalIds ( const char * name ) ; vtkDataArray * GetGlobalIds ( ) ; /@} /@{ *
##  Set/Get the pedigree id data.
##  int SetPedigreeIds ( vtkAbstractArray * da ) ; int SetActivePedigreeIds ( const char * name ) ; vtkAbstractArray * GetPedigreeIds ( ) ; /@} /@{ *
##  Set/Get the rational weights data.
##  int SetRationalWeights ( vtkDataArray * da ) ; int SetActiveRationalWeights ( const char * name ) ; vtkDataArray * GetRationalWeights ( ) ; /@} /@{ *
##  Set/Get the rational degrees data.
##  int SetHigherOrderDegrees ( vtkDataArray * da ) ; int SetActiveHigherOrderDegrees ( const char * name ) ; vtkDataArray * GetHigherOrderDegrees ( ) ; /@} /@{ *
...
##  vtkDataArray * GetScalars ( const char * name ) ; vtkDataArray * GetVectors ( const char * name ) ; vtkDataArray * GetNormals ( const char * name ) ; vtkDataArray * GetTangents ( const char * name ) ; vtkDataArray * GetTCoords ( const char * name ) ; vtkDataArray * GetTensors ( const char * name ) ; vtkDataArray * GetGlobalIds ( const char * name ) ; vtkAbstractArray * GetPedigreeIds ( const char * name ) ; vtkDataArray * GetRationalWeights ( const char * name ) ; vtkDataArray * GetHigherOrderDegrees ( const char * name ) ; /@} *
...
##  using vtkFieldData :: RemoveArray ; void RemoveArray ( int index ) override ; /@} /@{ *
##  Given an integer attribute type, this static method returns a string type
##  for the attribute (i.e. type = 0: returns "Scalars").
##  static const char * GetAttributeTypeAsString ( int attributeType ) ; static const char * GetLongAttributeTypeAsString ( int attributeType ) ; /@}  -- attribute copy properties ------------------------------------------ enum AttributeCopyOperations { COPYTUPLE = 0 , INTERPOLATE = 1 , PASSDATA = 2 , ALLCOPY  all of the above } ; *
...
##  \c index.
##  int GetCopyAttribute ( int index , int ctype ) ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyScalars ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyScalars ( int ctype = ALLCOPY ) ; virtual void CopyScalarsOn ( ) { this -> SetCopyScalars ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyScalarsOff ( ) { this -> SetCopyScalars ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyVectors ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyVectors ( int ctype = ALLCOPY ) ; virtual void CopyVectorsOn ( ) { this -> SetCopyScalarsCopyVectors ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyVectorsOff ( ) { this -> SetCopyScalarsCopyVectors ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyNormals ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyNormals ( int ctype = ALLCOPY ) ; virtual void CopyNormalsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormals ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyNormalsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormals ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyTangents ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyTangents ( int ctype = ALLCOPY ) ; virtual void CopyTangentsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangents ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyTangentsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangents ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyTCoords ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyTCoords ( int ctype = ALLCOPY ) ; virtual void CopyTCoordsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoords ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyTCoordsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoords ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyTensors ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyTensors ( int ctype = ALLCOPY ) ; virtual void CopyTensorsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensors ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyTensorsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensors ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyGlobalIds ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyGlobalIds ( int ctype = ALLCOPY ) ; virtual void CopyGlobalIdsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIds ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyGlobalIdsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIds ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyPedigreeIds ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyPedigreeIds ( int ctype = ALLCOPY ) ; virtual void CopyPedigreeIdsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIdsCopyPedigreeIds ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyPedigreeIdsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIdsCopyPedigreeIds ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyRationalWeights ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyRationalWeights ( int ctype = ALLCOPY ) ; virtual void CopyRationalWeightsOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIdsCopyPedigreeIdsCopyRationalWeights ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyRationalWeightsOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIdsCopyPedigreeIdsCopyRationalWeights ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void SetCopyHigherOrderDegrees ( vtkTypeBool i , int ctype = ALLCOPY ) ; vtkTypeBool GetCopyHigherOrderDegrees ( int ctype = ALLCOPY ) ; virtual void CopyHigherOrderDegreesOn ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIdsCopyPedigreeIdsCopyRationalWeightsCopyHigherOrderDegrees ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CopyHigherOrderDegreesOff ( ) { this -> SetCopyScalarsCopyVectorsCopyNormalsCopyTangentsCopyTCoordsCopyTensorsCopyGlobalIdsCopyPedigreeIdsCopyRationalWeightsCopyHigherOrderDegrees ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void CopyAllOn ( int ctype = ALLCOPY ) override ; / @copydoc vtkDataSetAttributes::SetCopyAttribute() void CopyAllOff ( int ctype = ALLCOPY ) override ;  -- passthrough operations ---------------------------------------------- *
...
##  CopyAllOn/Off
##  void PassData ( vtkFieldData * fd ) override ;  -- copytuple operations ------------------------------------------------ /@{ *
...
##  void CopyAllocate ( vtkDataSetAttributes * pd , vtkIdType sze = 0 , vtkIdType ext = 1000 ) { this -> CopyAllocate ( pd , sze , ext , 0 ) ; } void CopyAllocate ( vtkDataSetAttributes * pd , vtkIdType sze , vtkIdType ext , int shallowCopyArrays ) ; /@} *
...
##  void CopyData ( vtkDataSetAttributes * fromPd , vtkIdType fromId , vtkIdType toId ) ; void CopyData ( vtkDataSetAttributes * fromPd , vtkIdList * fromIds , vtkIdList * toIds ) ; void CopyData ( vtkDataSetAttributes * fromPd , vtkIdList * fromIds , vtkIdType destStartId = 0 ) ; /@} *
...
##  void CopyTuple ( vtkAbstractArray * fromData , vtkAbstractArray * toData , vtkIdType fromId , vtkIdType toId ) ; void CopyTuples ( vtkAbstractArray * fromData , vtkAbstractArray * toData , vtkIdList * fromIds , vtkIdList * toIds ) ; void CopyTuples ( vtkAbstractArray * fromData , vtkAbstractArray * toData , vtkIdType dstStart , vtkIdType n , vtkIdType srcStart ) ; /@}  -- interpolate operations ---------------------------------------------- /@{ *
...
##  If shallowCopyArrays is true, input arrays are copied to the output
##  instead of new ones being allocated.
##  void InterpolateAllocate ( vtkDataSetAttributes * pd , vtkIdType sze = 0 , vtkIdType ext = 1000 ) { this -> InterpolateAllocate ( pd , sze , ext , 0 ) ; } void InterpolateAllocate ( vtkDataSetAttributes * pd , vtkIdType sze , vtkIdType ext , int shallowCopyArrays ) ; /@} *
...
##  is prevented. If the flag is set to 1, weighted interpolation occurs.
##  If the flag is set to 2, nearest neighbor interpolation is used.
##  void InterpolateTime ( vtkDataSetAttributes * from1 , vtkDataSetAttributes * from2 , vtkIdType id , double t ) ; using FieldList = vtkDataSetAttributesFieldList ;  field list copy operations ------------------------------------------ *
...
##  FieldLists.
##  void CopyData ( vtkDataSetAttributes :: FieldList & list , vtkDataSetAttributes * dsa , int idx , vtkIdType fromId , vtkIdType toId ) ; void CopyData ( vtkDataSetAttributes :: FieldList & list , vtkDataSetAttributes * dsa , int idx , vtkIdType dstStart , vtkIdType n , vtkIdType srcStart ) ; *
...
##  void InterpolatePoint ( vtkDataSetAttributes :: FieldList & list , vtkDataSetAttributes * fromPd , int idx , vtkIdType toId , vtkIdList * ids , double * weights ) ; protected : vtkDataSetAttributes ( ) ; ~ vtkDataSetAttributes ( ) override ; void InternalCopyAllocate ( vtkDataSetAttributes * pd , int ctype , vtkIdType sze = 0 , vtkIdType ext = 1000 , int shallowCopyArrays = 0 , bool createNewArrays = true ) ; *
##  Initialize all of the object's data to nullptr
##  void InitializeFields ( ) override ; int AttributeIndices [ NUM_ATTRIBUTES ] ;  index to attribute array in field data int CopyAttributeFlags [ ALLCOPY ] [ NUM_ATTRIBUTES ] ;  copy flag for attribute data friend struct ArrayList ;  Friend to base class in vtkArrayListTemplate vtkFieldData :: BasicIterator RequiredArrays ; int * TargetIndices ; static const int NumberOfAttributeComponents [ NUM_ATTRIBUTES ] ; static const int AttributeLimits [ NUM_ATTRIBUTES ] ; static const char AttributeNames [ NUM_ATTRIBUTES ] [ 19 ] ; static const char LongAttributeNames [ NUM_ATTRIBUTES ] [ 42 ] ; private : static int CheckNumberOfComponents ( vtkAbstractArray * da , int attributeType ) ; vtkFieldData :: BasicIterator ComputeRequiredArrays ( vtkDataSetAttributes * pd , int ctype ) ; private : vtkDataSetAttributes ( const vtkDataSetAttributes & ) = delete ; void operator = ( const vtkDataSetAttributes & ) = delete ; friend class vtkDataSetAttributesFieldList ; } ;
## Error: token expected: ; but got: [identifier]!!!
