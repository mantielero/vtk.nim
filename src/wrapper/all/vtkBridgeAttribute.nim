...
## !!!Ignored construct:  # vtkBridgeAttribute_h [NewLine] # vtkBridgeAttribute_h [NewLine] # vtkBridgeExport.h for module export macro # vtkGenericAttribute.h [NewLine] class vtkPointData ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkCellData"
discard "forward decl of vtkDataSetAttributes"
## !!!Ignored construct:  class VTKTESTINGGENERICBRIDGE_EXPORT vtkBridgeAttribute : public vtkGenericAttribute { public : static vtkBridgeAttribute * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkGenericAttribute Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkGenericAttribute :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkBridgeAttribute :: IsTypeOf ( type ) ; } static vtkBridgeAttribute * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkBridgeAttribute * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkBridgeAttribute * NewInstance ( ) const { return vtkBridgeAttribute :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkGenericAttribute :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkBridgeAttribute :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkBridgeAttribute :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  \pre d_exists: d!=0
##  \pre valid_range: (i>=0) && (i<d->GetNumberOfArrays())
##  void InitWithCellData ( vtkCellData * d , int i ) ; protected : *
...
##  void AllocateInternalTuple ( int size ) ; friend class vtkBridgeCell ;  only one of them is non-null at a time. vtkPointData * Pd ; vtkCellData * Cd ; vtkDataSetAttributes * Data ;  always not-null, equal to either on Pd or Cd int AttributeNumber ; double * InternalTuple ;  used by vtkBridgeCell int InternalTupleCapacity ; double Range [ 2 ] ; private : vtkBridgeAttribute ( const vtkBridgeAttribute & ) = delete ; void operator = ( const vtkBridgeAttribute & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
