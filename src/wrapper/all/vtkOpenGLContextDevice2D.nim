...
## !!!Ignored construct:  # vtkOpenGLContextDevice2D_h [NewLine] # vtkOpenGLContextDevice2D_h [NewLine] # vtkContextDevice2D.h [NewLine] # vtkRenderingContextOpenGL2Module.h  For export macro [NewLine] # < list >  for std::list # < vector >  STL Header [NewLine] class vtkMatrix4x4 ;
...
discard "forward decl of vtkStringToImage"
discard "forward decl of vtkTransform"
discard "forward decl of vtkViewport"
discard "forward decl of vtkWindow"
## !!!Ignored construct:  class VTKRENDERINGCONTEXTOPENGL2_EXPORT vtkOpenGLContextDevice2D : public vtkContextDevice2D { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkContextDevice2D Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkContextDevice2D :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkOpenGLContextDevice2D :: IsTypeOf ( type ) ; } static vtkOpenGLContextDevice2D * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkOpenGLContextDevice2D * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkOpenGLContextDevice2D * NewInstance ( ) const { return vtkOpenGLContextDevice2D :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkContextDevice2D :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkOpenGLContextDevice2D :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkOpenGLContextDevice2D :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual void SetMaximumMarkerCacheSize ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  MaximumMarkerCacheSize  to  << _arg ) ; if ( this -> MaximumMarkerCacheSize != _arg ) { this -> MaximumMarkerCacheSize = _arg ; this -> Modified ( ) ; } } ; virtual int GetMaximumMarkerCacheSize ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << MaximumMarkerCacheSize  of  << this -> MaximumMarkerCacheSize ) ; return this -> MaximumMarkerCacheSize ; } ; /@} *
##  Draws a rectangle
##  void DrawQuad ( float * points , int n ) override ; *
##  Draws a rectangle
##  void DrawQuadStrip ( float * points , int n ) override ; *
##  Draw a polygon using the specified number of points.
##  void DrawPolygon ( float * , int ) override ; void DrawColoredPolygon ( float * points , int numPoints , unsigned char * colors = nullptr , int nc_comps = 0 ) override ; *
...
##  virtual vtkOpenGLRenderWindow * GetnameRenderWindow ( ) { vtkDebugWithObjectMacro ( this , <<  returning  RenderWindow  address  << static_cast < vtkOpenGLRenderWindow * > ( this -> RenderWindow ) ) ; return this -> RenderWindow ; } ; /@} *
...
##  vtkMatrix4x4 * GetProjectionMatrix ( ) ; vtkMatrix4x4 * GetModelMatrix ( ) ; /@} protected : vtkOpenGLContextDevice2D ( ) ; ~ vtkOpenGLContextDevice2D ( ) override ; *
...
##  class Private ; Private * Storage ; class CellArrayHelper ; CellArrayHelper * PolyDataImpl ; /@} *
##  The OpenGL render window being used by the device
##  vtkOpenGLRenderWindow * RenderWindow ; vtkOpenGLHelper * LinesCBO ;  vertex + color void ReadyLinesCBOProgram ( ) ; vtkOpenGLHelper * LinesBO ;  vertex void ReadyLinesBOProgram ( ) ; vtkOpenGLHelper * VCBO ;  vertex + color void ReadyVCBOProgram ( ) ; vtkOpenGLHelper * VBO ;  vertex void ReadyVBOProgram ( ) ; vtkOpenGLHelper * VTBO ;  vertex + tcoord void ReadyVTBOProgram ( ) ; vtkOpenGLHelper * SCBO ;  sprite + color void ReadySCBOProgram ( ) ; vtkOpenGLHelper * SBO ;  sprite void ReadySBOProgram ( ) ; void SetMatrices ( vtkShaderProgram * prog ) ; void BuildVBO ( vtkOpenGLHelper * cbo , float * v , int nv , unsigned char * coolors , int nc , float * tcoords ) ; void CoreDrawTriangles ( std :: vector < float > & tverts , unsigned char * colors = nullptr , int numComp = 0 ) ;  used for stipples unsigned short LinePattern ; /@{ *
##  Draw the markers as paths/polydata instead of sprites for detailed GL2PS
##  capture.
##  void DrawMarkersGL2PS ( int shape , bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; void DrawCrossMarkersGL2PS ( bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; void DrawPlusMarkersGL2PS ( bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; void DrawSquareMarkersGL2PS ( bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; void DrawCircleMarkersGL2PS ( bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; void DrawDiamondMarkersGL2PS ( bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; /@} /@{ *
##  Embed an RGBA image in the GL2PS output at the supplied point.
##  void DrawImageGL2PS ( float p [ 2 ] , vtkImageData * image ) ; void DrawImageGL2PS ( float p [ 2 ] , float scale , vtkImageData * image ) ; void DrawImageGL2PS ( const vtkRectf & rect , vtkImageData * image ) ; /@} /@{ *
##  Inject smooth primitives into the GL2PS stream.
##  void DrawCircleGL2PS ( float x , float y , float rX , float rY ) ; void DrawWedgeGL2PS ( float x , float y , float outRx , float outRy , float inRx , float inRy ) ; /@} *
...
##  void TransformSize ( float & dx , float & dy ) const ; private : vtkOpenGLContextDevice2D ( const vtkOpenGLContextDevice2D & ) = delete ; void operator = ( const vtkOpenGLContextDevice2D & ) = delete ; *
...
##  vtkImageData * GetMarker ( int shape , int size , bool highlight ) ; class vtkMarkerCacheObject { public : vtkTypeUInt64 Key ; vtkImageData * Value ; bool operator == ( vtkTypeUInt64 key ) { return this -> Key == key ; } } ; void ComputeStringBoundsInternal ( const std :: string & string , float bounds [ 4 ] ) ; vtkTransform * ProjectionMatrix ; vtkTransform * ModelMatrix ; std :: list < vtkMarkerCacheObject > MarkerCache ; int MaximumMarkerCacheSize ; *
