...
## !!!Ignored construct:  # vtkWrap_h [NewLine] # vtkWrap_h [NewLine] # vtkParse.h [NewLine] # vtkParseHierarchy.h [NewLine] # vtkWrappingToolsModule.h [NewLine] *
##  For use with vtkWrap_DeclareVariable.
##  @{ # VTK_WRAP_RETURN 1 [NewLine] # VTK_WRAP_ARG 2 [NewLine] # VTK_WRAP_NOSEMI 4 [NewLine] @} # __cplusplus [NewLine] extern C { # [NewLine] *
##  Check for common types.
##  IsPODPointer is for unsized arrays of POD types.
##  IsZeroCopyPointer is for buffers that shouldn't be copied.
##  @{ VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsVoid ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsVoidFunction ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsVoidPointer ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsCharPointer ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsPODPointer ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsZeroCopyPointer ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsStdVector ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsVTKObject ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsVTKSmartPointer ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsSpecialObject ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsPythonObject ( ValueInfo * val ) ; @} *
...
##  @{ VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsObject ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsFunction ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsStream ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsNumeric ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsString ( ValueInfo * val ) ; @} *
##  Subcategories of numeric types.  In this categorization,
##  bool and char are not considered to be integers.
##  @{ VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsBool ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsChar ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsInteger ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsRealNumber ( ValueInfo * val ) ; @} *
...
##  @{ VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsScalar ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsPointer ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsArray ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsNArray ( ValueInfo * val ) ; @} *
##  Properties that can combine with other properties.
##  @{ VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsNonConstRef ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsConstRef ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsRef ( ValueInfo * val ) ; VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsConst ( ValueInfo * val ) ; @} *
##  Hints.
...
##  VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsVTKObjectBaseType ( HierarchyInfo * hinfo , const char * classname ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT int vtkWrap_IsTypeOf ( HierarchyInfo * hinfo , const char * classname , const char * superclass ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_ExpandTypedefs ( ClassInfo * data , FileInfo * finfo , HierarchyInfo * hinfo ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_ApplyUsingDeclarations ( ClassInfo * data , FileInfo * finfo , HierarchyInfo * hinfo ) ; *
##  Merge members of all superclasses into the data structure.
##  The superclass header files will be read and parsed.
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_MergeSuperClasses ( ClassInfo * data , FileInfo * finfo , HierarchyInfo * hinfo ) ; *
##  Apply any hints about array sizes, e.g. hint that the
##  GetNumberOfComponents() method gives the tuple size.
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_FindCountHints ( ClassInfo * data , FileInfo * finfo , HierarchyInfo * hinfo ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_FindNewInstanceMethods ( ClassInfo * data , HierarchyInfo * hinfo ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_DeclareVariable ( FILE * fp , ClassInfo * data , ValueInfo * v , const char * name , int idx , int flags ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_DeclareVariableSize ( FILE * fp , ValueInfo * v , const char * name , int idx ) ; *
##  Qualify all the unqualified identifiers in the given expression
##  and print the result to the file.
##  VTKWRAPPINGTOOLS_EXPORT void vtkWrap_QualifyExpression ( FILE * fp , ClassInfo * data , const char * text ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT char * vtkWrap_TemplateArg ( const char * name ) ; # __cplusplus [NewLine] } # [NewLine] # [NewLine]  VTK-HeaderTest-Exclude: vtkWrap.h
