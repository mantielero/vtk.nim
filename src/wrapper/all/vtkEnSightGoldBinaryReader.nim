...
## !!!Ignored construct:  # vtkEnSightGoldBinaryReader_h [NewLine] # vtkEnSightGoldBinaryReader_h [NewLine] # vtkEnSightReader.h [NewLine] # vtkIOEnSightModule.h  For export macro [NewLine] class vtkMultiBlockDataSet ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKIOENSIGHT_EXPORT vtkEnSightGoldBinaryReader : public vtkEnSightReader { public : static vtkEnSightGoldBinaryReader * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkEnSightReader Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkEnSightReader :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkEnSightGoldBinaryReader :: IsTypeOf ( type ) ; } static vtkEnSightGoldBinaryReader * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkEnSightGoldBinaryReader * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkEnSightGoldBinaryReader * NewInstance ( ) const { return vtkEnSightGoldBinaryReader :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkEnSightReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkEnSightGoldBinaryReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkEnSightGoldBinaryReader :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; protected : vtkEnSightGoldBinaryReader ( ) ; ~ vtkEnSightGoldBinaryReader ( ) override ;  Returns 1 if successful.  Sets file size as a side action. int OpenFile ( const char * filename ) ;  Returns 1 if successful.  Handles constructing the filename, opening the file and checking
##  if it's binary int InitializeFile ( const char * filename ) ; *
...
##  Returns zero if there was an error.
##  int ReadInt ( int * result ) ; int ReadPartId ( int * result ) ; /@} *
...
##  int SkipTimeStep ( ) ; int SkipStructuredGrid ( char line [ 256 ] ) ; int SkipUnstructuredGrid ( char line [ 256 ] ) ; int SkipRectilinearGrid ( char line [ 256 ] ) ; int SkipImageData ( char line [ 256 ] ) ; /@} *
...
##  void AddFileIndexToCache ( const char * fileName ) ; int NodeIdsListed ; int ElementIdsListed ; int Fortran ; int FortranSkipBytes ;  Number of bytes to skip when seeking within a fortran-written file istream * GoldIFile ;  The size of the file could be used to choose byte order. vtkTypeUInt64 FileSize ; class FileOffsetMapInternal ; FileOffsetMapInternal * FileOffsets ; private : int SizeOfInt ; vtkEnSightGoldBinaryReader ( const vtkEnSightGoldBinaryReader & ) = delete ; void operator = ( const vtkEnSightGoldBinaryReader & ) = delete ; *
...
##  applicable.
##  bool SkipToTimeStep ( const char * fileName , int timeStep , vtkMultiBlockDataSet * compositeOutput , int attributeType , int numComponents , bool measured ) ; *
##  Reads measured data from a variable file.
##  bool ReadMeasureVariableArray ( const char * description , vtkMultiBlockDataSet * compositeOutput , int numComponents ) ; bool ReadVariableArray ( const char * description , vtkMultiBlockDataSet * compositeOutput , int attributeType , int numComponents , int component = - 1 ) ; class vtkUtilities ; friend class vtkUtilities ; } ;
## Error: token expected: ; but got: [identifier]!!!
