...
## !!!Ignored construct:  # vtkContext2D_h [NewLine] # vtkContext2D_h [NewLine] # vtkObject.h [NewLine] # vtkRenderingContext2DModule.h  For export macro [NewLine] class vtkWindow ;
...
discard "forward decl of vtkVector2f"
discard "forward decl of vtkRectf"
...
## !!!Ignored construct:  class VTKRENDERINGCONTEXT2D_EXPORT vtkContext2D : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkContext2D :: IsTypeOf ( type ) ; } static vtkContext2D * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkContext2D * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkContext2D * NewInstance ( ) const { return vtkContext2D :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkContext2D :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkContext2D :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  bool Begin ( vtkContextDevice2D * device ) ; virtual vtkContextDevice2D * GetnameDevice ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Device  address  << static_cast < vtkContextDevice2D * > ( this -> Device ) ) ; return this -> Device ; } ; *
...
##  void DrawPointSprites ( vtkImageData * sprite , vtkPoints2D * points , vtkUnsignedCharArray * colors ) ; void DrawPointSprites ( vtkImageData * sprite , float * points , int n , unsigned char * colors , int nc_comps ) ; /@} *
##  Draw a series of point sprites, images centred at the points supplied.
##  The supplied vtkImageData is the sprite to be drawn, only squares will be
##  drawn and the size is set using SetPointSize.
...
##  virtual void DrawMarkers ( int shape , bool highlight , float * points , int n , unsigned char * colors , int nc_comps ) ; virtual void DrawMarkers ( int shape , bool highlight , float * points , int n ) ; virtual void DrawMarkers ( int shape , bool highlight , vtkPoints2D * points ) ; virtual void DrawMarkers ( int shape , bool highlight , vtkPoints2D * points , vtkUnsignedCharArray * colors ) ; /@} *
...
##  void DrawQuad ( float x1 , float y1 , float x2 , float y2 , float x3 , float y3 , float x4 , float y4 ) ; void DrawQuad ( float * p ) ; /@} /@{ *
##  Draw a strip of quads
##  void DrawQuadStrip ( vtkPoints2D * points ) ; void DrawQuadStrip ( float * p , int n ) ; /@} *
...
##  void DrawStringRect ( vtkPoints2D * rect , const vtkStdString & string ) ; void DrawStringRect ( vtkPoints2D * rect , const char * string ) ; void DrawStringRect ( const float rect [ 4 ] , const vtkStdString & string ) ; void DrawStringRect ( const float rect [ 4 ] , const char * string ) ; /@} /@{ *
##  Draw some text to the screen.
##  void DrawString ( vtkPoints2D * point , const vtkStdString & string ) ; void DrawString ( float x , float y , const vtkStdString & string ) ; void DrawString ( vtkPoints2D * point , const char * string ) ; void DrawString ( float x , float y , const char * string ) ; /@} /@{ *
...
##  void ComputeStringBounds ( const vtkStdString & string , vtkPoints2D * bounds ) ; void ComputeStringBounds ( const vtkStdString & string , float bounds [ 4 ] ) ; void ComputeStringBounds ( const char * string , vtkPoints2D * bounds ) ; void ComputeStringBounds ( const char * string , float bounds [ 4 ] ) ; /@} *
...
##  void DrawMathTextString ( vtkPoints2D * point , const vtkStdString & string ) ; void DrawMathTextString ( float x , float y , const vtkStdString & string ) ; void DrawMathTextString ( vtkPoints2D * point , const char * string ) ; void DrawMathTextString ( float x , float y , const char * string ) ; /@} /@{ *
##  Draw a MathText formatted equation to the screen. See
##  http://matplotlib.sourceforge.net/users/mathtext.html for more information.
##  MathText requires matplotlib and python, and the vtkMatplotlib module must
...
##  void DrawMathTextString ( vtkPoints2D * point , const vtkStdString & string , const vtkStdString & fallback ) ; void DrawMathTextString ( float x , float y , const vtkStdString & string , const vtkStdString & fallback ) ; void DrawMathTextString ( vtkPoints2D * point , const char * string , const char * fallback ) ; void DrawMathTextString ( float x , float y , const char * string , const char * fallback ) ; /@} *
...
##  virtual vtkContext3D * GetnameDeviceContext3D ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Context3D  address  << static_cast < vtkContext3D * > ( this -> Context3D ) ) ; return this -> Context3D ; } ; virtual void SetContext3D ( vtkContext3D * context ) ; /@} protected : vtkContext2D ( ) ; ~ vtkContext2D ( ) override ; vtkContextDevice2D * Device ;  The underlying device vtkTransform2D * Transform ;  Current transform vtkAbstractContextBufferId * BufferId ; vtkContext3D * Context3D ;  May be very temporary - get at a 3D version. private : vtkContext2D ( const vtkContext2D & ) = delete ; void operator = ( const vtkContext2D & ) = delete ; *
...
proc FloatToInt*(x: cfloat): cint {.importcpp: "VTKRENDERINGCONTEXT2D_EXPORT::FloatToInt(@)",
                                header: "vtkContext2D.h".}