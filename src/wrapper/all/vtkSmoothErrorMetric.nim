...
## !!!Ignored construct:  # vtkSmoothErrorMetric_h [NewLine] # vtkSmoothErrorMetric_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkGenericSubdivisionErrorMetric.h [NewLine] class vtkGenericDataSet ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkSmoothErrorMetric : public vtkGenericSubdivisionErrorMetric { public : *
##  Construct the error metric with a default flatness threshold of 90.1
##  degrees.
##  static vtkSmoothErrorMetric * New ( ) ; /@{ *
##  Standard VTK type and error macros.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkGenericSubdivisionErrorMetric Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkGenericSubdivisionErrorMetric :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkSmoothErrorMetric :: IsTypeOf ( type ) ; } static vtkSmoothErrorMetric * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkSmoothErrorMetric * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkSmoothErrorMetric * NewInstance ( ) const { return vtkSmoothErrorMetric :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkGenericSubdivisionErrorMetric :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkSmoothErrorMetric :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkSmoothErrorMetric :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  double GetError ( double * leftPoint , double * midPoint , double * rightPoint , double alpha ) override ; protected : vtkSmoothErrorMetric ( ) ; ~ vtkSmoothErrorMetric ( ) override ; double AngleTolerance ; double CosTolerance ; private : vtkSmoothErrorMetric ( const vtkSmoothErrorMetric & ) = delete ; void operator = ( const vtkSmoothErrorMetric & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
