...
## !!!Ignored construct:  # vtkHexagonalPrism_h [NewLine] # vtkHexagonalPrism_h [NewLine] # vtkCell3D.h [NewLine] # vtkCommonDataModelModule.h  For export macro [NewLine] class vtkLine ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPolygon"
discard "forward decl of vtkQuad"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkHexagonalPrism : public vtkCell3D { public : static vtkHexagonalPrism * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkCell3D Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkCell3D :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkHexagonalPrism :: IsTypeOf ( type ) ; } static vtkHexagonalPrism * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkHexagonalPrism * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkHexagonalPrism * NewInstance ( ) const { return vtkHexagonalPrism :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkCell3D :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkHexagonalPrism :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkHexagonalPrism :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  void JacobianInverse ( const double pcoords [ 3 ] , double * * inverse , double derivs [ 36 ] ) ; protected : vtkHexagonalPrism ( ) ; ~ vtkHexagonalPrism ( ) override ; vtkLine * Line ; vtkQuad * Quad ; vtkPolygon * Polygon ; private : vtkHexagonalPrism ( const vtkHexagonalPrism & ) = delete ; void operator = ( const vtkHexagonalPrism & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
