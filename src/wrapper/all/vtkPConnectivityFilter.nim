...
## !!!Ignored construct:  # vtkPConnectivityFilter_h [NewLine] # vtkPConnectivityFilter_h [NewLine] # vtkConnectivityFilter.h [NewLine] # vtkFiltersParallelGeometryModule.h  For export macro [NewLine] class VTKFILTERSPARALLELGEOMETRY_EXPORT vtkPConnectivityFilter : public vtkConnectivityFilter { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkConnectivityFilter Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkConnectivityFilter :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPConnectivityFilter :: IsTypeOf ( type ) ; } static vtkPConnectivityFilter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPConnectivityFilter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPConnectivityFilter * NewInstance ( ) const { return vtkPConnectivityFilter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkConnectivityFilter :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPConnectivityFilter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPConnectivityFilter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkPConnectivityFilter * New ( ) ; protected : vtkPConnectivityFilter ( ) ; ~ vtkPConnectivityFilter ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; private : vtkPConnectivityFilter ( const vtkPConnectivityFilter & ) = delete ; void operator = ( const vtkPConnectivityFilter & ) = delete ; } ;
