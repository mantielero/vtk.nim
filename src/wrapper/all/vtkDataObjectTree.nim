...
## !!!Ignored construct:  # vtkDataObjectTree_h [NewLine] # vtkDataObjectTree_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkCompositeDataSet.h [NewLine] class vtkCompositeDataIterator ;
...
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkDataObjectTree : public vtkCompositeDataSet { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkCompositeDataSet Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkCompositeDataSet :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDataObjectTree :: IsTypeOf ( type ) ; } static vtkDataObjectTree * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDataObjectTree * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDataObjectTree * NewInstance ( ) const { return vtkDataObjectTree :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkCompositeDataSet :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDataObjectTree :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDataObjectTree :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void SetDataSetFrom ( vtkDataObjectTreeIterator * iter , vtkDataObject * dataObj ) ;  Needed because, otherwise vtkCompositeData::GetDataSet(unsigned int flatIndex) is hidden. using Superclass :: GetDataSet ; *
...
##  void ShallowCopy ( vtkDataObject * src ) override ; void DeepCopy ( vtkDataObject * src ) override ; void RecursiveShallowCopy ( vtkDataObject * src ) override ; /@} *
...
##  static vtkDataObjectTree * GetData ( vtkInformation * info ) ; static vtkDataObjectTree * GetData ( vtkInformationVector * v , int i = 0 ) ; /@} *
##  Overridden to return `VTK_DATA_OBJECT_TREE`.
##  int GetDataObjectType ( ) override { return VTK_DATA_OBJECT_TREE ; } protected : vtkDataObjectTree ( ) ; ~ vtkDataObjectTree ( ) override ; *
...
##  virtual vtkDataObjectTree * CreateForCopyStructure ( vtkDataObjectTree * other ) ;  The internal datastructure. Subclasses need not access this directly. vtkDataObjectTreeInternals * Internals ; friend class vtkDataObjectTreeIterator ; private : vtkDataObjectTree ( const vtkDataObjectTree & ) = delete ; void operator = ( const vtkDataObjectTree & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
