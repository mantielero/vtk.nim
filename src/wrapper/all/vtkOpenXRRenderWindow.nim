...
## !!!Ignored construct:  # vtkOpenXRRenderWindow_h [NewLine] # vtkOpenXRRenderWindow_h [NewLine] # vtkRenderingOpenXRModule.h  For export macro # vtkVRRenderWindow.h [NewLine] # vtkEventData.h  for method sig # vtkOpenXR.h [NewLine] # < array >  array [NewLine] class vtkMatrix4x4 ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKRENDERINGOPENXR_EXPORT vtkOpenXRRenderWindow : public vtkVRRenderWindow { public : static vtkOpenXRRenderWindow * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkVRRenderWindow Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkVRRenderWindow :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkOpenXRRenderWindow :: IsTypeOf ( type ) ; } static vtkOpenXRRenderWindow * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkOpenXRRenderWindow * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkOpenXRRenderWindow * NewInstance ( ) const { return vtkOpenXRRenderWindow :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkVRRenderWindow :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkOpenXRRenderWindow :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkOpenXRRenderWindow :: New ( ) ; } public : ; *
...
##  void SetModelActiveState ( const int hand , bool state ) { this -> ModelsActiveState [ hand ] = state ; } @} uint32_t GetDeviceHandleForOpenXRHandle ( uint32_t index ) ; vtkEventDataDevice GetDeviceForOpenXRHandle ( uint32_t ohandle ) ; *
...
##  void UpdateHMDMatrixPose ( ) override ; protected : vtkOpenXRRenderWindow ( ) ; ~ vtkOpenXRRenderWindow ( ) override ;  Create one framebuffer per view bool CreateFramebuffers ( uint32_t viewCount = 2 ) override ; bool BindTextureToFramebuffer ( FramebufferDesc & framebufferDesc ) ; void RenderFramebuffer ( FramebufferDesc & framebufferDesc ) ; void RenderOneEye ( const uint32_t eye ) ; void RenderModels ( ) ; vtkNew < vtkMatrix4x4 > TempMatrix4x4 ;  Store if a model is active or not here as openxr do not have a concept
##  of active/inactive controller std :: array < bool , 2 > ModelsActiveState = { true , true } ; private : vtkOpenXRRenderWindow ( const vtkOpenXRRenderWindow & ) = delete ; void operator = ( const vtkOpenXRRenderWindow & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
