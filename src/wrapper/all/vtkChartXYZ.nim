...
## !!!Ignored construct:  # vtkChartXYZ_h [NewLine] # vtkChartXYZ_h [NewLine] # vtkChartsCoreModule.h  For export macro # vtkColor.h  For vtkColor4ub # vtkContextItem.h [NewLine] # vtkNew.h  For ivars # vtkRect.h  For vtkRectf ivars # vtkSmartPointer.h  For ivars # vtkStdString.h  For vtkStdString # vtkTextProperty.h  For axes text properties # < vector >  For ivars [NewLine] class vtkAnnotationLink ;
...
discard "forward decl of vtkPlot3D"
discard "forward decl of vtkTable"
discard "forward decl of vtkTransform"
discard "forward decl of vtkUnsignedCharArray"
## !!!Ignored construct:  class VTKCHARTSCORE_EXPORT vtkChartXYZ : public vtkContextItem { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkContextItem Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkContextItem :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkChartXYZ :: IsTypeOf ( type ) ; } static vtkChartXYZ * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkChartXYZ * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkChartXYZ * NewInstance ( ) const { return vtkChartXYZ :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkContextItem :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkChartXYZ :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkChartXYZ :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkChartXYZ * New ( ) ; *
...
##  virtual void SetAngle ( double _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Angle  to  << _arg ) ; if ( this -> Angle != _arg ) { this -> Angle = _arg ; this -> Modified ( ) ; } } ; *
...
##  void SetAxisColor ( const vtkColor4ub & color ) ; vtkColor4ub GetAxisColor ( ) ; /@} *
...
##  virtual void SetAngleXAxisLabel ( vtkStdString _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  XAxisLabel  to  << _arg ) ; if ( this -> XAxisLabel != _arg ) { this -> XAxisLabel = _arg ; this -> Modified ( ) ; } } ; *
##  Set the Y axis label
##  virtual void SetAngleXAxisLabelYAxisLabel ( vtkStdString _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  YAxisLabel  to  << _arg ) ; if ( this -> YAxisLabel != _arg ) { this -> YAxisLabel = _arg ; this -> Modified ( ) ; } } ; *
##  Set the Z axis label
##  virtual void SetAngleXAxisLabelYAxisLabelZAxisLabel ( vtkStdString _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  ZAxisLabel  to  << _arg ) ; if ( this -> ZAxisLabel != _arg ) { this -> ZAxisLabel = _arg ; this -> Modified ( ) ; } } ; *
...
##  virtual void SetAngleXAxisLabelYAxisLabelZAxisLabelEnsureOuterEdgeAxisLabelling ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  EnsureOuterEdgeAxisLabelling  to  << _arg ) ; if ( this -> EnsureOuterEdgeAxisLabelling != _arg ) { this -> EnsureOuterEdgeAxisLabelling = _arg ; this -> Modified ( ) ; } } ; *
##  Set whether or not we're using this chart to rotate on a timer.
##  Default value is false.
##  virtual void SetAngleXAxisLabelYAxisLabelZAxisLabelEnsureOuterEdgeAxisLabellingAutoRotate ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  AutoRotate  to  << _arg ) ; if ( this -> AutoRotate != _arg ) { this -> AutoRotate = _arg ; this -> Modified ( ) ; } } ; *
...
##  virtual bool GetClippingPlanesEnabled ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ClippingPlanesEnabled  of  << this -> ClippingPlanesEnabled ) ; return this -> ClippingPlanesEnabled ; } ; *
##  When rotating the mousewheel, scale not only the plot but also the box.
##  virtual void SetAngleXAxisLabelYAxisLabelZAxisLabelEnsureOuterEdgeAxisLabellingAutoRotateScaleBoxWithPlot ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  ScaleBoxWithPlot  to  << _arg ) ; if ( this -> ScaleBoxWithPlot != _arg ) { this -> ScaleBoxWithPlot = _arg ; this -> Modified ( ) ; } } ; *
##  Check whether scaling the plot will also scale the box.
##  virtual bool GetClippingPlanesEnabledScaleBoxWithPlot ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ScaleBoxWithPlot  of  << this -> ScaleBoxWithPlot ) ; return this -> ScaleBoxWithPlot ; } ; protected : vtkChartXYZ ( ) ; ~ vtkChartXYZ ( ) override ; *
##  Rotation directions.
...
##  enum { USE_MARGINS_AND_SCENE_SIZE , USE_GEOMETRY } SizeStrategy = USE_GEOMETRY ; *
...
##  int SceneWidth ; /@{ *
##  Which line to label.
##  int XAxisToLabel [ 3 ] ; int YAxisToLabel [ 3 ] ; int ZAxisToLabel [ 3 ] ; /@} *
...
##  When rotating the mousewheel, scale not only the plot but also the box.
##  bool ScaleBoxWithPlot = true ; private : vtkChartXYZ ( const vtkChartXYZ & ) = delete ; void operator = ( const vtkChartXYZ & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
