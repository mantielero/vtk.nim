...
import
  vtkIOLegacyModule, vtkPixelExtent

discard "forward decl of vtkUnstructuredGrid"
type
  vtkPixelExtentIO* {.importcpp: "vtkPixelExtentIO", header: "vtkPixelExtentIO.h",
                     bycopy.} = object ## *
...
proc `<<`*(data: var vtkUnstructuredGrid; ext: vtkPixelExtent): var vtkUnstructuredGrid {.
    importcpp: "(# << #)", header: "vtkPixelExtentIO.h".}
