...
## !!!Ignored construct:  # vtkSelector_h [NewLine] # vtkSelector_h [NewLine] # vtkFiltersExtractionModule.h  For export macro # vtkObject.h [NewLine] # vtkSmartPointer.h  For vtkSmartPointer [NewLine] # < set >  for std::set [NewLine] class vtkCompositeDataSet ;
...
## !!!Ignored construct:  class VTKFILTERSEXTRACTION_EXPORT vtkSelector : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkSelector :: IsTypeOf ( type ) ; } static vtkSelector * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkSelector * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkSelector * NewInstance ( ) const { return vtkSelector :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkSelector :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkSelector :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual void SetInsidednessArrayName ( std :: string _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  InsidednessArrayName  to  << _arg ) ; if ( this -> InsidednessArrayName != _arg ) { this -> InsidednessArrayName = _arg ; this -> Modified ( ) ; } } ; virtual std :: string GetInsidednessArrayName ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << InsidednessArrayName  of  << this -> InsidednessArrayName ) ; return this -> InsidednessArrayName ; } ; /@} protected : vtkSelector ( ) ; ~ vtkSelector ( ) override ;  Contains the selection criteria. vtkSelectionNode * Node = nullptr ;  Name of the insidedness array added to the output when the selection criteria is
##  evaluated by this operator. std :: string InsidednessArrayName ; *
...
##  will fill it with 0.
##  virtual bool ComputeSelectedElements ( vtkDataObject * input , vtkSignedCharArray * insidednessArray ) = 0 ; enum SelectionMode { INCLUDE , EXCLUDE , INHERIT } ; *
...
##  void ExpandToConnectedElements ( vtkDataObject * output ) ; private : vtkSelector ( const vtkSelector & ) = delete ; void operator = ( const vtkSelector & ) = delete ; void ProcessBlock ( vtkDataObject * inputBlock , vtkDataObject * outputBlock , bool forceFalse ) ; void ProcessAMR ( vtkUniformGridAMR * input , vtkCompositeDataSet * output ) ; void ProcessDataObjectTree ( vtkDataObjectTree * input , vtkDataObjectTree * output , SelectionMode inheritedSelectionMode , unsigned int compositeIndex = 0 ) ; void ProcessSelectors ( vtkCompositeDataSet * input ) ; std :: set < unsigned int > SubsetCompositeIds ; } ;
## Error: token expected: ; but got: [identifier]!!!
