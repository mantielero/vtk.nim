...
## !!!Ignored construct:  # vtkBase64Utilities_h [NewLine] # vtkBase64Utilities_h [NewLine] # vtkIOCoreModule.h  For export macro # vtkObject.h [NewLine] class VTKIOCORE_EXPORT vtkBase64Utilities : public vtkObject { public : static vtkBase64Utilities * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkBase64Utilities :: IsTypeOf ( type ) ; } static vtkBase64Utilities * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkBase64Utilities * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkBase64Utilities * NewInstance ( ) const { return vtkBase64Utilities :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkBase64Utilities :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkBase64Utilities :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  static size_t DecodeSafely ( const unsigned char * input , size_t inputLen , unsigned char * output , size_t outputLen ) ; protected : vtkBase64Utilities ( ) = default ; ~ vtkBase64Utilities ( ) override = default ; private : vtkBase64Utilities ( const vtkBase64Utilities & ) = delete ; void operator = ( const vtkBase64Utilities & ) = delete ; } ;
