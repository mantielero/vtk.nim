...
## !!!Ignored construct:  # vtkCellTreeLocator_h [NewLine] # vtkCellTreeLocator_h [NewLine] # vtkAbstractCellLocator.h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 [NewLine] namespace detail {  Forward declarations for PIMPL struct vtkCellTree ; template < typename T > [end of template] struct CellTree ; template < typename T > [end of template] struct CellTreeBuilder ; } class VTKCOMMONDATAMODEL_EXPORT vtkCellTreeLocator : public vtkAbstractCellLocator { template < typename > friend struct detail :: CellTree ; template < typename > friend struct detail :: CellTreeBuilder ; public : /@{ *
##  Standard methods to print and obtain type-related information.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractCellLocator Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractCellLocator :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkCellTreeLocator :: IsTypeOf ( type ) ; } static vtkCellTreeLocator * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkCellTreeLocator * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkCellTreeLocator * NewInstance ( ) const { return vtkCellTreeLocator :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractCellLocator :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkCellTreeLocator :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkCellTreeLocator :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##
##  Default is 6.
##  virtual void SetNumberOfBuckets ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  NumberOfBuckets  to  << _arg ) ; if ( this -> NumberOfBuckets != _arg ) { this -> NumberOfBuckets = _arg ; this -> Modified ( ) ; } } ; virtual int GetNumberOfBuckets ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << NumberOfBuckets  of  << this -> NumberOfBuckets ) ; return this -> NumberOfBuckets ; } ; /@} *
...
##  bool GetLargeIds ( ) { return this -> LargeIds ; }  Re-use any superclass signatures that we don't override. using vtkAbstractCellLocator :: FindCell ; using vtkAbstractCellLocator :: IntersectWithLine ; *
...
##  void FreeSearchStructure ( ) override ; void BuildLocator ( ) override ; void ForceBuildLocator ( ) override ; void GenerateRepresentation ( int level , vtkPolyData * pd ) override ; /@} VTK_DEPRECATED_IN_9_2_0 ( This method is deprecated because LazyEvaluation has been deprecated ) virtual void BuildLocatorIfNeeded ( ) { } *
##  Shallow copy of a vtkCellTreeLocator.
##  void ShallowCopy ( vtkAbstractCellLocator * locator ) override ; protected : vtkCellTreeLocator ( ) ; ~ vtkCellTreeLocator ( ) override ; void BuildLocatorInternal ( ) override ; int NumberOfBuckets ; bool LargeIds = false ; detail :: vtkCellTree * Tree ; private : vtkCellTreeLocator ( const vtkCellTreeLocator & ) = delete ; void operator = ( const vtkCellTreeLocator & ) = delete ; } ;
