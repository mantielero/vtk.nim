...
## !!!Ignored construct:  # vtkOStrStreamWrapper_h [NewLine] # vtkOStrStreamWrapper_h [NewLine] # vtkCommonCoreModule.h [NewLine] # VTK_SYSTEM_INCLUDES_INSIDE [NewLine] Do_not_include_vtkOStrStreamWrapper_directly_vtkSystemIncludes_includes_it ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKCOMMONCORE_EXPORT vtkOStrStreamWrapper : public vtkOStreamWrapper { public : *
##  Constructor.
...
##  void freeze ( ) ; void freeze ( int ) ; /@} protected :  The pointer returned by str(). char * Result ;  Whether the caller of str() owns the memory. int Frozen ; private : vtkOStrStreamWrapper ( const vtkOStrStreamWrapper & r ) = delete ; vtkOStrStreamWrapper & operator = ( const vtkOStrStreamWrapper & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
