...
## !!!Ignored construct:  # vtkArrayWeights_h [NewLine] # vtkArrayWeights_h [NewLine] # vtkCommonCoreModule.h  For export macro # vtkSystemIncludes.h [NewLine] class vtkArrayWeightsStorage ;
## Error: token expected: ; but got: [identifier]!!!

##  pimpl

## !!!Ignored construct:  class VTKCOMMONCORE_EXPORT vtkArrayWeights { public : *
...
##  Assignment operator.
##  vtkArrayWeights & operator = ( const vtkArrayWeights & other ) ; protected : vtkArrayWeightsStorage * Storage ; } ;
## Error: token expected: ; but got: [identifier]!!!
