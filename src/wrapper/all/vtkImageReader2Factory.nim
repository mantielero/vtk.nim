...
## !!!Ignored construct:  # vtkImageReader2Factory_h [NewLine] # vtkImageReader2Factory_h [NewLine] # vtkIOImageModule.h  For export macro # vtkObject.h [NewLine] class vtkImageReader2 ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkImageReader2Collection"
discard "forward decl of vtkImageReader2FactoryCleanup"
## !!!Ignored construct:  class VTKIOIMAGE_EXPORT vtkImageReader2Factory : public vtkObject { public : static vtkImageReader2Factory * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkImageReader2Factory :: IsTypeOf ( type ) ; } static vtkImageReader2Factory * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkImageReader2Factory * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkImageReader2Factory * NewInstance ( ) const { return vtkImageReader2Factory :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkImageReader2Factory :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkImageReader2Factory :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  is returned.
##  VTK_NEWINSTANCE static vtkImageReader2 * CreateImageReader2 ( const char * path ) ; *
...
##  VTK_NEWINSTANCE static vtkImageReader2 * CreateImageReader2FromExtension ( const char * extension ) ; *
...
##  static bool CheckExtensionIsInExtensions ( const char * extension , const char * extensions ) ; protected : vtkImageReader2Factory ( ) = default ; ~ vtkImageReader2Factory ( ) override = default ; static void InitializeReaders ( ) ; private : static vtkImageReader2Collection * AvailableReaders ; vtkImageReader2Factory ( const vtkImageReader2Factory & ) = delete ; void operator = ( const vtkImageReader2Factory & ) = delete ; friend class vtkImageReader2FactoryCleanup ; } ;
## Error: token expected: ; but got: [identifier]!!!
