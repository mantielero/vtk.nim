...
## !!!Ignored construct:  # vtkStaticPointLocator2D_h [NewLine] # vtkStaticPointLocator2D_h [NewLine] # vtkAbstractPointLocator.h [NewLine] # vtkCommonDataModelModule.h  For export macro [NewLine] class vtkIdList ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkBucketList2D"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkStaticPointLocator2D : public vtkAbstractPointLocator { public : *
##  Construct with automatic computation of divisions, averaging
##  5 points per bucket.
##  static vtkStaticPointLocator2D * New ( ) ; /@{ *
##  Standard type and print methods.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractPointLocator Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractPointLocator :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkStaticPointLocator2D :: IsTypeOf ( type ) ; } static vtkStaticPointLocator2D * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkStaticPointLocator2D * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkStaticPointLocator2D * NewInstance ( ) const { return vtkStaticPointLocator2D :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractPointLocator :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkStaticPointLocator2D :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkStaticPointLocator2D :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} /@{ *
...
##  virtual void SetNumberOfPointsPerBucket ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << NumberOfPointsPerBucket  to  << _arg ) ; if ( this -> NumberOfPointsPerBucket != ( _arg < 1 ? 1 : ( _arg > VTK_INT_MAX ? VTK_INT_MAX : _arg ) ) ) { this -> NumberOfPointsPerBucket = ( _arg < 1 ? 1 : ( _arg > VTK_INT_MAX ? VTK_INT_MAX : _arg ) ) ; this -> Modified ( ) ; } } virtual int GetNumberOfPointsPerBucketMinValue ( ) { return 1 ; } virtual int GetNumberOfPointsPerBucketMaxValue ( ) { return VTK_INT_MAX ; } ; virtual int GetNumberOfPointsPerBucket ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << NumberOfPointsPerBucket  of  << this -> NumberOfPointsPerBucket ) ; return this -> NumberOfPointsPerBucket ; } ; /@} /@{ *
...
##  virtual void SetDivisions ( int _arg1 , int _arg2 ) { vtkDebugWithObjectMacro ( this , <<  setting  << Divisions  to ( << _arg1 << , << _arg2 << ) ) ; if ( ( this -> Divisions [ 0 ] != _arg1 ) || ( this -> Divisions [ 1 ] != _arg2 ) ) { this -> Divisions [ 0 ] = _arg1 ; this -> Divisions [ 1 ] = _arg2 ; this -> Modified ( ) ; } } void SetDivisions ( const int _arg [ 2 ] ) { this -> SetDivisions ( _arg [ 0 ] , _arg [ 1 ] ) ; } ; virtual int * GetDivisions ( ) VTK_SIZEHINT ( 2 ) { vtkDebugWithObjectMacro ( this , <<  returning  << Divisions  pointer  << this -> Divisions ) ; return this -> Divisions ; } VTK_WRAPEXCLUDE virtual void GetDivisions ( int data [ 2 ] ) { for ( int i = 0 ; i < 2 ; i ++ ) { data [ i ] = this -> Divisions [ i ] ; } } ; /@}  Re-use any superclass signatures that we don't override. using vtkAbstractPointLocator :: FindClosestNPoints ; using vtkAbstractPointLocator :: FindClosestPoint ; using vtkAbstractPointLocator :: FindPointsWithinRadius ; using vtkAbstractPointLocator :: GetBounds ; *
...
##  vtkIdType FindClosestPointWithinRadius ( double radius , const double x [ 3 ] , double & dist2 ) override ; virtual vtkIdType FindClosestPointWithinRadius ( double radius , const double x [ 3 ] , double inputDataLength , double & dist2 ) ; /@} *
...
##  void Initialize ( ) override ; void FreeSearchStructure ( ) override ; void BuildLocator ( ) override ; void ForceBuildLocator ( ) override ; /@} *
...
##  virtual void SetNumberOfPointsPerBucketMaxNumberOfBuckets ( vtkIdType _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << MaxNumberOfBuckets  to  << _arg ) ; if ( this -> MaxNumberOfBuckets != ( _arg < 1000 ? 1000 : ( _arg > VTK_ID_MAX ? VTK_ID_MAX : _arg ) ) ) { this -> MaxNumberOfBuckets = ( _arg < 1000 ? 1000 : ( _arg > VTK_ID_MAX ? VTK_ID_MAX : _arg ) ) ; this -> Modified ( ) ; } } virtual vtkIdType GetNumberOfPointsPerBucketMinValueMaxNumberOfBucketsMinValue ( ) { return 1000 ; } virtual vtkIdType GetNumberOfPointsPerBucketMaxValueMaxNumberOfBucketsMaxValue ( ) { return VTK_ID_MAX ; } ; virtual vtkIdType GetNumberOfPointsPerBucketMaxNumberOfBuckets ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << MaxNumberOfBuckets  of  << this -> MaxNumberOfBuckets ) ; return this -> MaxNumberOfBuckets ; } ; /@} *
...
##  void GetBounds ( double * bounds ) override { bounds [ 0 ] = this -> Bounds [ 0 ] ; bounds [ 1 ] = this -> Bounds [ 1 ] ; bounds [ 2 ] = this -> Bounds [ 2 ] ; bounds [ 3 ] = this -> Bounds [ 3 ] ; } /@} /@{ *
##  Provide an accessor to the bucket spacing. Valid after the locator is
##  built.
##  virtual double * GetSpacing ( ) { return this -> H ; } virtual void GetSpacing ( double spacing [ 3 ] ) { spacing [ 0 ] = this -> H [ 0 ] ; spacing [ 1 ] = this -> H [ 1 ] ; spacing [ 2 ] = 0.0 ; } /@} /@{ *
...
##  void GetBucketIndices ( const double * x , int ij [ 2 ] ) const ; vtkIdType GetBucketIndex ( const double * x ) const ; /@} *
...
##  void GenerateRepresentation ( int level , vtkPolyData * pd ) override ; protected : vtkStaticPointLocator2D ( ) ; ~ vtkStaticPointLocator2D ( ) override ; void BuildLocatorInternal ( ) override ; int NumberOfPointsPerBucket ;  Used with AutomaticOn to control subdivide int Divisions [ 2 ] ;  Number of sub-divisions in x-y directions double H [ 2 ] ;  Width of each bucket in x-y directions vtkBucketList2D * Buckets ;  Lists of point ids in each bucket vtkIdType MaxNumberOfBuckets ;  Maximum number of buckets in locator bool LargeIds ;  indicate whether integer ids are small or large private : vtkStaticPointLocator2D ( const vtkStaticPointLocator2D & ) = delete ; void operator = ( const vtkStaticPointLocator2D & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
