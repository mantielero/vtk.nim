...
## !!!Ignored construct:  # vtkClosedSurfacePointPlacer_h [NewLine] # vtkClosedSurfacePointPlacer_h [NewLine] # vtkInteractionWidgetsModule.h  For export macro # vtkPointPlacer.h [NewLine] class vtkPlane ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPlaneCollection"
discard "forward decl of vtkPlanes"
discard "forward decl of vtkRenderer"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkClosedSurfacePointPlacer : public vtkPointPlacer { public : *
##  Instantiate this class.
##  static vtkClosedSurfacePointPlacer * New ( ) ; /@{ *
##  Standard methods for instances of this class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPointPlacer Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPointPlacer :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkClosedSurfacePointPlacer :: IsTypeOf ( type ) ; } static vtkClosedSurfacePointPlacer * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkClosedSurfacePointPlacer * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkClosedSurfacePointPlacer * NewInstance ( ) const { return vtkClosedSurfacePointPlacer :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPointPlacer :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkClosedSurfacePointPlacer :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkClosedSurfacePointPlacer :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} /@{ *
...
##  void AddBoundingPlane ( vtkPlane * plane ) ; void RemoveBoundingPlane ( vtkPlane * plane ) ; void RemoveAllBoundingPlanes ( ) ; virtual void SetBoundingPlanes ( vtkPlaneCollection * ) ; virtual vtkPlaneCollection * GetnameBoundingPlanes ( ) { vtkDebugWithObjectMacro ( this , <<  returning  BoundingPlanes  address  << static_cast < vtkPlaneCollection * > ( this -> BoundingPlanes ) ) ; return this -> BoundingPlanes ; } ; void SetBoundingPlanes ( vtkPlanes * planes ) ; /@} *
...
##  int ValidateWorldPosition ( double worldPos [ 3 ] ) override ;  Descrption:
##  Orientationation is ignored, and the above method
##  is called instead. int ValidateWorldPosition ( double worldPos [ 3 ] , double worldOrient [ 9 ] ) override ;  Descrption:
##  The minimum distance the object should be from the faces of the object.
##  Must be greater than 0. Default is 0. virtual void SetMinimumDistance ( double _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << MinimumDistance  to  << _arg ) ; if ( this -> MinimumDistance != ( _arg < 0.0 ? 0.0 : ( _arg > VTK_DOUBLE_MAX ? VTK_DOUBLE_MAX : _arg ) ) ) { this -> MinimumDistance = ( _arg < 0.0 ? 0.0 : ( _arg > VTK_DOUBLE_MAX ? VTK_DOUBLE_MAX : _arg ) ) ; this -> Modified ( ) ; } } virtual double GetMinimumDistanceMinValue ( ) { return 0.0 ; } virtual double GetMinimumDistanceMaxValue ( ) { return VTK_DOUBLE_MAX ; } ; virtual double GetMinimumDistance ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << MinimumDistance  of  << this -> MinimumDistance ) ; return this -> MinimumDistance ; } ; protected : vtkClosedSurfacePointPlacer ( ) ; ~ vtkClosedSurfacePointPlacer ( ) override ;  A collection of planes used to bound the projection
##  plane vtkPlaneCollection * BoundingPlanes ;  Calculate the distance of a point from the Object. Negative
##  values imply that the point is outside. Positive values imply that it is
##  inside. The closest point to the object is returned in closestPt. static double GetDistanceFromObject ( double pos [ 3 ] , vtkPlaneCollection * pc , double closestPt [ 3 ] ) ; void BuildPlanes ( ) ; double MinimumDistance ; vtkPlaneCollection * InnerBoundingPlanes ; private : vtkClosedSurfacePointPlacer ( const vtkClosedSurfacePointPlacer & ) = delete ; void operator = ( const vtkClosedSurfacePointPlacer & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
