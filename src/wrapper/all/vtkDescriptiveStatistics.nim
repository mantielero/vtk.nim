...
## !!!Ignored construct:  # vtkDescriptiveStatistics_h [NewLine] # vtkDescriptiveStatistics_h [NewLine] # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 # vtkFiltersStatisticsModule.h  For export macro # vtkStatisticsAlgorithm.h [NewLine] class vtkMultiBlockDataSet ;
...
## !!!Ignored construct:  class VTKFILTERSSTATISTICS_EXPORT vtkDescriptiveStatistics : public vtkStatisticsAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkStatisticsAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkStatisticsAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDescriptiveStatistics :: IsTypeOf ( type ) ; } static vtkDescriptiveStatistics * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDescriptiveStatistics * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDescriptiveStatistics * NewInstance ( ) const { return vtkDescriptiveStatistics :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkStatisticsAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDescriptiveStatistics :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDescriptiveStatistics :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkDescriptiveStatistics * New ( ) ; /@{ *
...
##  VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void SetUnbiasedVariance ( vtkTypeBool ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use GetSampleEstimate instead ) virtual vtkTypeBool GetUnbiasedVariance ( ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void UnbiasedVarianceOn ( ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void UnbiasedVarianceOff ( ) ; /@} /@{ *
##  @warning THIS METHOD DOES NOTHING AND IS DEPRECATED.
##
##  Skewness estimator is picked depending on the state of `SampleEstimate`.
##  VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void SetG1Skewness ( vtkTypeBool ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use GetSampleEstimate instead ) virtual vtkTypeBool GetG1Skewness ( ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void G1SkewnessOn ( ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void G1SkewnessOff ( ) ; /@} /@{ *
##  @warning THIS METHOD DOES NOTHING AND IS DEPRECATED.
##
##  Kurtosis estimator is picked depending on the state of `SampleEstimate`.
##  VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void SetG2Kurtosis ( vtkTypeBool ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use GetSampleEstimate instead ) virtual vtkTypeBool GetG2Kurtosis ( ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void G2KurtosisOn ( ) ; VTK_DEPRECATED_IN_9_2_0 ( Please use SetSampleEstimate instead ) virtual void G2KurtosisOff ( ) ; /@} /@{ *
...
##  virtual void SetSampleEstimate ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  SampleEstimate  to  << _arg ) ; if ( this -> SampleEstimate != _arg ) { this -> SampleEstimate = _arg ; this -> Modified ( ) ; } } ; virtual bool GetSampleEstimate ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << SampleEstimate  of  << this -> SampleEstimate ) ; return this -> SampleEstimate ; } ; virtual void SampleEstimateOn ( ) { this -> SetSampleEstimate ( static_cast < bool > ( 1 ) ) ; } virtual void SampleEstimateOff ( ) { this -> SetSampleEstimate ( static_cast < bool > ( 0 ) ) ; } ; /@} /@{ *
...
##  virtual void SetSampleEstimateSignedDeviations ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  SignedDeviations  to  << _arg ) ; if ( this -> SignedDeviations != _arg ) { this -> SignedDeviations = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetSampleEstimateSignedDeviations ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << SignedDeviations  of  << this -> SignedDeviations ) ; return this -> SignedDeviations ; } ; virtual void SignedDeviationsOn ( ) { this -> SetSampleEstimateSignedDeviations ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void SignedDeviationsOff ( ) { this -> SetSampleEstimateSignedDeviations ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  vtkPointData
##  vtkCellData
##  virtual void SetSampleEstimateSignedDeviationsGhostsToSkip ( unsigned char _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  GhostsToSkip  to  << _arg ) ; if ( this -> GhostsToSkip != _arg ) { this -> GhostsToSkip = _arg ; this -> Modified ( ) ; } } ; virtual unsigned char GetSampleEstimateSignedDeviationsGhostsToSkip ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << GhostsToSkip  of  << this -> GhostsToSkip ) ; return this -> GhostsToSkip ; } ; /@} *
##  Given a collection of models, calculate aggregate model
##  void Aggregate ( vtkDataObjectCollection * , vtkMultiBlockDataSet * ) override ; protected : vtkDescriptiveStatistics ( ) ; ~ vtkDescriptiveStatistics ( ) override ; *
...
##  void SelectAssessFunctor ( vtkTable * outData , vtkDataObject * inMeta , vtkStringArray * rowNames , AssessFunctor * & dfunc ) override ; bool SampleEstimate ; vtkTypeBool SignedDeviations ; unsigned char GhostsToSkip ; private : vtkDescriptiveStatistics ( const vtkDescriptiveStatistics & ) = delete ; void operator = ( const vtkDescriptiveStatistics & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
