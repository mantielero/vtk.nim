...
## !!!Ignored construct:  # vtkNamedColors_h [NewLine] # vtkNamedColors_h [NewLine] # vtkColor.h  Needed for vtkColor[34]ub # vtkCommonColorModule.h  For export macro # vtkObject.h [NewLine] # vtkStdString.h  Needed for arguments # vtkStringArray.h  For returning color names [NewLine] class vtkNamedColorsDataStore ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkColorStringParser"
## !!!Ignored construct:  class VTKCOMMONCOLOR_EXPORT vtkNamedColors : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkNamedColors :: IsTypeOf ( type ) ; } static vtkNamedColors * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkNamedColors * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkNamedColors * NewInstance ( ) const { return vtkNamedColors :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkNamedColors :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkNamedColors :: New ( ) ; } public : ; *
...
##  HTML color string.
##  void SetColor ( const vtkStdString & name , const vtkStdString & htmlString ) ; protected : vtkNamedColors ( ) ; ~ vtkNamedColors ( ) override ; private : /@{ *
##  The implementation of the color map and other required methods.
##  vtkNamedColorsDataStore * Colors ; vtkColorStringParser * Parser ; /@} vtkNamedColors ( const vtkNamedColors & ) = delete ; void operator = ( const vtkNamedColors & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
