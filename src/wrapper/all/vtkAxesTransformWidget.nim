...
## !!!Ignored construct:  # vtkAxesTransformWidget_h [NewLine] # vtkAxesTransformWidget_h [NewLine] # vtkAbstractWidget.h [NewLine] # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkAxesTransformRepresentation ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkHandleWidget"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkAxesTransformWidget : public vtkAbstractWidget { public : *
##  Instantiate the object.
##  static vtkAxesTransformWidget * New ( ) ; /@{ *
##  Standard vtkObject methods
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAbstractWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAbstractWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkAxesTransformWidget :: IsTypeOf ( type ) ; } static vtkAxesTransformWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkAxesTransformWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkAxesTransformWidget * NewInstance ( ) const { return vtkAxesTransformWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAbstractWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkAxesTransformWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkAxesTransformWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  void SetRepresentation ( vtkAxesTransformRepresentation * r ) { this -> Superclass :: SetWidgetRepresentation ( reinterpret_cast < vtkWidgetRepresentation * > ( r ) ) ; } *
##  Return the representation as a vtkAxesTransformRepresentation.
##  vtkAxesTransformRepresentation * GetLineRepresentation ( ) { return reinterpret_cast < vtkAxesTransformRepresentation * > ( this -> WidgetRep ) ; } *
##  Create the default widget representation if one is not set.
##  void CreateDefaultRepresentation ( ) override ; *
##  Methods to change the whether the widget responds to interaction.
##  Overridden to pass the state to component widgets.
##  void SetProcessEvents ( vtkTypeBool ) override ; protected : vtkAxesTransformWidget ( ) ; ~ vtkAxesTransformWidget ( ) override ; int WidgetState ; enum WidgetStateType { Start = 0 , Active } ; # ! defined ( VTK_LEGACY_REMOVE ) [NewLine] VTK_DEPRECATED_IN_9_2_0 ( because leading underscore is reserved ) typedef WidgetStateType _WidgetState ; # [NewLine] int CurrentHandle ;  These methods handle events static void SelectAction ( vtkAbstractWidget * ) ; static void EndSelectAction ( vtkAbstractWidget * ) ; static void MoveAction ( vtkAbstractWidget * ) ;  The positioning handle widgets vtkHandleWidget * OriginWidget ;  first end point vtkHandleWidget * SelectionWidget ;  used when selecting any one of the axes private : vtkAxesTransformWidget ( const vtkAxesTransformWidget & ) = delete ; void operator = ( const vtkAxesTransformWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
