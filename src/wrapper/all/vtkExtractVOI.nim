...
## !!!Ignored construct:  # vtkExtractVOI_h [NewLine] # vtkExtractVOI_h [NewLine] # vtkImageAlgorithm.h [NewLine] # vtkImagingCoreModule.h  For export macro [NewLine]  Forward Declarations class vtkExtractStructuredGridHelper ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKIMAGINGCORE_EXPORT vtkExtractVOI : public vtkImageAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkImageAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkImageAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkExtractVOI :: IsTypeOf ( type ) ; } static vtkExtractVOI * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkExtractVOI * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkExtractVOI * NewInstance ( ) const { return vtkExtractVOI :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkImageAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkExtractVOI :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkExtractVOI :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual void SetIncludeBoundary ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  IncludeBoundary  to  << _arg ) ; if ( this -> IncludeBoundary != _arg ) { this -> IncludeBoundary = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetIncludeBoundary ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << IncludeBoundary  of  << this -> IncludeBoundary ) ; return this -> IncludeBoundary ; } ; virtual void IncludeBoundaryOn ( ) { this -> SetIncludeBoundary ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void IncludeBoundaryOff ( ) { this -> SetIncludeBoundary ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} protected : vtkExtractVOI ( ) ; ~ vtkExtractVOI ( ) override ; int RequestUpdateExtent ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestInformation ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestData ( vtkInformation * request , vtkInformationVector * * inputVector , vtkInformationVector * outputVector ) override ; *
...
##  bool RequestDataImpl ( vtkInformationVector * * inputVector , vtkInformationVector * outputVector ) ; int VOI [ 6 ] ; int SampleRate [ 3 ] ; vtkTypeBool IncludeBoundary ; vtkExtractStructuredGridHelper * Internal ; private : vtkExtractVOI ( const vtkExtractVOI & ) = delete ; void operator = ( const vtkExtractVOI & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
