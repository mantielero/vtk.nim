...
## !!!Ignored construct:  # vtkVoxel_h [NewLine] # vtkVoxel_h [NewLine] # vtkCell3D.h [NewLine] # vtkCommonDataModelModule.h  For export macro [NewLine] class vtkLine ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPixel"
discard "forward decl of vtkIncrementalPointLocator"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkVoxel : public vtkCell3D { public : static vtkVoxel * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkCell3D Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkCell3D :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkVoxel :: IsTypeOf ( type ) ; } static vtkVoxel * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkVoxel * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkVoxel * NewInstance ( ) const { return vtkVoxel :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkCell3D :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkVoxel :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkVoxel :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  void GetEdgePoints ( vtkIdType edgeId , const vtkIdType * & pts ) override ; vtkIdType GetFacePoints ( vtkIdType faceId , const vtkIdType * & pts ) override ; void GetEdgeToAdjacentFaces ( vtkIdType edgeId , const vtkIdType * & pts ) override ; vtkIdType GetFaceToAdjacentFaces ( vtkIdType faceId , const vtkIdType * & faces ) override ; vtkIdType GetPointToIncidentEdges ( vtkIdType pointId , const vtkIdType * & edges ) override ; vtkIdType GetPointToIncidentFaces ( vtkIdType pointId , const vtkIdType * & faces ) override ; vtkIdType GetPointToOneRingPoints ( vtkIdType pointId , const vtkIdType * & pts ) override ; double * GetParametricCoords ( ) override ; bool GetCentroid ( double centroid [ 3 ] ) const override ; bool IsInsideOut ( ) override ; /@} *
...
##
##  \return 1
##  int Inflate ( double dist ) override ; static void InterpolationDerivs ( const double pcoords [ 3 ] , double derivs [ 24 ] ) ; /@{ *
##  Compute the interpolation functions/derivatives
##  (aka shape functions/derivatives)
##  void InterpolateFunctions ( const double pcoords [ 3 ] , double weights [ 8 ] ) override { vtkVoxel :: InterpolationFunctions ( pcoords , weights ) ; } void InterpolateDerivs ( const double pcoords [ 3 ] , double derivs [ 24 ] ) override { vtkVoxel :: InterpolationDerivs ( pcoords , derivs ) ; } /@} *
...
##  static bool ComputeCentroid ( vtkPoints * points , const vtkIdType * pointIds , double centroid [ 3 ] ) ; protected : vtkVoxel ( ) ; ~ vtkVoxel ( ) override ; private : vtkVoxel ( const vtkVoxel & ) = delete ; void operator = ( const vtkVoxel & ) = delete ; vtkLine * Line ; vtkPixel * Pixel ; } ;
## Error: token expected: ; but got: [identifier]!!!
