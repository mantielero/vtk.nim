...
## !!!Ignored construct:  # vtkParseExtras_h [NewLine] # vtkParseExtras_h [NewLine] # vtkParseData.h [NewLine] # vtkWrappingToolsModule.h [NewLine] # < stddef . h > [NewLine]  Flags for selecting what info to print for declarations # VTK_PARSE_NAMES 0x00000010 [NewLine] # VTK_PARSE_VALUES 0x00000020 [NewLine] # VTK_PARSE_RETURN_VALUE 0x00000040 [NewLine] # VTK_PARSE_PARAMETER_LIST 0x00000080 [NewLine] # VTK_PARSE_SPECIFIERS 0x00FF0000 [NewLine] # VTK_PARSE_TRAILERS 0x0F000000 [NewLine] # VTK_PARSE_TEMPLATES 0xF0000000 [NewLine] # VTK_PARSE_EVERYTHING 0xFFFFFFFF [NewLine] # __cplusplus [NewLine] extern C { # [NewLine] *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_IdentifierLength ( const char * text ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_NameLength ( const char * text ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_UnscopedNameLength ( const char * text ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_LiteralLength ( const char * text ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_BasicTypeFromString ( const char * text , unsigned int * type , const char * * classname , size_t * classname_len ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_ValueInfoFromString ( ValueInfo * val , StringCache * cache , const char * text ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_ValueInfoToString ( ValueInfo * data , char * text , unsigned int flags ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_FunctionInfoToString ( FunctionInfo * func , char * text , unsigned int flags ) ; *
##  Generate a C++ template declaration from a TemplateInfo struct.
##
##  See vtkParse_ValueInfoToString() for basic usage.
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_TemplateInfoToString ( TemplateInfo * func , char * text , unsigned int flags ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT int vtkParse_CompareFunctionSignature ( const FunctionInfo * func1 , const FunctionInfo * func2 ) ; *
##  Expand a typedef within a variable, parameter, or typedef declaration.
##  The expansion is done in-place.
##  VTKWRAPPINGTOOLS_EXPORT void vtkParse_ExpandTypedef ( ValueInfo * valinfo , ValueInfo * typedefinfo ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkParse_ExpandTypedefs ( ValueInfo * valinfo , StringCache * cache , int n , const char * name [ ] , const char * val [ ] , ValueInfo * typedefinfo [ ] ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkParse_ExpandValues ( ValueInfo * valinfo , StringCache * cache , int n , const char * name [ ] , const char * val [ ] ) ; *
##  Search and replace, return the initial string if no replacements
##  occurred, else return a new string allocated with malloc. VTKWRAPPINGTOOLS_EXPORT const char * vtkParse_StringReplace ( const char * str1 , int n , const char * name [ ] , const char * val [ ] ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT size_t vtkParse_DecomposeTemplatedType ( const char * text , const char * * classname , int n , const char * * * args , const char * defaults [ ] ) ; *
##  Free the list of strings returned by ExtractTemplateArgs.
##  VTKWRAPPINGTOOLS_EXPORT void vtkParse_FreeTemplateDecomposition ( const char * classname , int n , const char * * args ) ; *
...
##  be returned.
##  VTKWRAPPINGTOOLS_EXPORT void vtkParse_InstantiateClassTemplate ( ClassInfo * data , StringCache * cache , int n , const char * args [ ] ) ; *
...
##  VTKWRAPPINGTOOLS_EXPORT void vtkParse_IntantiateFunctionTemplate ( FunctionInfo * data , int n , const char * args [ ] ) ; *
##  Get a zero-terminated array of the types in vtkTemplateMacro.
##  VTKWRAPPINGTOOLS_EXPORT const char * * vtkParse_GetTemplateMacroTypes ( void ) ; *
##  Get a zero-terminated array of the types in vtkArray.
##  VTKWRAPPINGTOOLS_EXPORT const char * * vtkParse_GetArrayTypes ( void ) ; # __cplusplus [NewLine] }  extern "C" # [NewLine] # [NewLine]  VTK-HeaderTest-Exclude: vtkParseExtras.h
