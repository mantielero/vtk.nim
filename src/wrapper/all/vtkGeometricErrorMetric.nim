...
## !!!Ignored construct:  # vtkGeometricErrorMetric_h [NewLine] # vtkGeometricErrorMetric_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkGenericSubdivisionErrorMetric.h [NewLine] class vtkGenericDataSet ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkGeometricErrorMetric : public vtkGenericSubdivisionErrorMetric { public : *
##  Construct the error metric with a default squared absolute geometric
##  accuracy equal to 1.
##  static vtkGeometricErrorMetric * New ( ) ; /@{ *
##  Standard VTK type and error macros.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkGenericSubdivisionErrorMetric Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkGenericSubdivisionErrorMetric :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkGeometricErrorMetric :: IsTypeOf ( type ) ; } static vtkGeometricErrorMetric * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkGeometricErrorMetric * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkGeometricErrorMetric * NewInstance ( ) const { return vtkGeometricErrorMetric :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkGenericSubdivisionErrorMetric :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkGeometricErrorMetric :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkGeometricErrorMetric :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} /@{ *
##  Return the squared absolute geometric accuracy. See
##  SetAbsoluteGeometricTolerance() for details.
##  \post positive_result: result>0
##  virtual double GetAbsoluteGeometricTolerance ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << AbsoluteGeometricTolerance  of  << this -> AbsoluteGeometricTolerance ) ; return this -> AbsoluteGeometricTolerance ; } ; /@} *
...
##  int GetRelative ( ) ; protected : vtkGeometricErrorMetric ( ) ; ~ vtkGeometricErrorMetric ( ) override ; *
...
##  double Distance2LinePoint ( double x [ 3 ] , double y [ 3 ] , double z [ 3 ] ) ; double AbsoluteGeometricTolerance ; double SmallestSize ; int Relative ;  Control the type of output of GetError() private : vtkGeometricErrorMetric ( const vtkGeometricErrorMetric & ) = delete ; void operator = ( const vtkGeometricErrorMetric & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
