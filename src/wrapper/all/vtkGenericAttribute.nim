...
## !!!Ignored construct:  # vtkGenericAttribute_h [NewLine] # vtkGenericAttribute_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkObject.h [NewLine] class vtkGenericCellIterator ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkGenericAdaptorCell"
discard "forward decl of vtkGenericPointIterator"
const
  VTKCOMMONDATAMODEL_EXPORTvtkPointCentered* = 0
  VTKCOMMONDATAMODEL_EXPORTvtkCellCentered* = 1
  VTKCOMMONDATAMODEL_EXPORTvtkBoundaryCentered* = 2

## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkGenericAttribute : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkGenericAttribute :: IsTypeOf ( type ) ; } static vtkGenericAttribute * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkGenericAttribute * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkGenericAttribute * NewInstance ( ) const { return vtkGenericAttribute :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkGenericAttribute :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkGenericAttribute :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  \pre other_exists: other!=0
##  \pre not_self: other!=this
##  virtual void ShallowCopy ( vtkGenericAttribute * other ) = 0 ; protected : vtkGenericAttribute ( ) ; ~ vtkGenericAttribute ( ) override ; private : vtkGenericAttribute ( const vtkGenericAttribute & ) = delete ; void operator = ( const vtkGenericAttribute & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
