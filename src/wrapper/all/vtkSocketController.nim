...
## !!!Ignored construct:  # vtkSocketController_h [NewLine] # vtkSocketController_h [NewLine] # vtkMultiProcessController.h [NewLine] # vtkParallelCoreModule.h  For export macro [NewLine] class vtkSocketCommunicator ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKPARALLELCORE_EXPORT vtkSocketController : public vtkMultiProcessController { public : static vtkSocketController * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkMultiProcessController Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkMultiProcessController :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkSocketController :: IsTypeOf ( type ) ; } static vtkSocketController * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkSocketController * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkSocketController * NewInstance ( ) const { return vtkSocketController :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkMultiProcessController :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkSocketController :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkSocketController :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  This method is for initialiazing sockets.
##  One of these is REQUIRED for Windows.
##  void Initialize ( int * argc , char * * * argv , int ) override { this -> Initialize ( argc , argv ) ; } void Initialize ( int * argc , char * * * argv ) override ; virtual void Initialize ( ) { this -> Initialize ( nullptr , nullptr ) ; } *
##  Does not apply to sockets. Does nothing.
##  void Finalize ( ) override { } void Finalize ( int ) override { } *
##  Does not apply to sockets. Does nothing.
...
##  to the communicator
##  virtual int ConnectTo ( const char * hostName , int port ) ; int GetSwapBytesInReceivedData ( ) ; *
...
##  vtkMultiProcessController * CreateCompliantController ( ) ; enum Consts { ENDIAN_TAG = 1010580540 ,  0x3c3c3c3c IDTYPESIZE_TAG = 1027423549 ,  0x3d3d3d3d VERSION_TAG = 1044266558 ,  0x3e3e3e3e HASH_TAG = 0x3f3f3f3f } ; protected : vtkSocketController ( ) ; ~ vtkSocketController ( ) override ;  Initialize only once, finialize on destruction. static int Initialized ; private : vtkSocketController ( const vtkSocketController & ) = delete ; void operator = ( const vtkSocketController & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
