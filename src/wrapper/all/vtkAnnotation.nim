...
## !!!Ignored construct:  # vtkAnnotation_h [NewLine] # vtkAnnotation_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDataObject.h [NewLine] class vtkInformationStringKey ;
...
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkAnnotation : public vtkDataObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkDataObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkDataObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkAnnotation :: IsTypeOf ( type ) ; } static vtkAnnotation * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkAnnotation * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkAnnotation * NewInstance ( ) const { return vtkAnnotation :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkDataObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkAnnotation :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkAnnotation :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkAnnotation * New ( ) ; *
...
##  virtual vtkSelection * GetnameSelection ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Selection  address  << static_cast < vtkSelection * > ( this -> Selection ) ) ; return this -> Selection ; } ; virtual void SetSelection ( vtkSelection * selection ) ; /@} /@{ *
##  Retrieve a vtkAnnotation stored inside an information object.
##  static vtkAnnotation * GetData ( vtkInformation * info ) ; static vtkAnnotation * GetData ( vtkInformationVector * v , int i = 0 ) ; /@} *
...
##  vtkMTimeType GetMTime ( ) override ; protected : vtkAnnotation ( ) ; ~ vtkAnnotation ( ) override ; vtkSelection * Selection ; private : vtkAnnotation ( const vtkAnnotation & ) = delete ; void operator = ( const vtkAnnotation & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
