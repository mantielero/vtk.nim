...
## !!!Ignored construct:  # vtkGenericAdaptorCell_h [NewLine] # vtkGenericAdaptorCell_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkObject.h [NewLine] class vtkLine ;
...
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkGenericAdaptorCell : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkGenericAdaptorCell :: IsTypeOf ( type ) ; } static vtkGenericAdaptorCell * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkGenericAdaptorCell * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkGenericAdaptorCell * NewInstance ( ) const { return vtkGenericAdaptorCell :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkGenericAdaptorCell :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkGenericAdaptorCell :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  VTK_NEWINSTANCE virtual vtkGenericCellIterator * NewCellIterator ( ) = 0 ; *
...
##  \post positive_result: result>=0
##  virtual int CountNeighbors ( vtkGenericAdaptorCell * boundary ) = 0 ; virtual void CountEdgeNeighbors ( int * sharing ) = 0 ; /@} *
...
##  virtual const vtkIdType * GetEdgeArray ( vtkIdType edgeId ) = 0 ; protected : vtkGenericAdaptorCell ( ) ; ~ vtkGenericAdaptorCell ( ) override ; *
##  Reset internal structures.
##  void Reset ( ) ; *
##  Allocate some memory if Tuples does not exist or is smaller than size.
##  \pre positive_size: size>0
##  void AllocateTuples ( int size ) ;  Internal tetra used for the contouring/clipping algorithm vtkTetra * Tetra ; vtkTriangle * Triangle ; vtkLine * Line ; vtkVertex * Vertex ;  is it used ? vtkQuad * Quad ; vtkHexahedron * Hexa ; vtkWedge * Wedge ; vtkPyramid * Pyramid ;  Internal locator when tessellating on a cell basis, this is different
