...
## !!!Ignored construct:  # vtkTableToGraph_h [NewLine] # vtkTableToGraph_h [NewLine] # vtkGraphAlgorithm.h [NewLine] # vtkInfovisCoreModule.h  For export macro [NewLine] class vtkBitArray ;
...
## !!!Ignored construct:  class VTKINFOVISCORE_EXPORT vtkTableToGraph : public vtkGraphAlgorithm { public : static vtkTableToGraph * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkGraphAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkGraphAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkTableToGraph :: IsTypeOf ( type ) ; } static vtkTableToGraph * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkTableToGraph * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkTableToGraph * NewInstance ( ) const { return vtkTableToGraph :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkGraphAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkTableToGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkTableToGraph :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual vtkMutableDirectedGraph * GetnameLinkGraph ( ) { vtkDebugWithObjectMacro ( this , <<  returning  LinkGraph  address  << static_cast < vtkMutableDirectedGraph * > ( this -> LinkGraph ) ) ; return this -> LinkGraph ; } ; void SetLinkGraph ( vtkMutableDirectedGraph * g ) ; /@} *
...
##  virtual void SetDirected ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Directed  to  << _arg ) ; if ( this -> Directed != _arg ) { this -> Directed = _arg ; this -> Modified ( ) ; } } ; virtual bool GetDirected ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Directed  of  << this -> Directed ) ; return this -> Directed ; } ; virtual void DirectedOn ( ) { this -> SetDirected ( static_cast < bool > ( 1 ) ) ; } virtual void DirectedOff ( ) { this -> SetDirected ( static_cast < bool > ( 0 ) ) ; } ; /@} *
...
##  void SetVertexTableConnection ( vtkAlgorithmOutput * in ) ; protected : vtkTableToGraph ( ) ; ~ vtkTableToGraph ( ) override ; *
##  Validate that the link graph is in the appropriate format.
##  int ValidateLinkGraph ( ) ; int FillInputPortInformation ( int port , vtkInformation * info ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestDataObject ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; bool Directed ; vtkMutableDirectedGraph * LinkGraph ; vtkStringArray * VertexTableDomains ; private : vtkTableToGraph ( const vtkTableToGraph & ) = delete ; void operator = ( const vtkTableToGraph & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
