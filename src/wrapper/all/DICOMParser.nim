...
## !!!Ignored construct:  # __DICOMParser_h_ [NewLine] # __DICOMParser_h_ [NewLine] # _MSC_VER [NewLine] # warning ( disable : 4514 ) [NewLine] # warning ( disable : 4786 ) [NewLine] # warning ( disable : 4503 ) [NewLine] # warning ( disable : 4710 ) [NewLine] # warning ( disable : 4702 ) [NewLine] # warning ( push , 3 ) [NewLine] # [NewLine] # < map > [NewLine] # < utility > [NewLine] # < vector > [NewLine] # DICOMConfig.h [NewLine] # DICOMFile.h [NewLine] # DICOMParserMap.h [NewLine] # DICOMTypes.h [NewLine] class DICOMCallback ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of DICOMMemberCallback"
discard "forward decl of DICOMParserImplementation"
## !!!Ignored construct:  class DICOM_EXPORT DICOMParser { public :
##  Default constructor
##  DICOMParser ( ) ;
##  Default destructor.
##  virtual ~ DICOMParser ( ) ;
...
##  image data.
##  bool ByteSwap ; bool ByteSwapData ;
...
##  DICOMFile * DataFile ; dicom_stl :: string FileName ; bool ToggleByteSwapImageData ;  dicom_stl::vector<doublebyte> Groups;
##  dicom_stl::vector<doublebyte> Elements;
##  dicom_stl::vector<VRTypes> Datatypes; DICOMMemberCallback < DICOMParser > * TransferSyntaxCB ;
...
##  compile warnings.
##  DICOMParserImplementation * Implementation ; private : DICOMParser ( const DICOMParser & ) ; void operator = ( const DICOMParser & ) ; } ;
## Error: token expected: ; but got: [identifier]!!!
