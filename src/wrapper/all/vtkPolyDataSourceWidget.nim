...
## !!!Ignored construct:  # vtkPolyDataSourceWidget_h [NewLine] # vtkPolyDataSourceWidget_h [NewLine] # vtk3DWidget.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkPolyDataAlgorithm ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkPolyDataSourceWidget : public vtk3DWidget { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtk3DWidget Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtk3DWidget :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPolyDataSourceWidget :: IsTypeOf ( type ) ; } static vtkPolyDataSourceWidget * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPolyDataSourceWidget * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPolyDataSourceWidget * NewInstance ( ) const { return vtkPolyDataSourceWidget :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtk3DWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPolyDataSourceWidget :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPolyDataSourceWidget :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  in the widget.
##  virtual void UpdatePlacement ( ) = 0 ; protected : *
...
##  vtkPolyDataSourceWidget ( ) ; private :  this copy constructor and assignment operator are deliberately not
...
##  be used in these ways.  I couldn't resist adding this explanation. :) vtkPolyDataSourceWidget ( const vtkPolyDataSourceWidget & ) = delete ; void operator = ( const vtkPolyDataSourceWidget & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
