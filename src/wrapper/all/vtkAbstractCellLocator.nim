...
## !!!Ignored construct:  # vtkAbstractCellLocator_h [NewLine] # vtkAbstractCellLocator_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDeprecation.h  For VTK_DEPRECATED_IN_9_2_0 # vtkLocator.h [NewLine] # vtkNew.h  For vtkNew [NewLine] # < memory >  For shared_ptr # < vector >  For Weights [NewLine] class vtkCellArray ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkGenericCell"
discard "forward decl of vtkIdList"
discard "forward decl of vtkPoints"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkAbstractCellLocator : public vtkLocator { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkLocator Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkLocator :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkAbstractCellLocator :: IsTypeOf ( type ) ; } static vtkAbstractCellLocator * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkAbstractCellLocator * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkAbstractCellLocator * NewInstance ( ) const { return vtkAbstractCellLocator :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkLocator :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkAbstractCellLocator :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkAbstractCellLocator :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  virtual void SetNumberOfCellsPerNode ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  << NumberOfCellsPerNode  to  << _arg ) ; if ( this -> NumberOfCellsPerNode != ( _arg < 1 ? 1 : ( _arg > VTK_INT_MAX ? VTK_INT_MAX : _arg ) ) ) { this -> NumberOfCellsPerNode = ( _arg < 1 ? 1 : ( _arg > VTK_INT_MAX ? VTK_INT_MAX : _arg ) ) ; this -> Modified ( ) ; } } virtual int GetNumberOfCellsPerNodeMinValue ( ) { return 1 ; } virtual int GetNumberOfCellsPerNodeMaxValue ( ) { return VTK_INT_MAX ; } ; virtual int GetNumberOfCellsPerNode ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << NumberOfCellsPerNode  of  << this -> NumberOfCellsPerNode ) ; return this -> NumberOfCellsPerNode ; } ; /@} /@{ *
...
##  save the bounds).
##  virtual void SetCacheCellBounds ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  CacheCellBounds  to  << _arg ) ; if ( this -> CacheCellBounds != _arg ) { this -> CacheCellBounds = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetNumberOfCellsPerNodeCacheCellBounds ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << CacheCellBounds  of  << this -> CacheCellBounds ) ; return this -> CacheCellBounds ; } ; virtual void CacheCellBoundsOn ( ) { this -> SetCacheCellBounds ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void CacheCellBoundsOff ( ) { this -> SetCacheCellBounds ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} *
...
##  virtual void SetCacheCellBoundsRetainCellLists ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  RetainCellLists  to  << _arg ) ; if ( this -> RetainCellLists != _arg ) { this -> RetainCellLists = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetNumberOfCellsPerNodeCacheCellBoundsRetainCellLists ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << RetainCellLists  of  << this -> RetainCellLists ) ; return this -> RetainCellLists ; } ; virtual void RetainCellListsOn ( ) { this -> SetCacheCellBoundsRetainCellLists ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void RetainCellListsOff ( ) { this -> SetCacheCellBoundsRetainCellLists ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##
##  THIS FUNCTION IS THREAD SAFE.
##  virtual vtkIdType FindCell ( double x [ 3 ] , double tol2 , vtkGenericCell * GenCell , double pcoords [ 3 ] , double * weights ) ; virtual vtkIdType FindCell ( double x [ 3 ] , double tol2 , vtkGenericCell * GenCell , int & subId , double pcoords [ 3 ] , double * weights ) ; /@} *
...
##  virtual void ShallowCopy ( vtkAbstractCellLocator * ) { } protected : vtkAbstractCellLocator ( ) ; ~ vtkAbstractCellLocator ( ) override ; /@{ *
...
##  virtual bool StoreCellBounds ( ) ; virtual void FreeCellBounds ( ) ; /@} *
...
##  void UpdateInternalWeights ( ) ; int NumberOfCellsPerNode ; vtkTypeBool RetainCellLists ; vtkTypeBool CacheCellBounds ; vtkNew < vtkGenericCell > GenericCell ; std :: shared_ptr < std :: vector < double >> CellBoundsSharedPtr ; double * CellBounds ;  The is just used for simplicity in the internal code *
##  This time stamp helps us decide if we want to update internal `Weights` array size.
##  vtkTimeStamp WeightsTime ; static bool IsInBounds ( const double bounds [ 6 ] , const double x [ 3 ] , const double tol = 0.0 ) ;
...
##  std :: vector < double > Weights ; private : vtkAbstractCellLocator ( const vtkAbstractCellLocator & ) = delete ; void operator = ( const vtkAbstractCellLocator & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
