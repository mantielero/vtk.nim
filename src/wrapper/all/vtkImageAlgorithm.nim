...
## !!!Ignored construct:  # vtkImageAlgorithm_h [NewLine] # vtkImageAlgorithm_h [NewLine] # vtkAlgorithm.h [NewLine] # vtkCommonExecutionModelModule.h  For export macro [NewLine] class vtkDataSet ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkImageData"
## !!!Ignored construct:  class VTKCOMMONEXECUTIONMODEL_EXPORT vtkImageAlgorithm : public vtkAlgorithm { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkImageAlgorithm :: IsTypeOf ( type ) ; } static vtkImageAlgorithm * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkImageAlgorithm * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkImageAlgorithm * NewInstance ( ) const { return vtkImageAlgorithm :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkImageAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkImageAlgorithm :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
##  Get the output data object for a port on this algorithm.
##  vtkImageData * GetOutput ( ) ; vtkImageData * GetOutput ( int ) ; virtual void SetOutput ( vtkDataObject * d ) ; /@} *
...
##  vtkDataObject * GetInput ( int port ) ; vtkDataObject * GetInput ( ) { return this -> GetInput ( 0 ) ; } vtkImageData * GetImageDataInput ( int port ) ; /@} /@{ *
##  Assign a data object as input. Note that this method does not
##  establish a pipeline connection. Use SetInputConnection to
##  setup a pipeline connection.
##  virtual void AddInputData ( vtkDataObject * ) ; virtual void AddInputData ( int , vtkDataObject * ) ; /@} protected : vtkImageAlgorithm ( ) ; ~ vtkImageAlgorithm ( ) override ; *
...
##  virtual void ExecuteData ( vtkDataObject * output ) ; virtual void Execute ( ) ; /@} /@{ *
...
##  virtual void AllocateOutputData ( vtkImageData * out , vtkInformation * outInfo , int * uExtent ) ; virtual vtkImageData * AllocateOutputData ( vtkDataObject * out , vtkInformation * outInfo ) ; /@} *
...
##  int FillOutputPortInformation ( int port , vtkInformation * info ) override ; int FillInputPortInformation ( int port , vtkInformation * info ) override ; /@} private : vtkImageAlgorithm ( const vtkImageAlgorithm & ) = delete ; void operator = ( const vtkImageAlgorithm & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
