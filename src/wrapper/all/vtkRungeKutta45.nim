...
## !!!Ignored construct:  # vtkRungeKutta45_h [NewLine] # vtkRungeKutta45_h [NewLine] # vtkCommonMathModule.h  For export macro # vtkInitialValueProblemSolver.h [NewLine] class VTKCOMMONMATH_EXPORT vtkRungeKutta45 : public vtkInitialValueProblemSolver { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkInitialValueProblemSolver Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkInitialValueProblemSolver :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkRungeKutta45 :: IsTypeOf ( type ) ; } static vtkRungeKutta45 * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkRungeKutta45 * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkRungeKutta45 * NewInstance ( ) const { return vtkRungeKutta45 :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkInitialValueProblemSolver :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkRungeKutta45 :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkRungeKutta45 :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Construct a vtkRungeKutta45 with no initial FunctionSet.
##  static vtkRungeKutta45 * New ( ) ; using Superclass :: ComputeNextStep ; /@{ *
