...
## !!!Ignored construct:  # vtkAbstractImageInterpolator_h [NewLine] # vtkAbstractImageInterpolator_h [NewLine] # vtkImagingCoreModule.h  For export macro # vtkObject.h [NewLine] enum vtkImageBorderMode : int { VTK_IMAGE_BORDER_CLAMP = 0 , VTK_IMAGE_BORDER_REPEAT = 1 , VTK_IMAGE_BORDER_MIRROR = 2 , } ;
...
discard "forward decl of vtkInterpolationWeights"
## !!!Ignored construct:  class VTKIMAGINGCORE_EXPORT vtkAbstractImageInterpolator : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkAbstractImageInterpolator :: IsTypeOf ( type ) ; } static vtkAbstractImageInterpolator * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkAbstractImageInterpolator * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkAbstractImageInterpolator * NewInstance ( ) const { return vtkAbstractImageInterpolator :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkAbstractImageInterpolator :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkAbstractImageInterpolator :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void SetOutValue ( double outValue ) ; double GetOutValue ( ) { return this -> OutValue ; } *
...
##  void SetTolerance ( double tol ) ; double GetTolerance ( ) { return this -> Tolerance ; } *
...
##  void SetComponentOffset ( int offset ) ; int GetComponentOffset ( ) { return this -> ComponentOffset ; } *
...
##  void SetComponentCount ( int count ) ; int GetComponentCount ( ) { return this -> ComponentCount ; } *
...
##  void InterpolateIJK ( const double point [ 3 ] , double * value ) ; void InterpolateIJK ( const float point [ 3 ] , float * value ) ; /@} /@{ *
...
##  bool CheckBoundsIJK ( const double x [ 3 ] ) ; bool CheckBoundsIJK ( const float x [ 3 ] ) ; /@} /@{ *
...
##  void SetBorderMode ( vtkImageBorderMode mode ) ; void SetBorderModeToClamp ( ) { this -> SetBorderMode ( VTK_IMAGE_BORDER_CLAMP ) ; } void SetBorderModeToRepeat ( ) { this -> SetBorderMode ( VTK_IMAGE_BORDER_REPEAT ) ; } void SetBorderModeToMirror ( ) { this -> SetBorderMode ( VTK_IMAGE_BORDER_MIRROR ) ; } vtkImageBorderMode GetBorderMode ( ) { return this -> BorderMode ; } const char * GetBorderModeAsString ( ) ; /@} *
...
##  void SetSlidingWindow ( bool x ) ; void SlidingWindowOn ( ) { this -> SetSlidingWindow ( true ) ; } void SlidingWindowOff ( ) { this -> SetSlidingWindow ( false ) ; } bool GetSlidingWindow ( ) { return this -> SlidingWindow ; } *
...
##  virtual void PrecomputeWeightsForExtent ( const double matrix [ 16 ] , const int extent [ 6 ] , int checkExtent [ 6 ] , vtkInterpolationWeights * & weights ) ; virtual void PrecomputeWeightsForExtent ( const float matrix [ 16 ] , const int extent [ 6 ] , int checkExtent [ 6 ] , vtkInterpolationWeights * & weights ) ; /@} *
...
##  void InterpolateRow ( vtkInterpolationWeights * & weights , int xIdx , int yIdx , int zIdx , double * value , int n ) ; void InterpolateRow ( vtkInterpolationWeights * & weights , int xIdx , int yIdx , int zIdx , float * value , int n ) ; /@} /@{ *
...
##  virtual void GetInterpolationFunc ( void ( * * doublefunc ) ( vtkInterpolationInfo * , const double [ 3 ] , double * ) ) ; virtual void GetInterpolationFunc ( void ( * * floatfunc ) ( vtkInterpolationInfo * , const float [ 3 ] , float * ) ) ; /@} /@{ *
##  Get the row interpolation functions.
##  virtual void GetRowInterpolationFunc ( void ( * * doublefunc ) ( vtkInterpolationWeights * , int , int , int , double * , int ) ) ; virtual void GetRowInterpolationFunc ( void ( * * floatfunc ) ( vtkInterpolationWeights * , int , int , int , float * , int ) ) ; /@} /@{ *
##  Get the sliding window interpolation functions.
##  virtual void GetSlidingWindowFunc ( void ( * * doublefunc ) ( vtkInterpolationWeights * , int , int , int , double * , int ) ) ; virtual void GetSlidingWindowFunc ( void ( * * floatfunc ) ( vtkInterpolationWeights * , int , int , int , float * , int ) ) ; /@} vtkDataArray * Scalars ; double StructuredBoundsDouble [ 6 ] ; float StructuredBoundsFloat [ 6 ] ; int Extent [ 6 ] ; double Spacing [ 3 ] ; double Origin [ 3 ] ; double OutValue ; double Tolerance ; vtkImageBorderMode BorderMode ; int ComponentOffset ; int ComponentCount ; bool SlidingWindow ;  information needed by the interpolator funcs vtkInterpolationInfo * InterpolationInfo ; void ( * InterpolationFuncDouble ) ( vtkInterpolationInfo * info , const double point [ 3 ] , double * outPtr ) ; void ( * InterpolationFuncFloat ) ( vtkInterpolationInfo * info , const float point [ 3 ] , float * outPtr ) ; void ( * RowInterpolationFuncDouble ) ( vtkInterpolationWeights * weights , int idX , int idY , int idZ , double * outPtr , int n ) ; void ( * RowInterpolationFuncFloat ) ( vtkInterpolationWeights * weights , int idX , int idY , int idZ , float * outPtr , int n ) ; private : vtkAbstractImageInterpolator ( const vtkAbstractImageInterpolator & ) = delete ; void operator = ( const vtkAbstractImageInterpolator & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

proc InterpolateIJK*(point: array[3, cdouble]; value: ptr cdouble) {.
    importcpp: "VTKIMAGINGCORE_EXPORT::InterpolateIJK(@)",
    header: "vtkAbstractImageInterpolator.h".}
proc InterpolateIJK*(point: array[3, cfloat]; value: ptr cfloat) {.
    importcpp: "VTKIMAGINGCORE_EXPORT::InterpolateIJK(@)",
    header: "vtkAbstractImageInterpolator.h".}
proc CheckBoundsIJK*(x: array[3, cdouble]): bool {.
    importcpp: "VTKIMAGINGCORE_EXPORT::CheckBoundsIJK(@)",
    header: "vtkAbstractImageInterpolator.h".}
proc CheckBoundsIJK*(x: array[3, cfloat]): bool {.
    importcpp: "VTKIMAGINGCORE_EXPORT::CheckBoundsIJK(@)",
    header: "vtkAbstractImageInterpolator.h".}
proc InterpolateRow*(weights: ptr vtkInterpolationWeights; xIdx: cint; yIdx: cint;
                    zIdx: cint; value: ptr cdouble; n: cint) {.
    importcpp: "VTKIMAGINGCORE_EXPORT::InterpolateRow(@)",
    header: "vtkAbstractImageInterpolator.h".}
proc InterpolateRow*(weights: ptr vtkInterpolationWeights; xIdx: cint; yIdx: cint;
                    zIdx: cint; value: ptr cfloat; n: cint) {.
    importcpp: "VTKIMAGINGCORE_EXPORT::InterpolateRow(@)",
    header: "vtkAbstractImageInterpolator.h".}