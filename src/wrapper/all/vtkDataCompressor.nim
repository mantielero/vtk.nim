...
## !!!Ignored construct:  # vtkDataCompressor_h [NewLine] # vtkDataCompressor_h [NewLine] # vtkIOCoreModule.h  For export macro # vtkObject.h [NewLine] class vtkUnsignedCharArray ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKIOCORE_EXPORT vtkDataCompressor : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkDataCompressor :: IsTypeOf ( type ) ; } static vtkDataCompressor * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkDataCompressor * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkDataCompressor * NewInstance ( ) const { return vtkDataCompressor :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkDataCompressor :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkDataCompressor :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  this class.
##  vtkUnsignedCharArray * Uncompress ( unsigned char const * compressedData , size_t compressedSize , size_t uncompressedSize ) ; * Compression performance varies greatly with compression level
...
##  virtual void SetCompressionLevel ( int compressionLevel ) = 0 ; virtual int GetCompressionLevel ( ) = 0 ; protected : vtkDataCompressor ( ) ; ~ vtkDataCompressor ( ) override ;  Actual compression method.  This must be provided by a subclass.
##  Must return the size of the compressed data, or zero on error. virtual size_t CompressBuffer ( unsigned char const * uncompressedData , size_t uncompressedSize , unsigned char * compressedData , size_t compressionSpace ) = 0 ;  Actual decompression method.  This must be provided by a subclass.
##  Must return the size of the uncompressed data, or zero on error. virtual size_t UncompressBuffer ( unsigned char const * compressedData , size_t compressedSize , unsigned char * uncompressedData , size_t uncompressedSize ) = 0 ; private : vtkDataCompressor ( const vtkDataCompressor & ) = delete ; void operator = ( const vtkDataCompressor & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
