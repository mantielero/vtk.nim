...
## !!!Ignored construct:  # vtkGenericCellTessellator_h [NewLine] # vtkGenericCellTessellator_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkObject.h [NewLine] class vtkCellArray ;
...
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkGenericCellTessellator : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkGenericCellTessellator :: IsTypeOf ( type ) ; } static vtkGenericCellTessellator * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkGenericCellTessellator * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkGenericCellTessellator * NewInstance ( ) const { return vtkGenericCellTessellator :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkGenericCellTessellator :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkGenericCellTessellator :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  virtual void SetErrorMetrics ( vtkCollection * someErrorMetrics ) ; virtual vtkCollection * GetnameErrorMetrics ( ) { vtkDebugWithObjectMacro ( this , <<  returning  ErrorMetrics  address  << static_cast < vtkCollection * > ( this -> ErrorMetrics ) ) ; return this -> ErrorMetrics ; } ; /@} *
...
##  virtual int GetMeasurement ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << Measurement  of  << this -> Measurement ) ; return this -> Measurement ; } ; virtual void SetMeasurement ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  Measurement  to  << _arg ) ; if ( this -> Measurement != _arg ) { this -> Measurement = _arg ; this -> Modified ( ) ; } } ; /@} *
...
##  void GetMaxErrors ( double * errors ) ; protected : vtkGenericCellTessellator ( ) ; ~ vtkGenericCellTessellator ( ) override ; *
