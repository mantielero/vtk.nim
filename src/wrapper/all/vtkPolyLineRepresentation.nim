...
## !!!Ignored construct:  # vtkPolyLineRepresentation_h [NewLine] # vtkPolyLineRepresentation_h [NewLine] # vtkCurveRepresentation.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkPolyLineSource ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPointHandleSource"
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkPolyLineRepresentation : public vtkCurveRepresentation { public : static vtkPolyLineRepresentation * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkCurveRepresentation Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkCurveRepresentation :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPolyLineRepresentation :: IsTypeOf ( type ) ; } static vtkPolyLineRepresentation * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPolyLineRepresentation * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPolyLineRepresentation * NewInstance ( ) const { return vtkPolyLineRepresentation :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkCurveRepresentation :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPolyLineRepresentation :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPolyLineRepresentation :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  void BuildRepresentation ( ) override ; protected : vtkPolyLineRepresentation ( ) ; ~ vtkPolyLineRepresentation ( ) override ;  The poly line source vtkNew < vtkPolyLineSource > PolyLineSource ; *
...
##  void ReconfigureHandles ( int npts ) ;  Specialized methods to access handles vtkActor * GetHandleActor ( int index ) override ; vtkHandleSource * GetHandleSource ( int index ) override ; virtual int GetHandleIndex ( vtkProp * prop ) override ; private : vtkPolyLineRepresentation ( const vtkPolyLineRepresentation & ) = delete ; void operator = ( const vtkPolyLineRepresentation & ) = delete ;  Glyphs representing hot spots (e.g., handles) std :: vector < vtkSmartPointer < vtkPointHandleSource >> PointHandles ; std :: vector < vtkSmartPointer < vtkActor >> HandleActors ; } ;
## Error: token expected: ; but got: [identifier]!!!
