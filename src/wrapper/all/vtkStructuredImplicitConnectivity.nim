...
## !!!Ignored construct:  # vtkStructuredImplicitConnectivity_h [NewLine] # vtkStructuredImplicitConnectivity_h [NewLine] # vtkFiltersParallelMPIModule.h  For export macro # vtkObject.h [NewLine]  Forward declarations class vtkDataArray ;
...
discard "forward decl of CommunicationManager"
discard "forward decl of DomainMetaData"
discard "forward decl of StructuredGrid"
##  END namespace detail

##  END namespace vtk

## !!!Ignored construct:  class VTKFILTERSPARALLELMPI_EXPORT vtkStructuredImplicitConnectivity : public vtkObject { public : static vtkStructuredImplicitConnectivity * New ( ) ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkStructuredImplicitConnectivity :: IsTypeOf ( type ) ; } static vtkStructuredImplicitConnectivity * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkStructuredImplicitConnectivity * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkStructuredImplicitConnectivity * NewInstance ( ) const { return vtkStructuredImplicitConnectivity :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkStructuredImplicitConnectivity :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkStructuredImplicitConnectivity :: New ( ) ; } public : ; *
...
##  void SetWholeExtent ( int wholeExt [ 6 ] ) ;  \brief Registers the structured grid dataset belonging to this process.
...
##  \note A rank with no or an empty grid, should not call this method. void RegisterGrid ( const int gridID , int extent [ 6 ] , vtkPoints * gridPnts , vtkPointData * pointData ) ;  \brief Registers the rectilinear grid dataset belonging to this process.
...
##  \pre gridID >= 0. The code uses values of gridID < -1 as flag internally.
##  \pre vtkStructuredExtent::Smaller(extent,wholeExtent) == true.
##  \note A rank with no or an empty grid, should not call this method. void RegisterRectilinearGrid ( const int gridID , int extent [ 6 ] , vtkDataArray * xcoords , vtkDataArray * ycoords , vtkDataArray * zcoords , vtkPointData * pointData ) ; *
...
##  \param gridID the ID of the grid.
##  \param grid pointer to data-structure where to store the output.
##  void GetOutputRectilinearGrid ( const int gridID , vtkRectilinearGrid * grid ) ; protected : vtkStructuredImplicitConnectivity ( ) ; virtual ~ vtkStructuredImplicitConnectivity ( ) ; void SetController ( vtkMPIController * ) ; vtkMPIController * Controller ; vtk :: detail :: DomainMetaData * DomainInfo ; vtk :: detail :: StructuredGrid * InputGrid ; vtk :: detail :: StructuredGrid * OutputGrid ; vtk :: detail :: CommunicationManager * CommManager ; *
...
##  void ExchangeExtents ( ) ; private : vtkStructuredImplicitConnectivity ( const vtkStructuredImplicitConnectivity & ) = delete ; void operator = ( const vtkStructuredImplicitConnectivity & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
