...
## !!!Ignored construct:  # vtkUniformGrid_h [NewLine] # vtkUniformGrid_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkImageData.h [NewLine] class vtkEmptyCell ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkStructuredVisibilityConstraint"
discard "forward decl of vtkUnsignedCharArray"
discard "forward decl of vtkAMRBox"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkUniformGrid : public vtkImageData { public : /@{ *
##  Construct an empty uniform grid.
##  static vtkUniformGrid * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkImageData Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkImageData :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkUniformGrid :: IsTypeOf ( type ) ; } static vtkUniformGrid * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkUniformGrid * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkUniformGrid * NewInstance ( ) const { return vtkUniformGrid :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkImageData :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkUniformGrid :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkUniformGrid :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  vtkCell * GetCell ( int i , int j , int k ) override ; vtkCell * GetCell ( vtkIdType cellId ) override ; void GetCell ( vtkIdType cellId , vtkGenericCell * cell ) override ; vtkIdType FindCell ( double x [ 3 ] , vtkCell * cell , vtkIdType cellId , double tol2 , int & subId , double pcoords [ 3 ] , double * weights ) override ; vtkIdType FindCell ( double x [ 3 ] , vtkCell * cell , vtkGenericCell * gencell , vtkIdType cellId , double tol2 , int & subId , double pcoords [ 3 ] , double * weights ) override ; vtkCell * FindAndGetCell ( double x [ 3 ] , vtkCell * cell , vtkIdType cellId , double tol2 , int & subId , double pcoords [ 3 ] , double * weights ) override ; int GetCellType ( vtkIdType cellId ) override ; using vtkDataSet :: GetCellPoints ; void GetCellPoints ( vtkIdType cellId , vtkIdList * ptIds ) override { vtkStructuredData :: GetCellPoints ( cellId , ptIds , this -> GetDataDescription ( ) , this -> GetDimensions ( ) ) ; } void GetPointCells ( vtkIdType ptId , vtkIdList * cellIds ) override { vtkStructuredData :: GetPointCells ( ptId , cellIds , this -> GetDimensions ( ) ) ; } void Initialize ( ) override ; int GetMaxCellSize ( ) override { return 8 ; }  voxel is the largest /@} *
...
##  grid are set.
##  virtual void BlankPoint ( vtkIdType ptId ) ; virtual void UnBlankPoint ( vtkIdType ptId ) ; virtual void BlankPoint ( const int i , const int j , const int k ) ; virtual void UnBlankPoint ( const int i , const int j , const int k ) ; /@} /@{ *
##  Methods for supporting blanking of cells. Blanking turns on or off
##  cells in the structured grid.
##  These methods should be called only after the dimensions of the
##  grid are set.
##  virtual void BlankCell ( vtkIdType ptId ) ; virtual void UnBlankCell ( vtkIdType ptId ) ; virtual void BlankCell ( const int i , const int j , const int k ) ; virtual void UnBlankCell ( const int i , const int j , const int k ) ; /@} *
...
##  These methods should be called only after the dimensions of the
##  grid are set.
##  virtual unsigned char IsCellVisible ( vtkIdType cellId ) ; virtual vtkImageData * NewImageDataCopy ( ) ; /@{ *
##  Retrieve an instance of this class from an information object.
##  static vtkUniformGrid * GetData ( vtkInformation * info ) ; static vtkUniformGrid * GetData ( vtkInformationVector * v , int i = 0 ) ; /@} protected : vtkUniformGrid ( ) ; ~ vtkUniformGrid ( ) override ; *
##  Returns the cell dimensions for this vtkUniformGrid instance.
##  void GetCellDims ( int cellDims [ 3 ] ) ; *
##  Override this method because of blanking.
##  void ComputeScalarRange ( ) override ; vtkEmptyCell * GetEmptyCell ( ) ; private : vtkUniformGrid ( const vtkUniformGrid & ) = delete ; void operator = ( const vtkUniformGrid & ) = delete ; vtkEmptyCell * EmptyCell ; static unsigned char MASKED_CELL_VALUE ; } ;
## Error: token expected: ; but got: [identifier]!!!
