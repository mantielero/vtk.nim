...
## !!!Ignored construct:  # vtkXMLUtilities_h [NewLine] # vtkXMLUtilities_h [NewLine] # vtkIOXMLParserModule.h  For export macro # vtkObject.h [NewLine] class vtkXMLDataElement ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKIOXMLPARSER_EXPORT vtkXMLUtilities : public vtkObject { public : static vtkXMLUtilities * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkXMLUtilities :: IsTypeOf ( type ) ; } static vtkXMLUtilities * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkXMLUtilities * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkXMLUtilities * NewInstance ( ) const { return vtkXMLUtilities :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkXMLUtilities :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkXMLUtilities :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  VTK_NEWINSTANCE static vtkXMLDataElement * ReadElementFromStream ( istream & , int encoding = VTK_ENCODING_NONE ) ; VTK_NEWINSTANCE static vtkXMLDataElement * ReadElementFromString ( const char * str , int encoding = VTK_ENCODING_NONE ) ; VTK_NEWINSTANCE static vtkXMLDataElement * ReadElementFromFile ( VTK_FILEPATH const char * filename , int encoding = VTK_ENCODING_NONE ) ; /@} *
...
##  static void FactorElements ( vtkXMLDataElement * tree ) ; static void UnFactorElements ( vtkXMLDataElement * tree ) ; /@} protected : vtkXMLUtilities ( ) = default ; ~ vtkXMLUtilities ( ) override = default ; static int FactorElementsInternal ( vtkXMLDataElement * tree , vtkXMLDataElement * root , vtkXMLDataElement * pool ) ; static int UnFactorElementsInternal ( vtkXMLDataElement * tree , vtkXMLDataElement * pool ) ; private : vtkXMLUtilities ( const vtkXMLUtilities & ) = delete ; void operator = ( const vtkXMLUtilities & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
