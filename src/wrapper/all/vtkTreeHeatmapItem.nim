...
## !!!Ignored construct:  # vtkTreeHeatmapItem_h [NewLine] # vtkTreeHeatmapItem_h [NewLine] # vtkContextItem.h [NewLine] # vtkViewsInfovisModule.h  For export macro [NewLine] # vtkNew.h  For vtkNew ivars # vtkSmartPointer.h  For vtkSmartPointer ivars # < map >  For string lookup tables # < vector >  For lookup tables [NewLine] class vtkDendrogramItem ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkHeatmapItem"
discard "forward decl of vtkTable"
discard "forward decl of vtkTree"
## !!!Ignored construct:  class VTKVIEWSINFOVIS_EXPORT vtkTreeHeatmapItem : public vtkContextItem { public : static vtkTreeHeatmapItem * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkContextItem Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkContextItem :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkTreeHeatmapItem :: IsTypeOf ( type ) ; } static vtkTreeHeatmapItem * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkTreeHeatmapItem * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkTreeHeatmapItem * NewInstance ( ) const { return vtkTreeHeatmapItem :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkContextItem :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkTreeHeatmapItem :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkTreeHeatmapItem :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
...
##  vtkDendrogramItem * GetDendrogram ( ) ; void SetDendrogram ( vtkDendrogramItem * dendrogram ) ; /@} /@{ *
##  Get/Set the heatmap contained by this item.
##  vtkHeatmapItem * GetHeatmap ( ) ; void SetHeatmap ( vtkHeatmapItem * heatmap ) ; /@} *
...
##  bool MouseDoubleClickEvent ( const vtkContextMouseEvent & event ) override ; protected : vtkTreeHeatmapItem ( ) ; ~ vtkTreeHeatmapItem ( ) override ; *
...
##  void CollapseHeatmapColumns ( ) ; vtkSmartPointer < vtkDendrogramItem > Dendrogram ; vtkSmartPointer < vtkDendrogramItem > ColumnDendrogram ; vtkSmartPointer < vtkHeatmapItem > Heatmap ; int Orientation ; private : vtkTreeHeatmapItem ( const vtkTreeHeatmapItem & ) = delete ; void operator = ( const vtkTreeHeatmapItem & ) = delete ; vtkMTimeType TreeHeatmapBuildTime ; } ;
## Error: token expected: ; but got: [identifier]!!!
