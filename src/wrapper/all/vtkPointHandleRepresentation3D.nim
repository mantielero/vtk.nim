...
## !!!Ignored construct:  # vtkPointHandleRepresentation3D_h [NewLine] # vtkPointHandleRepresentation3D_h [NewLine] # vtkCursor3D.h  Needed for delegation to cursor3D # vtkHandleRepresentation.h [NewLine] # vtkInteractionWidgetsModule.h  For export macro [NewLine] class vtkCursor3D ;
...
## !!!Ignored construct:  class VTKINTERACTIONWIDGETS_EXPORT vtkPointHandleRepresentation3D : public vtkHandleRepresentation { public : *
##  Instantiate this class.
##  static vtkPointHandleRepresentation3D * New ( ) ; /@{ *
##  Standard methods for instances of this class.
##  protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkHandleRepresentation Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkHandleRepresentation :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPointHandleRepresentation3D :: IsTypeOf ( type ) ; } static vtkPointHandleRepresentation3D * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPointHandleRepresentation3D * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPointHandleRepresentation3D * NewInstance ( ) const { return vtkPointHandleRepresentation3D :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkHandleRepresentation :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPointHandleRepresentation3D :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPointHandleRepresentation3D :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} using vtkHandleRepresentation :: Translate ; /@{ *
...
##  void SetTranslationMode ( vtkTypeBool mode ) ; virtual vtkTypeBool GetTranslationMode ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << TranslationMode  of  << this -> TranslationMode ) ; return this -> TranslationMode ; } ; virtual void TranslationModeOn ( ) { this -> SetTranslationMode ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void TranslationModeOff ( ) { this -> SetTranslationMode ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  virtual void SetSmoothMotion ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  SmoothMotion  to  << _arg ) ; if ( this -> SmoothMotion != _arg ) { this -> SmoothMotion = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetTranslationModeHotSpotSizeSmoothMotion ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << SmoothMotion  of  << this -> SmoothMotion ) ; return this -> SmoothMotion ; } ; virtual void SmoothMotionOn ( ) { this -> SetTranslationModeSmoothMotion ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void SmoothMotionOff ( ) { this -> SetTranslationModeSmoothMotion ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@}
...
##  void SetVisibility ( vtkTypeBool visible ) override ; protected : vtkPointHandleRepresentation3D ( ) ; ~ vtkPointHandleRepresentation3D ( ) override ;  the cursor3D vtkActor * Actor ; vtkPolyDataMapper * Mapper ; vtkCursor3D * Cursor3D ;  Do the picking vtkCellPicker * CursorPicker ; double LastPickPosition [ 3 ] ; double LastEventPosition [ 3 ] ;  Methods to manipulate the cursor int ConstraintAxis ; void Translate ( const double * p1 , const double * p2 ) override ; void Scale ( const double * p1 , const double * p2 , const double eventPos [ 2 ] ) ; void MoveFocus ( const double * p1 , const double * p2 ) ; void SizeBounds ( ) ; *
