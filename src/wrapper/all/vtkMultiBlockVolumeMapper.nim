...
## !!!Ignored construct:  # vtkMultiBlockVolumeMapper_h [NewLine] # vtkMultiBlockVolumeMapper_h [NewLine] # < vector >  For DataBlocks [NewLine] # vtkNew.h  for ivar # vtkRenderingVolumeOpenGL2Module.h  For export macro # vtkVolumeMapper.h [NewLine] class vtkDataObjectTree ;
...
## !!!Ignored construct:  class VTKRENDERINGVOLUMEOPENGL2_EXPORT vtkMultiBlockVolumeMapper : public vtkVolumeMapper { public : static vtkMultiBlockVolumeMapper * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkVolumeMapper Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkVolumeMapper :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkMultiBlockVolumeMapper :: IsTypeOf ( type ) ; } static vtkMultiBlockVolumeMapper * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkMultiBlockVolumeMapper * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkMultiBlockVolumeMapper * NewInstance ( ) const { return vtkMultiBlockVolumeMapper :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkVolumeMapper :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkMultiBlockVolumeMapper :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkMultiBlockVolumeMapper :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
##   \brief API Superclass
##   \sa vtkAbstractVolumeMapper
##  double * GetBounds ( ) override ; using vtkAbstractVolumeMapper :: GetBounds ; void SelectScalarArray ( int arrayNum ) override ; void SelectScalarArray ( char const * arrayName ) override ; void SetScalarMode ( int ScalarMode ) override ; void SetArrayAccessMode ( int accessMode ) override ; *
...
##  void SetVectorMode ( int mode ) ; virtual int GetVectorMode ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << VectorMode  of  << this -> VectorMode ) ; return this -> VectorMode ; } ; void SetVectorComponent ( int component ) ; virtual int GetVectorModeVectorComponent ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << VectorComponent  of  << this -> VectorComponent ) ; return this -> VectorComponent ; } ; /@} /@{ *
...
##  void SetGlobalIlluminationReach ( float val ) ; virtual float GetVectorModeVectorComponentGlobalIlluminationReach ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << GlobalIlluminationReach  of  << this -> GlobalIlluminationReach ) ; return this -> GlobalIlluminationReach ; } ; /@} /@{ *
##  @copydoc vtkSmartVolumeMapper::SetVolumetricScatteringBlending(float)
##  void SetVolumetricScatteringBlending ( float val ) ; virtual float GetVectorModeVectorComponentGlobalIlluminationReachVolumetricScatteringBlending ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << VolumetricScatteringBlending  of  << this -> VolumetricScatteringBlending ) ; return this -> VolumetricScatteringBlending ; } ; /@} /@{ *
...
##  void SetCroppingRegionPlanes ( double arg1 , double arg2 , double arg3 , double arg4 , double arg5 , double arg6 ) override ; void SetCroppingRegionPlanes ( const double * planes ) override ; *
...
##  void SetTransfer2DYAxisArray ( const char * a ) ; @} protected : vtkMultiBlockVolumeMapper ( ) ; ~ vtkMultiBlockVolumeMapper ( ) override ; *
...
##  int FillInputPortInformation ( int port , vtkInformation * info ) override ; vtkRenderWindow * DebugWin ; vtkRenderer * DebugRen ; vtkNew < vtkMatrix4x4 > TempMatrix4x4 ; private : *
...
##  data.
##  void CreateMappers ( vtkDataObjectTree * input , vtkRenderer * ren , vtkVolume * vol ) ; vtkDataObjectTree * GetDataObjectTreeInput ( ) ; *
##  Compute the bounds enclosing all of the blocks in the dataset.
##  void ComputeBounds ( ) ; *
##  Sort loaded vtkImageData blocks back-to-front.
##  void SortMappers ( vtkRenderer * ren , vtkMatrix4x4 * volumeMat ) ; void ClearMappers ( ) ; *
##  Create and setup a proxy rendering-mapper with the current flags.
##  vtkSmartVolumeMapper * CreateMapper ( ) ; vtkMultiBlockVolumeMapper ( const vtkMultiBlockVolumeMapper & ) = delete ; void operator = ( const vtkMultiBlockVolumeMapper & ) = delete ; /////////////////////////////////////////////////////////////////////////// typedef std :: vector < vtkSmartVolumeMapper * > MapperVec ; MapperVec Mappers ; vtkSmartVolumeMapper * FallBackMapper ; vtkMTimeType BlockLoadingTime ; vtkMTimeType BoundsComputeTime ; int VectorMode ; int VectorComponent ; int RequestedRenderMode ; *
...
##  float VolumetricScatteringBlending = 0.0 ; char * Transfer2DYAxisArray ; } ;
## Error: token expected: ; but got: [identifier]!!!
