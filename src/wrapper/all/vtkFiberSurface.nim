...
import
  vtkFiltersTopologyModule, vtkPolyDataAlgorithm

type
  vtkFiberSurface* {.importcpp: "vtkFiberSurface", header: "vtkFiberSurface.h",
                    bycopy.} = object of vtkPolyDataAlgorithm
    vtkFiberSurface* {.importc: "vtkFiberSurface".}: VTK_NEWINSTANCE


proc New*(): ptr vtkFiberSurface {.importcpp: "vtkFiberSurface::New(@)",
                               header: "vtkFiberSurface.h".}
type
  vtkFiberSurfaceSuperclass* = vtkPolyDataAlgorithm

proc IsTypeOf*(`type`: cstring): vtkTypeBool {.
    importcpp: "vtkFiberSurface::IsTypeOf(@)", header: "vtkFiberSurface.h".}
proc IsA*(this: var vtkFiberSurface; `type`: cstring): vtkTypeBool {.importcpp: "IsA",
    header: "vtkFiberSurface.h".}
proc SafeDownCast*(o: ptr vtkObjectBase): ptr vtkFiberSurface {.
    importcpp: "vtkFiberSurface::SafeDownCast(@)", header: "vtkFiberSurface.h".}
## !!!Ignored construct:  * NewInstance ( ) const { return vtkFiberSurface :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPolyDataAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkFiberSurface :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkFiberSurface :: New ( ) ; } public : ;
## Error: identifier expected, but got: *!!!

proc PrintSelf*(this: var vtkFiberSurface; os: var ostream; indent: vtkIndent) {.
    importcpp: "PrintSelf", header: "vtkFiberSurface.h".}
proc SetField1*(this: var vtkFiberSurface; fieldName: cstring) {.
    importcpp: "SetField1", header: "vtkFiberSurface.h".}
proc SetField2*(this: var vtkFiberSurface; fieldName: cstring) {.
    importcpp: "SetField2", header: "vtkFiberSurface.h".}
type
  vtkFiberSurfaceBaseVertexType* {.size: sizeof(cint),
                                  importcpp: "vtkFiberSurface::BaseVertexType",
                                  header: "vtkFiberSurface.h".} = enum
    bv_not_used, bv_vertex_0, bv_vertex_1, bv_vertex_2, bv_vertex_3, bv_edge_01,
    bv_edge_02, bv_edge_03, bv_edge_12, bv_edge_13, bv_edge_23


type
  vtkFiberSurfaceClipVertexType* {.size: sizeof(cint),
                                  importcpp: "vtkFiberSurface::ClipVertexType",
                                  header: "vtkFiberSurface.h".} = enum
    not_used, vertex_0, vertex_1, vertex_2, edge_0_parm_0, edge_1_parm_0,
    edge_2_parm_0, edge_0_parm_1, edge_1_parm_1, edge_2_parm_1
