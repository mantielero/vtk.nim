...
## !!!Ignored construct:  # vtkFitToHeightMapFilter_h [NewLine] # vtkFitToHeightMapFilter_h [NewLine] # vtkFiltersModelingModule.h  For export macro # vtkPolyDataAlgorithm.h [NewLine] class vtkImageData ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKFILTERSMODELING_EXPORT vtkFitToHeightMapFilter : public vtkPolyDataAlgorithm { public : /@{ *
##  Standard methods for construction, type and printing.
##  static vtkFitToHeightMapFilter * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkPolyDataAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkPolyDataAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkFitToHeightMapFilter :: IsTypeOf ( type ) ; } static vtkFitToHeightMapFilter * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkFitToHeightMapFilter * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkFitToHeightMapFilter * NewInstance ( ) const { return vtkFitToHeightMapFilter :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkPolyDataAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkFitToHeightMapFilter :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkFitToHeightMapFilter :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@} *
...
##  vtkImageData * GetHeightMap ( ) ; vtkImageData * GetHeightMap ( vtkInformationVector * sourceInfo ) ; /@}  Strategies to fit the polydata. enum FittingStrategy { POINT_PROJECTION = 0 , POINT_MINIMUM_HEIGHT = 1 , POINT_MAXIMUM_HEIGHT = 2 , POINT_AVERAGE_HEIGHT = 3 , CELL_MINIMUM_HEIGHT = 4 , CELL_MAXIMUM_HEIGHT = 5 , CELL_AVERAGE_HEIGHT = 6 , } ; /@{ *
...
##  virtual void SetFittingStrategy ( int _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  FittingStrategy  to  << _arg ) ; if ( this -> FittingStrategy != _arg ) { this -> FittingStrategy = _arg ; this -> Modified ( ) ; } } ; virtual int GetFittingStrategy ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << FittingStrategy  of  << this -> FittingStrategy ) ; return this -> FittingStrategy ; } ; void SetFittingStrategyToPointProjection ( ) { this -> SetFittingStrategy ( POINT_PROJECTION ) ; } void SetFittingStrategyToPointMinimumHeight ( ) { this -> SetFittingStrategy ( POINT_MINIMUM_HEIGHT ) ; } void SetFittingStrategyToPointMaximumHeight ( ) { this -> SetFittingStrategy ( POINT_MAXIMUM_HEIGHT ) ; } void SetFittingStrategyToAverageHeight ( ) { this -> SetFittingStrategy ( POINT_AVERAGE_HEIGHT ) ; } void SetFittingStrategyToCellMinimumHeight ( ) { this -> SetFittingStrategy ( CELL_MINIMUM_HEIGHT ) ; } void SetFittingStrategyToCellMaximumHeight ( ) { this -> SetFittingStrategy ( CELL_MAXIMUM_HEIGHT ) ; } void SetFittingStrategyToCellAverageHeight ( ) { this -> SetFittingStrategy ( CELL_AVERAGE_HEIGHT ) ; } /@} /@{ *
...
##  true.
##  virtual void SetFittingStrategyUseHeightMapOffset ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  UseHeightMapOffset  to  << _arg ) ; if ( this -> UseHeightMapOffset != _arg ) { this -> UseHeightMapOffset = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetFittingStrategyUseHeightMapOffset ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << UseHeightMapOffset  of  << this -> UseHeightMapOffset ) ; return this -> UseHeightMapOffset ; } ; virtual void UseHeightMapOffsetOn ( ) { this -> SetUseHeightMapOffset ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void UseHeightMapOffsetOff ( ) { this -> SetUseHeightMapOffset ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} protected : vtkFitToHeightMapFilter ( ) ; ~ vtkFitToHeightMapFilter ( ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int FillInputPortInformation ( int , vtkInformation * ) override ; int FittingStrategy ; vtkTypeBool UseHeightMapOffset ; double Offset ; void AdjustPoints ( vtkPolyData * output , vtkIdType numCells , vtkPoints * newPts ) ; void AdjustCells ( vtkPolyData * output , vtkIdType numCells , double * cellHts , vtkPoints * inPts , vtkPoints * newPts ) ; private : vtkFitToHeightMapFilter ( const vtkFitToHeightMapFilter & ) = delete ; void operator = ( const vtkFitToHeightMapFilter & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
