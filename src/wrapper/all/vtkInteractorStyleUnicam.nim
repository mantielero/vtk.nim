...
## !!!Ignored construct:  # vtkInteractorStyleUnicam_h [NewLine] # vtkInteractorStyleUnicam_h [NewLine] # vtkInteractionStyleModule.h  For export macro # vtkInteractorStyle.h [NewLine] class vtkCamera ;
