...
## !!!Ignored construct:  # vtkHyperTreeGridOrientedGeometryCursor_h [NewLine] # vtkHyperTreeGridOrientedGeometryCursor_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkHyperTreeGridGeometryEntry.h  Used internally # vtkHyperTreeGridTools.h  for HasTree # vtkObject.h [NewLine] # < memory >  For std::shared_ptr # < vector >  For std::vector [NewLine] class vtkHyperTree ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkHyperTreeGrid"
discard "forward decl of vtkHyperTreeGridScales"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkHyperTreeGridOrientedGeometryCursor : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkHyperTreeGridOrientedGeometryCursor :: IsTypeOf ( type ) ; } static vtkHyperTreeGridOrientedGeometryCursor * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkHyperTreeGridOrientedGeometryCursor * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkHyperTreeGridOrientedGeometryCursor * NewInstance ( ) const { return vtkHyperTreeGridOrientedGeometryCursor :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkHyperTreeGridOrientedGeometryCursor :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkHyperTreeGridOrientedGeometryCursor :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkHyperTreeGridOrientedGeometryCursor * New ( ) ; void Dump ( ostream & os ) ; *
...
##  JB
##  void GetBounds ( double bounds [ 6 ] ) ; void GetPoint ( double point [ 3 ] ) ; *
...
##  JB
##  unsigned int Level ;  Hyper tree grid to which the cursor is attached vtkHyperTreeGridGeometryEntry Entry ; private : vtkHyperTreeGridOrientedGeometryCursor ( const vtkHyperTreeGridOrientedGeometryCursor & ) = delete ; void operator = ( const vtkHyperTreeGridOrientedGeometryCursor & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
