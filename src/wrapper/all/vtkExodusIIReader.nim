...
## !!!Ignored construct:  # vtkExodusIIReader_h [NewLine] # vtkExodusIIReader_h [NewLine] # vtkIOExodusModule.h  For export macro # vtkMultiBlockDataSetAlgorithm.h [NewLine] class vtkDataArray ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkDataSet"
discard "forward decl of vtkExodusIICache"
discard "forward decl of vtkExodusIIReaderPrivate"
...
## !!!Ignored construct:  class VTKIOEXODUS_EXPORT vtkExodusIIReader : public vtkMultiBlockDataSetAlgorithm { public : static vtkExodusIIReader * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkMultiBlockDataSetAlgorithm Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkMultiBlockDataSetAlgorithm :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkExodusIIReader :: IsTypeOf ( type ) ; } static vtkExodusIIReader * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkExodusIIReader * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkExodusIIReader * NewInstance ( ) const { return vtkExodusIIReader :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkMultiBlockDataSetAlgorithm :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkExodusIIReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkExodusIIReader :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Determine if the file can be read with this reader.
##  virtual int CanReadFile ( VTK_FILEPATH const char * fname ) ;  virtual void Modified(); *
...
##  virtual void SetFileName ( VTK_FILEPATH const char * fname ) ; virtual VTK_FILEPATH VTK_FUTURE_CONST char * GetFileName ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << FileName  of  << ( this -> FileName ? this -> FileName : (null) ) ) ; return this -> FileName ; } ; /@} /@{ *
##  Specify file name of the xml file.
##  virtual void SetXMLFileName ( VTK_FILEPATH const char * fname ) ; virtual VTK_FILEPATH VTK_FUTURE_CONST char * GetFileNameXMLFileName ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << XMLFileName  of  << ( this -> XMLFileName ? this -> XMLFileName : (null) ) ) ; return this -> XMLFileName ; } ; /@} /@{ *
...
##  virtual int * GetModeShapesRangeTimeStepRange ( ) VTK_SIZEHINT ( 2 ) { vtkDebugWithObjectMacro ( this , <<  returning  << TimeStepRange  pointer  << this -> TimeStepRange ) ; return this -> TimeStepRange ; } VTK_WRAPEXCLUDE virtual void GetModeShapesRangeTimeStepRange ( int & _arg1 , int & _arg2 ) { _arg1 = this -> TimeStepRange [ 0 ] ; _arg2 = this -> TimeStepRange [ 1 ] ; vtkDebugWithObjectMacro ( this , <<  returning  << TimeStepRange  = ( << _arg1 << , << _arg2 << ) ) ; } VTK_WRAPEXCLUDE virtual void GetModeShapesRangeTimeStepRange ( int _arg [ 2 ] ) { this -> GetModeShapesRangeTimeStepRange ( _arg [ 0 ] , _arg [ 1 ] ) ; } ; /@} /@{ *
...
##  virtual void SetGenerateObjectIdCellArray ( vtkTypeBool g ) ; vtkTypeBool GetGenerateObjectIdCellArray ( ) ; virtual void GenerateObjectIdCellArrayOn ( ) { this -> SetGenerateObjectIdCellArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void GenerateObjectIdCellArrayOff ( ) { this -> SetGenerateObjectIdCellArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; static const char * GetObjectIdArrayName ( ) { return ObjectId ; } /@} virtual void SetGenerateGlobalElementIdArray ( vtkTypeBool g ) ; vtkTypeBool GetGenerateGlobalElementIdArray ( ) ; virtual void GenerateGlobalElementIdArrayOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void GenerateGlobalElementIdArrayOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; virtual void SetGenerateGlobalNodeIdArray ( vtkTypeBool g ) ; vtkTypeBool GetGenerateGlobalNodeIdArray ( ) ; virtual void GenerateGlobalNodeIdArrayOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void GenerateGlobalNodeIdArrayOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; virtual void SetGenerateImplicitElementIdArray ( vtkTypeBool g ) ; vtkTypeBool GetGenerateImplicitElementIdArray ( ) ; virtual void GenerateImplicitElementIdArrayOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void GenerateImplicitElementIdArrayOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; virtual void SetGenerateImplicitNodeIdArray ( vtkTypeBool g ) ; vtkTypeBool GetGenerateImplicitNodeIdArray ( ) ; virtual void GenerateImplicitNodeIdArrayOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void GenerateImplicitNodeIdArrayOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; virtual void SetGenerateFileIdArray ( vtkTypeBool f ) ; vtkTypeBool GetGenerateFileIdArray ( ) ; virtual void GenerateFileIdArrayOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArray ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void GenerateFileIdArrayOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArray ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; virtual void SetFileId ( int f ) ; int GetFileId ( ) ; /@{ *
##  Extra cell data array that can be generated.  By default, this array
...
##  virtual void SetApplyDisplacements ( vtkTypeBool d ) ; vtkTypeBool GetApplyDisplacements ( ) ; virtual void ApplyDisplacementsOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacements ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void ApplyDisplacementsOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacements ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; virtual void SetDisplacementMagnitude ( float s ) ; float GetDisplacementMagnitude ( ) ; /@} /@{ *
...
##  virtual void SetHasModeShapes ( vtkTypeBool ms ) ; vtkTypeBool GetHasModeShapes ( ) ; virtual void HasModeShapesOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapes ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void HasModeShapesOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapes ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  virtual void SetModeShapeTime ( double phase ) ; double GetModeShapeTime ( ) ; /@} /@{ *
...
##  virtual void SetAnimateModeShapes ( vtkTypeBool flag ) ; vtkTypeBool GetAnimateModeShapes ( ) ; virtual void AnimateModeShapesOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapesAnimateModeShapes ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void AnimateModeShapesOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapesAnimateModeShapes ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  virtual void SetIgnoreFileTime ( bool flag ) ; bool GetIgnoreFileTime ( ) ; virtual void IgnoreFileTimeOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapesAnimateModeShapesIgnoreFileTime ( static_cast < bool > ( 1 ) ) ; } virtual void IgnoreFileTimeOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapesAnimateModeShapesIgnoreFileTime ( static_cast < bool > ( 0 ) ) ; } ; /@} /@{ *
##  Access to meta data generated by UpdateInformation.
##  const char * GetTitle ( ) ; int GetDimensionality ( ) ; int GetNumberOfTimeSteps ( ) ; /@} int GetNumberOfNodesInFile ( ) ; int GetNumberOfEdgesInFile ( ) ; int GetNumberOfFacesInFile ( ) ; int GetNumberOfElementsInFile ( ) ; int GetObjectTypeFromName ( const char * name ) ; const char * GetObjectTypeName ( int ) ; int GetNumberOfNodes ( ) ; int GetNumberOfObjects ( int objectType ) ; int GetNumberOfEntriesInObject ( int objectType , int objectIndex ) ; int GetObjectId ( int objectType , int objectIndex ) ; const char * GetObjectName ( int objectType , int objectIndex ) ; using Superclass :: GetObjectName ; int GetObjectIndex ( int objectType , const char * objectName ) ; int GetObjectIndex ( int objectType , int id ) ; int GetObjectStatus ( int objectType , int objectIndex ) ; int GetObjectStatus ( int objectType , const char * objectName ) { return this -> GetObjectStatus ( objectType , this -> GetObjectIndex ( objectType , objectName ) ) ; } void SetObjectStatus ( int objectType , int objectIndex , int status ) ; void SetObjectStatus ( int objectType , const char * objectName , int status ) ; /@{ *
...
##  (Developer Note) This meta data is all accessed through vtkExodusMetadata
##  int GetNumberOfObjectAttributes ( int objectType , int objectIndex ) ; const char * GetObjectAttributeName ( int objectType , int objectIndex , int attribIndex ) ; int GetObjectAttributeIndex ( int objectType , int objectIndex , const char * attribName ) ; int GetObjectAttributeStatus ( int objectType , int objectIndex , int attribIndex ) ; int GetObjectAttributeStatus ( int objectType , int objectIndex , const char * attribName ) { return this -> GetObjectAttributeStatus ( objectType , objectIndex , this -> GetObjectAttributeIndex ( objectType , objectIndex , attribName ) ) ; } void SetObjectAttributeStatus ( int objectType , int objectIndex , int attribIndex , int status ) ; void SetObjectAttributeStatus ( int objectType , int objectIndex , const char * attribName , int status ) { this -> SetObjectAttributeStatus ( objectType , objectIndex , this -> GetObjectAttributeIndex ( objectType , objectIndex , attribName ) , status ) ; } /@} virtual vtkIdType GetTotalNumberOfNodes ( ) ; virtual vtkIdType GetTotalNumberOfEdges ( ) ; virtual vtkIdType GetTotalNumberOfFaces ( ) ; virtual vtkIdType GetTotalNumberOfElements ( ) ; /@{ *
...
##  int GetNumberOfPartArrays ( ) ; const char * GetPartArrayName ( int arrayIdx ) ; int GetPartArrayID ( const char * name ) ; const char * GetPartBlockInfo ( int arrayIdx ) ; void SetPartArrayStatus ( int index , int flag ) ; void SetPartArrayStatus ( const char * , int flag ) ; int GetPartArrayStatus ( int index ) ; int GetPartArrayStatus ( const char * ) ; /@} /@{ *
...
##  int GetNumberOfMaterialArrays ( ) ; const char * GetMaterialArrayName ( int arrayIdx ) ; int GetMaterialArrayID ( const char * name ) ; void SetMaterialArrayStatus ( int index , int flag ) ; void SetMaterialArrayStatus ( const char * , int flag ) ; int GetMaterialArrayStatus ( int index ) ; int GetMaterialArrayStatus ( const char * ) ; /@} /@{ *
...
##  int GetNumberOfAssemblyArrays ( ) ; const char * GetAssemblyArrayName ( int arrayIdx ) ; int GetAssemblyArrayID ( const char * name ) ; void SetAssemblyArrayStatus ( int index , int flag ) ; void SetAssemblyArrayStatus ( const char * , int flag ) ; int GetAssemblyArrayStatus ( int index ) ; int GetAssemblyArrayStatus ( const char * ) ; /@} /@{ *
...
##  void SetSqueezePoints ( bool sp ) ; bool GetSqueezePoints ( ) ; /@} virtual void Dump ( ) ; *
##  SIL describes organization of/relationships between classifications
##  eg. blocks/materials/hierarchies.
##  vtkGraph * GetSIL ( ) ; /@{ *
##  Every time the SIL is updated a this will return a different value.
##  virtual int GetTimeStepDisplayTypeSILUpdateStamp ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << SILUpdateStamp  of  << this -> SILUpdateStamp ) ; return this -> SILUpdateStamp ; } ; /@} /@{ *
...
##  static vtkInformationIntegerKey * GLOBAL_VARIABLE ( ) ; static vtkInformationIntegerKey * GLOBAL_TEMPORAL_VARIABLE ( ) ; /@} /@{ *
...
##  virtual void SetTimeStepUseLegacyBlockNames ( bool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  UseLegacyBlockNames  to  << _arg ) ; if ( this -> UseLegacyBlockNames != _arg ) { this -> UseLegacyBlockNames = _arg ; this -> Modified ( ) ; } } ; virtual bool GetTimeStepDisplayTypeSILUpdateStampUseLegacyBlockNames ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << UseLegacyBlockNames  of  << this -> UseLegacyBlockNames ) ; return this -> UseLegacyBlockNames ; } ; virtual void UseLegacyBlockNamesOn ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapesAnimateModeShapesIgnoreFileTimeUseLegacyBlockNames ( static_cast < bool > ( 1 ) ) ; } virtual void UseLegacyBlockNamesOff ( ) { this -> SetGenerateObjectIdCellArrayGenerateGlobalElementIdArrayGenerateGlobalNodeIdArrayGenerateImplicitElementIdArrayGenerateImplicitNodeIdArrayGenerateFileIdArrayApplyDisplacementsHasModeShapesAnimateModeShapesIgnoreFileTimeUseLegacyBlockNames ( static_cast < bool > ( 0 ) ) ; } ; /@} protected : vtkExodusIIReader ( ) ; ~ vtkExodusIIReader ( ) override ;  helper for finding IDs static int GetIDHelper ( const char * arrayName , vtkDataSet * data , int localID , int searchType ) ; static int GetGlobalID ( const char * arrayName , vtkDataSet * data , int localID , int searchType ) ; virtual void SetMetadata ( vtkExodusIIReaderPrivate * ) ; virtual vtkExodusIIReaderPrivate * GetnameMetadata ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Metadata  address  << static_cast < vtkExodusIIReaderPrivate * > ( this -> Metadata ) ) ; return this -> Metadata ; } ; *
##  Returns true if the file given by XMLFileName exists.
##  Return true if found, false otherwise
##  bool FindXMLFile ( ) ;  Time query function. Called by ExecuteInformation().
##  Fills the TimestepValues array. void GetAllTimes ( vtkInformationVector * ) ; *
##  Populates the TIME_STEPS and TIME_RANGE keys based on file metadata.
##  void AdvertiseTimeSteps ( vtkInformation * outputInfo ) ; vtkTypeBool ProcessRequest ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestInformation ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ;  int RequestDataOverTime( vtkInformation *, vtkInformationVector **, vtkInformationVector *);  Parameters for controlling what is read in. char * FileName ; char * XMLFileName ; int TimeStep ; int TimeStepRange [ 2 ] ; vtkTimeStamp FileNameMTime ; vtkTimeStamp XMLFileNameMTime ;  Information specific for exodus files.  1=display Block names
##  2=display Part names
##  3=display Material names int DisplayType ;  Metadata containing a description of the currently open file. vtkExodusIIReaderPrivate * Metadata ; int SILUpdateStamp ; friend class vtkPExodusIIReader ; private : vtkExodusIIReader ( const vtkExodusIIReader & ) = delete ; void operator = ( const vtkExodusIIReader & ) = delete ; void AddDisplacements ( vtkUnstructuredGrid * output ) ; int ModeShapesRange [ 2 ] ; bool UseLegacyBlockNames ; } ;
## Error: token expected: ; but got: [identifier]!!!
