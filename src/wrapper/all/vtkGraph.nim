...
## !!!Ignored construct:  # vtkGraph_h [NewLine] # vtkGraph_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkDataObject.h [NewLine] class vtkAdjacentVertexIterator ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkCellArray"
discard "forward decl of vtkEdgeListIterator"
discard "forward decl of vtkDataSetAttributes"
discard "forward decl of vtkDirectedGraph"
discard "forward decl of vtkGraphEdge"
discard "forward decl of vtkGraphEdgePoints"
discard "forward decl of vtkDistributedGraphHelper"
discard "forward decl of vtkGraphInternals"
discard "forward decl of vtkIdTypeArray"
discard "forward decl of vtkInEdgeIterator"
discard "forward decl of vtkOutEdgeIterator"
discard "forward decl of vtkPoints"
discard "forward decl of vtkUndirectedGraph"
discard "forward decl of vtkVertexListIterator"
discard "forward decl of vtkVariant"
discard "forward decl of vtkVariantArray"
discard "forward decl of vtk_edge_iterator"
discard "forward decl of vtk_out_edge_pointer_iterator"
discard "forward decl of vtk_in_edge_pointer_iterator"
##  Edge structures.

type
  VTKCOMMONDATAMODEL_EXPORTvtkEdgeBase* {.
      importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkEdgeBase", header: "vtkGraph.h",
      bycopy.} = object
    Id* {.importc: "Id".}: vtkIdType


proc constructVTKCOMMONDATAMODEL_EXPORTvtkEdgeBase*(): VTKCOMMONDATAMODEL_EXPORTvtkEdgeBase {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkEdgeBase(@)",
    header: "vtkGraph.h".}
proc constructVTKCOMMONDATAMODEL_EXPORTvtkEdgeBase*(id: vtkIdType): VTKCOMMONDATAMODEL_EXPORTvtkEdgeBase {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkEdgeBase(@)",
    header: "vtkGraph.h".}
type
  VTKCOMMONDATAMODEL_EXPORTvtkOutEdgeType* {.
      importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkOutEdgeType",
      header: "vtkGraph.h", bycopy.} = object of VTKCOMMONDATAMODEL_EXPORTvtkEdgeBase
    Target* {.importc: "Target".}: vtkIdType


proc constructVTKCOMMONDATAMODEL_EXPORTvtkOutEdgeType*(): VTKCOMMONDATAMODEL_EXPORTvtkOutEdgeType {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkOutEdgeType(@)",
    header: "vtkGraph.h".}
proc constructVTKCOMMONDATAMODEL_EXPORTvtkOutEdgeType*(t: vtkIdType; id: vtkIdType): VTKCOMMONDATAMODEL_EXPORTvtkOutEdgeType {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkOutEdgeType(@)",
    header: "vtkGraph.h".}
type
  VTKCOMMONDATAMODEL_EXPORTvtkInEdgeType* {.
      importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkInEdgeType", header: "vtkGraph.h",
      bycopy.} = object of VTKCOMMONDATAMODEL_EXPORTvtkEdgeBase
    Source* {.importc: "Source".}: vtkIdType


proc constructVTKCOMMONDATAMODEL_EXPORTvtkInEdgeType*(): VTKCOMMONDATAMODEL_EXPORTvtkInEdgeType {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkInEdgeType(@)",
    header: "vtkGraph.h".}
proc constructVTKCOMMONDATAMODEL_EXPORTvtkInEdgeType*(s: vtkIdType; id: vtkIdType): VTKCOMMONDATAMODEL_EXPORTvtkInEdgeType {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkInEdgeType(@)",
    header: "vtkGraph.h".}
type
  VTKCOMMONDATAMODEL_EXPORTvtkEdgeType* {.
      importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkEdgeType", header: "vtkGraph.h",
      bycopy.} = object of VTKCOMMONDATAMODEL_EXPORTvtkEdgeBase
    Source* {.importc: "Source".}: vtkIdType
    Target* {.importc: "Target".}: vtkIdType


proc constructVTKCOMMONDATAMODEL_EXPORTvtkEdgeType*(): VTKCOMMONDATAMODEL_EXPORTvtkEdgeType {.
    constructor, importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkEdgeType(@)",
    header: "vtkGraph.h".}
proc constructVTKCOMMONDATAMODEL_EXPORTvtkEdgeType*(s: vtkIdType; t: vtkIdType;
    id: vtkIdType): VTKCOMMONDATAMODEL_EXPORTvtkEdgeType {.constructor,
    importcpp: "VTKCOMMONDATAMODEL_EXPORT::vtkEdgeType(@)", header: "vtkGraph.h".}
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkGraph : public vtkDataObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkDataObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkDataObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkGraph :: IsTypeOf ( type ) ; } static vtkGraph * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkGraph * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkGraph * NewInstance ( ) const { return vtkGraph :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkDataObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkGraph :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkGraph :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
##  Get the vertex or edge data.
##  virtual vtkDataSetAttributes * GetnameVertexData ( ) { vtkDebugWithObjectMacro ( this , <<  returning  VertexData  address  << static_cast < vtkDataSetAttributes * > ( this -> VertexData ) ) ; return this -> VertexData ; } ; virtual vtkDataSetAttributes * GetnameVertexDataEdgeData ( ) { vtkDebugWithObjectMacro ( this , <<  returning  EdgeData  address  << static_cast < vtkDataSetAttributes * > ( this -> EdgeData ) ) ; return this -> EdgeData ; } ; /@} *
...
##  retrieved.
##  double * GetPoint ( vtkIdType ptId ) ; void GetPoint ( vtkIdType ptId , double x [ 3 ] ) ; /@} /@{ *
...
##  vtkPoints * GetPoints ( ) ; virtual void SetPoints ( vtkPoints * points ) ; /@} *
...
##  computes the bounds around the local part of the graph.
##  double * GetBounds ( ) ; void GetBounds ( double bounds [ 6 ] ) ; /@} *
...
##  static vtkGraph * GetData ( vtkInformation * info ) ; static vtkGraph * GetData ( vtkInformationVector * v , int i = 0 ) ; /@} *
...
##  vtkIdType GetSourceVertex ( vtkIdType e ) ; vtkIdType GetTargetVertex ( vtkIdType e ) ; /@} /@{ *
...
##  void SetEdgePoints ( vtkIdType e , vtkIdType npts , const double pts [ ] ) VTK_SIZEHINT ( pts , 3 * npts ) ; void GetEdgePoints ( vtkIdType e , vtkIdType & npts , double * & pts ) VTK_SIZEHINT ( pts , 3 * npts ) ; /@} *
...
##  overwrites it.
##  void SetEdgePoint ( vtkIdType e , vtkIdType i , const double x [ 3 ] ) ; void SetEdgePoint ( vtkIdType e , vtkIdType i , double x , double y , double z ) { double p [ 3 ] = { x , y , z } ; this -> SetEdgePoint ( e , i , p ) ; } *
##  Adds a point to the end of the list of edge points for a certain edge.
##  void AddEdgePoint ( vtkIdType e , const double x [ 3 ] ) ; void AddEdgePoint ( vtkIdType e , double x , double y , double z ) { double p [ 3 ] = { x , y , z } ; this -> AddEdgePoint ( e , p ) ; } /@{ *
##  Copy the internal edge point data from another graph into this graph.
##  Both graphs must have the same number of edges.
##  void ShallowCopyEdgePoints ( vtkGraph * g ) ; void DeepCopyEdgePoints ( vtkGraph * g ) ; /@} *
...
##  bool ToUndirectedGraph ( vtkUndirectedGraph * g ) ; protected : vtkGraph ( ) ; ~ vtkGraph ( ) override ; *
...
##  void AddEdgeInternal ( vtkIdType u , vtkIdType v , bool directed , vtkVariantArray * propertyArr , vtkEdgeType * edge ) ; void AddEdgeInternal ( const vtkVariant & uPedigree , vtkIdType v , bool directed , vtkVariantArray * propertyArr , vtkEdgeType * edge ) ; void AddEdgeInternal ( vtkIdType u , const vtkVariant & vPedigree , bool directed , vtkVariantArray * propertyArr , vtkEdgeType * edge ) ; void AddEdgeInternal ( const vtkVariant & uPedigree , const vtkVariant & vPedigree , bool directed , vtkVariantArray * propertyArr , vtkEdgeType * edge ) ; /@} *
...
##  virtual void GetOutEdges ( vtkIdType v , const vtkOutEdgeType * & edges , vtkIdType & nedges ) ; virtual void GetInEdges ( vtkIdType v , const vtkInEdgeType * & edges , vtkIdType & nedges ) ; /@} *
##  Builds a mapping from edge id to source/target vertex id.
##  void BuildEdgeList ( ) ; /@{ *
##  Friend iterator classes.
##  friend class vtkAdjacentVertexIterator ; friend class vtkEdgeListIterator ; friend class vtkInEdgeIterator ; friend class vtkOutEdgeIterator ; friend class boost :: vtk_edge_iterator ; friend class boost :: vtk_in_edge_pointer_iterator ; friend class boost :: vtk_out_edge_pointer_iterator ; /@} /@{ *
##  The vertex and edge data.
##  vtkDataSetAttributes * VertexData ; vtkDataSetAttributes * EdgeData ; /@} *
##  (xmin,xmax, ymin,ymax, zmin,zmax) geometric bounds.
##  double Bounds [ 6 ] ; *
##  Time at which bounds were computed.
##  vtkTimeStamp ComputeTime ; /@{ *
##  The vertex locations.
##  vtkPoints * Points ; static double DefaultPoint [ 3 ] ; /@} /@{ *
##  The optional mapping from edge id to source/target ids.
##  virtual vtkIdTypeArray * GetnameVertexDataEdgeDataEdgeList ( ) { vtkDebugWithObjectMacro ( this , <<  returning  EdgeList  address  << static_cast < vtkIdTypeArray * > ( this -> EdgeList ) ) ; return this -> EdgeList ; } ; virtual void SetEdgeList ( vtkIdTypeArray * list ) ; vtkIdTypeArray * EdgeList ; /@} private : vtkGraph ( const vtkGraph & ) = delete ; void operator = ( const vtkGraph & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  bool VTKCOMMONDATAMODEL_EXPORT operator == ( vtkEdgeBase e1 , vtkEdgeBase e2 ) ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  bool VTKCOMMONDATAMODEL_EXPORT operator != ( vtkEdgeBase e1 , vtkEdgeBase e2 ) ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  VTKCOMMONDATAMODEL_EXPORT ostream & operator << ( ostream & out , vtkEdgeBase e ) ;
