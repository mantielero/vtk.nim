...
## !!!Ignored construct:  # vtkPLSDynaReader_h [NewLine] # vtkPLSDynaReader_h [NewLine] # vtkIOParallelLSDynaModule.h  For export macro # vtkLSDynaReader.h [NewLine] class vtkMultiProcessController ;
## Error: token expected: ; but got: [identifier]!!!

## !!!Ignored construct:  class VTKIOPARALLELLSDYNA_EXPORT vtkPLSDynaReader : public vtkLSDynaReader { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkLSDynaReader Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkLSDynaReader :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPLSDynaReader :: IsTypeOf ( type ) ; } static vtkPLSDynaReader * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPLSDynaReader * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPLSDynaReader * NewInstance ( ) const { return vtkPLSDynaReader :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkLSDynaReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPLSDynaReader :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPLSDynaReader :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkPLSDynaReader * New ( ) ; *
##  Determine if the file can be read with this reader.
##  int CanReadFile ( VTK_FILEPATH const char * fname ) override ; /@{ *
##  Set/Get the communicator object. By default we use the world controller
##  void SetController ( vtkMultiProcessController * c ) ; virtual vtkMultiProcessController * GetnameController ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Controller  address  << static_cast < vtkMultiProcessController * > ( this -> Controller ) ) ; return this -> Controller ; } ; /@} protected : vtkPLSDynaReader ( ) ; ~ vtkPLSDynaReader ( ) override ; int RequestInformation ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int RequestData ( vtkInformation * , vtkInformationVector * * , vtkInformationVector * ) override ; int ReadTopology ( ) override ; private : vtkPLSDynaReader ( const vtkPLSDynaReader & ) = delete ; void operator = ( const vtkPLSDynaReader & ) = delete ; void GetPartRanges ( vtkIdType * mins , vtkIdType * maxs ) ; vtkMultiProcessController * Controller ; struct vtkPLSDynaReaderInternal ; vtkPLSDynaReaderInternal * Internal ; } ;
## Error: token expected: ; but got: [identifier]!!!
