...
## !!!Ignored construct:  # vtkPentagonalPrism_h [NewLine] # vtkPentagonalPrism_h [NewLine] # vtkCell3D.h [NewLine] # vtkCommonDataModelModule.h  For export macro [NewLine] class vtkLine ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkPolygon"
discard "forward decl of vtkQuad"
discard "forward decl of vtkTriangle"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkPentagonalPrism : public vtkCell3D { public : static vtkPentagonalPrism * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkCell3D Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkCell3D :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkPentagonalPrism :: IsTypeOf ( type ) ; } static vtkPentagonalPrism * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkPentagonalPrism * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkPentagonalPrism * NewInstance ( ) const { return vtkPentagonalPrism :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkCell3D :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkPentagonalPrism :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkPentagonalPrism :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
##  See vtkCell3D API for description of these methods.
##  void GetEdgePoints ( vtkIdType edgeId , const vtkIdType * & pts ) override ; vtkIdType GetFacePoints ( vtkIdType faceId , const vtkIdType * & pts ) override ; void GetEdgeToAdjacentFaces ( vtkIdType edgeId , const vtkIdType * & pts ) override ; vtkIdType GetFaceToAdjacentFaces ( vtkIdType faceId , const vtkIdType * & faceIds ) override ; vtkIdType GetPointToIncidentEdges ( vtkIdType pointId , const vtkIdType * & edgeIds ) override ; vtkIdType GetPointToIncidentFaces ( vtkIdType pointId , const vtkIdType * & faceIds ) override ; vtkIdType GetPointToOneRingPoints ( vtkIdType pointId , const vtkIdType * & pts ) override ; bool GetCentroid ( double centroid [ 3 ] ) const override ; bool IsInsideOut ( ) override ; /@} *
...
##  int GetCellType ( ) override { return VTK_PENTAGONAL_PRISM ; } int GetCellDimension ( ) override { return 3 ; } int GetNumberOfEdges ( ) override { return 15 ; } int GetNumberOfFaces ( ) override { return 7 ; } vtkCell * GetEdge ( int edgeId ) override ; vtkCell * GetFace ( int faceId ) override ; int CellBoundary ( int subId , const double pcoords [ 3 ] , vtkIdList * pts ) override ; /@} int EvaluatePosition ( const double x [ 3 ] , double closestPoint [ 3 ] , int & subId , double pcoords [ 3 ] , double & dist2 , double weights [ ] ) override ; void EvaluateLocation ( int & subId , const double pcoords [ 3 ] , double x [ 3 ] , double * weights ) override ; int IntersectWithLine ( const double p1 [ 3 ] , const double p2 [ 3 ] , double tol , double & t , double x [ 3 ] , double pcoords [ 3 ] , int & subId ) override ; int Triangulate ( int index , vtkIdList * ptIds , vtkPoints * pts ) override ; void Derivatives ( int subId , const double pcoords [ 3 ] , const double * values , int dim , double * derivs ) override ; double * GetParametricCoords ( ) override ; *
##  Return the center of the wedge in parametric coordinates.
##  int GetParametricCenter ( double pcoords [ 3 ] ) override ; static void InterpolationFunctions ( const double pcoords [ 3 ] , double weights [ 10 ] ) ; static void InterpolationDerivs ( const double pcoords [ 3 ] , double derivs [ 30 ] ) ; /@{ *
##  Compute the interpolation functions/derivatives
##  (aka shape functions/derivatives)
##  void InterpolateFunctions ( const double pcoords [ 3 ] , double weights [ 10 ] ) override { vtkPentagonalPrism :: InterpolationFunctions ( pcoords , weights ) ; } void InterpolateDerivs ( const double pcoords [ 3 ] , double derivs [ 30 ] ) override { vtkPentagonalPrism :: InterpolationDerivs ( pcoords , derivs ) ; } /@} /@{ *
...
##  static const vtkIdType * GetEdgeArray ( vtkIdType edgeId ) ; static const vtkIdType * GetFaceArray ( vtkIdType faceId ) ; /@} *
...
##  void JacobianInverse ( const double pcoords [ 3 ] , double * * inverse , double derivs [ 30 ] ) ; protected : vtkPentagonalPrism ( ) ; ~ vtkPentagonalPrism ( ) override ; vtkLine * Line ; vtkQuad * Quad ; vtkPolygon * Polygon ; vtkTriangle * Triangle ; private : vtkPentagonalPrism ( const vtkPentagonalPrism & ) = delete ; void operator = ( const vtkPentagonalPrism & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
