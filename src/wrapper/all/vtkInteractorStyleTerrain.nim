...
## !!!Ignored construct:  # vtkInteractorStyleTerrain_h [NewLine] # vtkInteractorStyleTerrain_h [NewLine] # vtkInteractionStyleModule.h  For export macro # vtkInteractorStyle.h [NewLine] class vtkPolyDataMapper ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkSphereSource"
discard "forward decl of vtkExtractEdges"
## !!!Ignored construct:  class VTKINTERACTIONSTYLE_EXPORT vtkInteractorStyleTerrain : public vtkInteractorStyle { public : *
##  Instantiate the object.
##  static vtkInteractorStyleTerrain * New ( ) ; protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkInteractorStyle Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkInteractorStyle :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkInteractorStyleTerrain :: IsTypeOf ( type ) ; } static vtkInteractorStyleTerrain * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkInteractorStyleTerrain * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkInteractorStyleTerrain * NewInstance ( ) const { return vtkInteractorStyleTerrain :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkInteractorStyle :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkInteractorStyleTerrain :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkInteractorStyleTerrain :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; /@{ *
...
##  are overridden in subclasses to perform the correct motion. void Rotate ( ) override ; void Pan ( ) override ; void Dolly ( ) override ; /@{ *
##  Turn on/off the latitude/longitude lines.
##  virtual void SetLatLongLines ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  LatLongLines  to  << _arg ) ; if ( this -> LatLongLines != _arg ) { this -> LatLongLines = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetLatLongLines ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << LatLongLines  of  << this -> LatLongLines ) ; return this -> LatLongLines ; } ; virtual void LatLongLinesOn ( ) { this -> SetLatLongLines ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void LatLongLinesOff ( ) { this -> SetLatLongLines ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} protected : vtkInteractorStyleTerrain ( ) ; ~ vtkInteractorStyleTerrain ( ) override ;  Internal helper attributes vtkTypeBool LatLongLines ; vtkSphereSource * LatLongSphere ; vtkPolyDataMapper * LatLongMapper ; vtkActor * LatLongActor ; vtkExtractEdges * LatLongExtractEdges ; void SelectRepresentation ( ) ; void CreateLatLong ( ) ; double MotionFactor ; private : vtkInteractorStyleTerrain ( const vtkInteractorStyleTerrain & ) = delete ; void operator = ( const vtkInteractorStyleTerrain & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
