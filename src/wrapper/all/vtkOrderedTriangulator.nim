...
## !!!Ignored construct:  # vtkOrderedTriangulator_h [NewLine] # vtkOrderedTriangulator_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkObject.h [NewLine] class vtkUnstructuredGrid ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkCellArray"
discard "forward decl of vtkHeap"
discard "forward decl of vtkIdList"
discard "forward decl of vtkPoints"
discard "forward decl of vtkTetra"
discard "forward decl of vtkDataArray"
discard "forward decl of vtkDoubleArray"
discard "forward decl of vtkOTMesh"
discard "forward decl of vtkOTTemplates"
...
when VTK_SIZEOF_SHORT == 4:
  type
    VTKCOMMONDATAMODEL_EXPORTTemplateIDType* = cushort
elif VTK_SIZEOF_INT == 4:
  type
    VTKCOMMONDATAMODEL_EXPORTTemplateIDType* = cuint
elif VTK_SIZEOF_LONG == 4:
  type
    VTKCOMMONDATAMODEL_EXPORTTemplateIDType* = culong
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkOrderedTriangulator : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkOrderedTriangulator :: IsTypeOf ( type ) ; } static vtkOrderedTriangulator * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkOrderedTriangulator * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkOrderedTriangulator * NewInstance ( ) const { return vtkOrderedTriangulator :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkOrderedTriangulator :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkOrderedTriangulator :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; *
##  Construct object.
...
##  void InitTriangulation ( double xmin , double xmax , double ymin , double ymax , double zmin , double zmax , int numPts ) ; void InitTriangulation ( double bounds [ 6 ] , int numPts ) ; /@} /@{ *
...
##  vtkIdType InsertPoint ( vtkIdType id , double x [ 3 ] , double p [ 3 ] , int type ) ; vtkIdType InsertPoint ( vtkIdType id , vtkIdType sortid , double x [ 3 ] , double p [ 3 ] , int type ) ; vtkIdType InsertPoint ( vtkIdType id , vtkIdType sortid , vtkIdType sortid2 , double x [ 3 ] , double p [ 3 ] , int type ) ; /@} /@{ *
...
##  should be used.
##  void Triangulate ( ) ; void TemplateTriangulate ( int cellType , int numPts , int numEdges ) ; /@} *
...
##  virtual int GetNumberOfPoints ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << NumberOfPoints  of  << this -> NumberOfPoints ) ; return this -> NumberOfPoints ; } ; /@} /@{ *
...
##  virtual void SetUseTemplates ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  UseTemplates  to  << _arg ) ; if ( this -> UseTemplates != _arg ) { this -> UseTemplates = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetNumberOfPointsUseTemplates ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << UseTemplates  of  << this -> UseTemplates ) ; return this -> UseTemplates ; } ; virtual void UseTemplatesOn ( ) { this -> SetUseTemplates ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void UseTemplatesOff ( ) { this -> SetUseTemplates ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
...
##  InsertPoint().)
##  virtual void SetUseTemplatesPreSorted ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  PreSorted  to  << _arg ) ; if ( this -> PreSorted != _arg ) { this -> PreSorted = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetNumberOfPointsUseTemplatesPreSorted ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << PreSorted  of  << this -> PreSorted ) ; return this -> PreSorted ; } ; virtual void PreSortedOn ( ) { this -> SetUseTemplatesPreSorted ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void PreSortedOff ( ) { this -> SetUseTemplatesPreSorted ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} /@{ *
##  Tells the triangulator that a second sort id is provided
##  for each point and should also be considered when sorting.
##  virtual void SetUseTemplatesPreSortedUseTwoSortIds ( vtkTypeBool _arg ) { vtkDebugWithObjectMacro ( this , <<  setting  UseTwoSortIds  to  << _arg ) ; if ( this -> UseTwoSortIds != _arg ) { this -> UseTwoSortIds = _arg ; this -> Modified ( ) ; } } ; virtual vtkTypeBool GetNumberOfPointsUseTemplatesPreSortedUseTwoSortIds ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << UseTwoSortIds  of  << this -> UseTwoSortIds ) ; return this -> UseTwoSortIds ; } ; virtual void UseTwoSortIdsOn ( ) { this -> SetUseTemplatesPreSortedUseTwoSortIds ( static_cast < vtkTypeBool > ( 1 ) ) ; } virtual void UseTwoSortIdsOff ( ) { this -> SetUseTemplatesPreSortedUseTwoSortIds ( static_cast < vtkTypeBool > ( 0 ) ) ; } ; /@} *
...
##  int GetNextTetra ( int classification , vtkTetra * tet , vtkDataArray * cellScalars , vtkDoubleArray * tetScalars ) ; protected : vtkOrderedTriangulator ( ) ; ~ vtkOrderedTriangulator ( ) override ; private : void Initialize ( ) ; vtkOTMesh * Mesh ; int NumberOfPoints ;  number of points inserted int MaximumNumberOfPoints ;  maximum possible number of points to be inserted double Bounds [ 6 ] ; vtkTypeBool PreSorted ; vtkTypeBool UseTwoSortIds ; vtkHeap * Heap ; vtkTypeBool UseTemplates ; int CellType ; int NumberOfCellPoints ; int NumberOfCellEdges ; vtkHeap * TemplateHeap ; vtkOTTemplates * Templates ; int TemplateTriangulation ( ) ; void AddTemplate ( ) ; TemplateIDType ComputeTemplateIndex ( ) ; private : vtkOrderedTriangulator ( const vtkOrderedTriangulator & ) = delete ; void operator = ( const vtkOrderedTriangulator & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
