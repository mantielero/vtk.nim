...
## !!!Ignored construct:  # vtkContextDevice2D_h [NewLine] # vtkContextDevice2D_h [NewLine] # vtkObject.h [NewLine] # vtkRect.h  For vtkRecti ivar # vtkRenderingContext2DModule.h  For export macro # vtkRenderingCoreEnums.h  For marker enum # vtkVector.h  For vtkVector2i ivar [NewLine] class vtkWindow ;
...
## !!!Ignored construct:  class VTKRENDERINGCONTEXT2D_EXPORT vtkContextDevice2D : public vtkObject { public : protected : const char * GetClassNameInternal ( ) const override { return thisClass ; } public : typedef vtkObject Superclass ; static vtkTypeBool IsTypeOf ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 1 ; } return vtkObject :: IsTypeOf ( type ) ; } vtkTypeBool IsA ( const char * type ) override { return this -> vtkContextDevice2D :: IsTypeOf ( type ) ; } static vtkContextDevice2D * SafeDownCast ( vtkObjectBase * o ) { if ( o && o -> IsA ( thisClass ) ) { return static_cast < vtkContextDevice2D * > ( o ) ; } return nullptr ; } VTK_NEWINSTANCE vtkContextDevice2D * NewInstance ( ) const { return vtkContextDevice2D :: SafeDownCast ( this -> NewInstanceInternal ( ) ) ; } static vtkIdType GetNumberOfGenerationsFromBaseType ( const char * type ) { if ( ! strcmp ( thisClass , type ) ) { return 0 ; } return 1 + vtkObject :: GetNumberOfGenerationsFromBaseType ( type ) ; } vtkIdType GetNumberOfGenerationsFromBase ( const char * type ) override { return this -> vtkContextDevice2D :: GetNumberOfGenerationsFromBaseType ( type ) ; } public : protected : vtkObjectBase * NewInstanceInternal ( ) const override { return vtkContextDevice2D :: New ( ) ; } public : ; void PrintSelf ( ostream & os , vtkIndent indent ) override ; static vtkContextDevice2D * New ( ) ; *
...
##  @{
##  virtual void DrawPolygon ( float * p , int n ) { this -> DrawColoredPolygon ( p , n ) ; } virtual void DrawColoredPolygon ( float * points , int numPoints , unsigned char * colors = nullptr , int nc_comps = 0 ) ; *@} *
...
##  virtual vtkPen * GetnamePen ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Pen  address  << static_cast < vtkPen * > ( this -> Pen ) ) ; return this -> Pen ; } ; /@} *
...
##  virtual vtkBrush * GetnamePenBrush ( ) { vtkDebugWithObjectMacro ( this , <<  returning  Brush  address  << static_cast < vtkBrush * > ( this -> Brush ) ) ; return this -> Brush ; } ; /@} *
...
##  virtual vtkTextProperty * GetnamePenBrushTextProp ( ) { vtkDebugWithObjectMacro ( this , <<  returning  TextProp  address  << static_cast < vtkTextProperty * > ( this -> TextProp ) ) ; return this -> TextProp ; } ; /@} *
##  Set the color for the device using unsigned char of length 4, RGBA.
##  virtual void SetColor4 ( unsigned char color [ 4 ] ) = 0 ; enum TextureProperty { Nearest = 0x01 , Linear = 0x02 , Stretch = 0x04 , Repeat = 0x08 } ; *
...
##  virtual void BufferIdModeEnd ( ) ; virtual void SetViewportSize ( const vtkVector2i & size ) { this -> ViewportSize = size ; } virtual vtkVector2i GetViewportSize ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ViewportSize  of  << this -> ViewportSize ) ; return this -> ViewportSize ; } ; virtual void SetViewportRect ( const vtkRecti & rect ) { this -> ViewportRect = rect ; } virtual vtkRecti GetViewportSizeViewportRect ( ) VTK_FUTURE_CONST { vtkDebugWithObjectMacro ( this , <<  returning  << ViewportRect  of  << this -> ViewportRect ) ; return this -> ViewportRect ; } ; protected : vtkContextDevice2D ( ) ; ~ vtkContextDevice2D ( ) override ; *
...
##  vtkRecti ViewportRect ; vtkAbstractContextBufferId * BufferId ; vtkPen * Pen ;  Outlining vtkBrush * Brush ;  Fills vtkTextProperty * TextProp ;  Text property private : vtkContextDevice2D ( const vtkContextDevice2D & ) = delete ; void operator = ( const vtkContextDevice2D & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
