...
## !!!Ignored construct:  # vtkDataSetAttributesFieldList_h [NewLine] # vtkDataSetAttributesFieldList_h [NewLine] # vtkCommonDataModelModule.h  For export macro # vtkSmartPointer.h  for vtkSmartPointer # vtkSystemIncludes.h [NewLine] # < functional >  for std::function # < memory >  for unique_ptr [NewLine] class vtkAbstractArray ;
## Error: token expected: ; but got: [identifier]!!!

discard "forward decl of vtkDataSetAttributes"
discard "forward decl of vtkIdList"
## !!!Ignored construct:  class VTKCOMMONDATAMODEL_EXPORT vtkDataSetAttributesFieldList { public : *
##  `number_of_inputs` parameter is not required and only provided for
##  backwards compatibility.
##  vtkDataSetAttributesFieldList ( int number_of_inputs = 0 ) ; virtual ~ vtkDataSetAttributesFieldList ( ) ; void PrintSelf ( ostream & os , vtkIndent indent ) ; *
...
##  instead as well.
##  void CopyAllocate ( vtkDataSetAttributes * output , int ctype , vtkIdType sz , vtkIdType ext ) const ; void CopyData ( int inputIndex , vtkDataSetAttributes * input , vtkIdType fromId , vtkDataSetAttributes * output , vtkIdType toId ) const ; void CopyData ( int inputIndex , vtkDataSetAttributes * input , vtkIdType inputStart , vtkIdType numValues , vtkDataSetAttributes * output , vtkIdType outStart ) const ; void InterpolatePoint ( int inputIndex , vtkDataSetAttributes * input , vtkIdList * inputIds , double * weights , vtkDataSetAttributes * output , vtkIdType toId ) const ; /@} *
...
##  void BuildPrototype ( vtkDataSetAttributes * protoDSA , vtkDataSetAttributes * ordering = nullptr ) ; protected : *
##  Called to create an output array for the given type.
##  Default implementation calls `vtkAbstractArray::CreateArray()`.
##  virtual vtkSmartPointer < vtkAbstractArray > CreateArray ( int type ) const ; private : class vtkInternals ; std :: unique_ptr < vtkInternals > Internals ; vtkDataSetAttributesFieldList ( const vtkDataSetAttributesFieldList & ) = delete ; void operator = ( vtkDataSetAttributesFieldList & ) = delete ; } ;
## Error: token expected: ; but got: [identifier]!!!
